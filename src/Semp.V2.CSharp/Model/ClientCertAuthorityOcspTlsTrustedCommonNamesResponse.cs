...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ClientCertAuthorityOcspTlsTrustedCommonNamesResponse :  IEquatable<ClientCertAuthorityOcspTlsTrustedCommonNamesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCertAuthorityOcspTlsTrustedCommonNamesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public ClientCertAuthorityOcspTlsTrustedCommonNamesResponse(List<ClientCertAuthorityOcspTlsTrustedCommonName> data = default(List<ClientCertAuthorityOcspTlsTrustedCommonName>), List<ClientCertAuthorityOcspTlsTrustedCommonNameLinks> links = default(List<ClientCertAuthorityOcspTlsTrustedCommonNameLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for ClientCertAuthorityOcspTlsTrustedCommonNamesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<ClientCertAuthorityOcspTlsTrustedCommonName> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<ClientCertAuthorityOcspTlsTrustedCommonNameLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as ClientCertAuthorityOcspTlsTrustedCommonNamesResponse);
        }

        /// <summary>
        /// Returns true if ClientCertAuthorityOcspTlsTrustedCommonNamesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCertAuthorityOcspTlsTrustedCommonNamesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCertAuthorityOcspTlsTrustedCommonNamesResponse input)
        {
            if (input == null)
                return false;

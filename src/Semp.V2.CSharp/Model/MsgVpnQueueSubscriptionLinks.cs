...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueSubscriptionLinks :  IEquatable<MsgVpnQueueSubscriptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueSubscriptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Queue Subscription object..</param>
        public MsgVpnQueueSubscriptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Queue Subscription object.</value>
        ...
        {
            return this.Equals(input as MsgVpnQueueSubscriptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueSubscriptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueSubscriptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueSubscriptionLinks input)
        {
            if (input == null)
                return false;

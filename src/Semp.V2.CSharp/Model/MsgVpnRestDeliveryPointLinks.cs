...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointLinks :  IEquatable<MsgVpnRestDeliveryPointLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointLinks" /> class.
        /// </summary>
        /// <param name="queueBindingsUri">The URI of this REST Delivery Point&#x27;s collection of Queue Binding objects..</param>
        /// <param name="restConsumersUri">The URI of this REST Delivery Point&#x27;s collection of REST Consumer objects..</param>
        /// <param name="uri">The URI of this REST Delivery Point object..</param>
        public MsgVpnRestDeliveryPointLinks(string queueBindingsUri = default(string), string restConsumersUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this REST Delivery Point&#x27;s collection of Queue Binding objects.</value>
        [DataMember(Name="queueBindingsUri", EmitDefaultValue=false)]
        public string QueueBindingsUri { get; set; }

        /// <summary>
        /// The URI of this REST Delivery Point&#x27;s collection of REST Consumer objects.
        /// </summary>
        /// <value>The URI of this REST Delivery Point&#x27;s collection of REST Consumer objects.</value>
        [DataMember(Name="restConsumersUri", EmitDefaultValue=false)]
        public string RestConsumersUri { get; set; }

        /// <summary>
        /// The URI of this REST Delivery Point object.
        /// </summary>
        /// <value>The URI of this REST Delivery Point object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  QueueBindingsUri: ").Append(QueueBindingsUri).Append("\n");
            sb.Append("  RestConsumersUri: ").Append(RestConsumersUri).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.QueueBindingsUri == input.QueueBindingsUri ||
                    (this.QueueBindingsUri != null &&
                    this.QueueBindingsUri.Equals(input.QueueBindingsUri))
                ) && 
                (
                    this.RestConsumersUri == input.RestConsumersUri ||
                    (this.RestConsumersUri != null &&
                    this.RestConsumersUri.Equals(input.RestConsumersUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.QueueBindingsUri != null)
                    hashCode = hashCode * 59 + this.QueueBindingsUri.GetHashCode();
                if (this.RestConsumersUri != null)
                    hashCode = hashCode * 59 + this.RestConsumersUri.GetHashCode();
                if (this.Uri != null)

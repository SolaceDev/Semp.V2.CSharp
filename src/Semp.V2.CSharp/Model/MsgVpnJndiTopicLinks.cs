...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiTopicLinks :  IEquatable<MsgVpnJndiTopicLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiTopicLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this JNDI Topic object..</param>
        public MsgVpnJndiTopicLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this JNDI Topic object.</value>
        ...
        {
            return this.Equals(input as MsgVpnJndiTopicLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiTopicLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiTopicLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiTopicLinks input)
        {
            if (input == null)
                return false;

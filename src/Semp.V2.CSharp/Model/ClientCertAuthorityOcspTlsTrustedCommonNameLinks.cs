...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ClientCertAuthorityOcspTlsTrustedCommonNameLinks :  IEquatable<ClientCertAuthorityOcspTlsTrustedCommonNameLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCertAuthorityOcspTlsTrustedCommonNameLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this OCSP Responder Trusted Common Name object..</param>
        public ClientCertAuthorityOcspTlsTrustedCommonNameLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this OCSP Responder Trusted Common Name object.</value>
        ...
        {
            return this.Equals(input as ClientCertAuthorityOcspTlsTrustedCommonNameLinks);
        }

        /// <summary>
        /// Returns true if ClientCertAuthorityOcspTlsTrustedCommonNameLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCertAuthorityOcspTlsTrustedCommonNameLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCertAuthorityOcspTlsTrustedCommonNameLinks input)
        {
            if (input == null)
                return false;

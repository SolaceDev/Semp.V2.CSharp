...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeRemoteSubscriptionLinks :  IEquatable<MsgVpnBridgeRemoteSubscriptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeRemoteSubscriptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Remote Subscription object..</param>
        public MsgVpnBridgeRemoteSubscriptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Remote Subscription object.</value>
        ...
        {
            return this.Equals(input as MsgVpnBridgeRemoteSubscriptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeRemoteSubscriptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeRemoteSubscriptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeRemoteSubscriptionLinks input)
        {
            if (input == null)
                return false;

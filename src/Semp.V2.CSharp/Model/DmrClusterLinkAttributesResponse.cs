...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkAttributesResponse :  IEquatable<DmrClusterLinkAttributesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkAttributesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterLinkAttributesResponse(List<DmrClusterLinkAttribute> data = default(List<DmrClusterLinkAttribute>), List<DmrClusterLinkAttributeLinks> links = default(List<DmrClusterLinkAttributeLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterLinkAttributesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DmrClusterLinkAttribute> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DmrClusterLinkAttributeLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterLinkAttributesResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkAttributesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkAttributesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkAttributesResponse input)
        {
            if (input == null)
                return false;

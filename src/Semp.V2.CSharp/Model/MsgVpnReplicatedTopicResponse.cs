...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplicatedTopicResponse :  IEquatable<MsgVpnReplicatedTopicResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplicatedTopicResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnReplicatedTopicResponse(MsgVpnReplicatedTopic data = default(MsgVpnReplicatedTopic), MsgVpnReplicatedTopicLinks links = default(MsgVpnReplicatedTopicLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnReplicatedTopicResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnReplicatedTopic Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnReplicatedTopicLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnReplicatedTopicResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnReplicatedTopicResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplicatedTopicResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplicatedTopicResponse input)
        {
            if (input == null)
                return false;

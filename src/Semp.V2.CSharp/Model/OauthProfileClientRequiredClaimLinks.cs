...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientRequiredClaimLinks :  IEquatable<OauthProfileClientRequiredClaimLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientRequiredClaimLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Required Claim object..</param>
        public OauthProfileClientRequiredClaimLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as OauthProfileClientRequiredClaimLinks);
        }

        /// <summary>
        /// Returns true if OauthProfileClientRequiredClaimLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientRequiredClaimLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientRequiredClaimLinks input)
        {
            if (input == null)
                return false;

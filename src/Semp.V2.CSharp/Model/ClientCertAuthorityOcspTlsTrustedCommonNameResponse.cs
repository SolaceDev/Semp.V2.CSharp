...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ClientCertAuthorityOcspTlsTrustedCommonNameResponse :  IEquatable<ClientCertAuthorityOcspTlsTrustedCommonNameResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCertAuthorityOcspTlsTrustedCommonNameResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public ClientCertAuthorityOcspTlsTrustedCommonNameResponse(ClientCertAuthorityOcspTlsTrustedCommonName data = default(ClientCertAuthorityOcspTlsTrustedCommonName), ClientCertAuthorityOcspTlsTrustedCommonNameLinks links = default(ClientCertAuthorityOcspTlsTrustedCommonNameLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for ClientCertAuthorityOcspTlsTrustedCommonNameResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public ClientCertAuthorityOcspTlsTrustedCommonName Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public ClientCertAuthorityOcspTlsTrustedCommonNameLinks Links { get; set; }
        ...
        {
            return this.Equals(input as ClientCertAuthorityOcspTlsTrustedCommonNameResponse);
        }

        /// <summary>
        /// Returns true if ClientCertAuthorityOcspTlsTrustedCommonNameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCertAuthorityOcspTlsTrustedCommonNameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCertAuthorityOcspTlsTrustedCommonNameResponse input)
        {
            if (input == null)
                return false;

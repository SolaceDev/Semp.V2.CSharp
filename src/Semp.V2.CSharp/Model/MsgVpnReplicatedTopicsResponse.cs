...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplicatedTopicsResponse :  IEquatable<MsgVpnReplicatedTopicsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplicatedTopicsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnReplicatedTopicsResponse(List<MsgVpnReplicatedTopic> data = default(List<MsgVpnReplicatedTopic>), List<MsgVpnReplicatedTopicLinks> links = default(List<MsgVpnReplicatedTopicLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnReplicatedTopicsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnReplicatedTopic> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnReplicatedTopicLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnReplicatedTopicsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnReplicatedTopicsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplicatedTopicsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplicatedTopicsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRuleConditionResponse :  IEquatable<DmrClusterCertMatchingRuleConditionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRuleConditionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterCertMatchingRuleConditionResponse(DmrClusterCertMatchingRuleCondition data = default(DmrClusterCertMatchingRuleCondition), DmrClusterCertMatchingRuleConditionLinks links = default(DmrClusterCertMatchingRuleConditionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterCertMatchingRuleConditionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DmrClusterCertMatchingRuleCondition Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DmrClusterCertMatchingRuleConditionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRuleConditionResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRuleConditionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRuleConditionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRuleConditionResponse input)
        {
            if (input == null)
                return false;

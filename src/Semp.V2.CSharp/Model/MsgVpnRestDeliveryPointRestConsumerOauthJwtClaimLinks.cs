...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks :  IEquatable<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Claim object..</param>
        public MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Claim object.</value>
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks input)
        {
            if (input == null)
                return false;

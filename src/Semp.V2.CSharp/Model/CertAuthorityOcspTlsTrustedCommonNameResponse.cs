...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CertAuthorityOcspTlsTrustedCommonNameResponse :  IEquatable<CertAuthorityOcspTlsTrustedCommonNameResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertAuthorityOcspTlsTrustedCommonNameResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public CertAuthorityOcspTlsTrustedCommonNameResponse(CertAuthorityOcspTlsTrustedCommonName data = default(CertAuthorityOcspTlsTrustedCommonName), CertAuthorityOcspTlsTrustedCommonNameLinks links = default(CertAuthorityOcspTlsTrustedCommonNameLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for CertAuthorityOcspTlsTrustedCommonNameResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public CertAuthorityOcspTlsTrustedCommonName Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public CertAuthorityOcspTlsTrustedCommonNameLinks Links { get; set; }
        ...
        {
            return this.Equals(input as CertAuthorityOcspTlsTrustedCommonNameResponse);
        }

        /// <summary>
        /// Returns true if CertAuthorityOcspTlsTrustedCommonNameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CertAuthorityOcspTlsTrustedCommonNameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertAuthorityOcspTlsTrustedCommonNameResponse input)
        {
            if (input == null)
                return false;

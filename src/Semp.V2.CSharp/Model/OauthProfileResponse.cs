...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileResponse :  IEquatable<OauthProfileResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileResponse(OauthProfile data = default(OauthProfile), OauthProfileLinks links = default(OauthProfileLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public OauthProfile Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public OauthProfileLinks Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRulesResponse :  IEquatable<DmrClusterCertMatchingRulesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRulesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterCertMatchingRulesResponse(List<DmrClusterCertMatchingRule> data = default(List<DmrClusterCertMatchingRule>), List<DmrClusterCertMatchingRuleLinks> links = default(List<DmrClusterCertMatchingRuleLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterCertMatchingRulesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DmrClusterCertMatchingRule> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DmrClusterCertMatchingRuleLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRulesResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRulesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRulesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRulesResponse input)
        {
            if (input == null)
                return false;

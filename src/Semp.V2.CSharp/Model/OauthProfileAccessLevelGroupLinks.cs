...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileAccessLevelGroupLinks :  IEquatable<OauthProfileAccessLevelGroupLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileAccessLevelGroupLinks" /> class.
        /// </summary>
        /// <param name="msgVpnAccessLevelExceptionsUri">The URI of this Group Access Level&#x27;s collection of Message VPN Access-Level Exception objects..</param>
        /// <param name="uri">The URI of this Group Access Level object..</param>
        public OauthProfileAccessLevelGroupLinks(string msgVpnAccessLevelExceptionsUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Group Access Level&#x27;s collection of Message VPN Access-Level Exception objects.</value>
        [DataMember(Name="msgVpnAccessLevelExceptionsUri", EmitDefaultValue=false)]
        public string MsgVpnAccessLevelExceptionsUri { get; set; }

        /// <summary>
        /// The URI of this Group Access Level object.
        /// </summary>
        /// <value>The URI of this Group Access Level object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MsgVpnAccessLevelExceptionsUri: ").Append(MsgVpnAccessLevelExceptionsUri).Append("\n");
        ...
        {
            return this.Equals(input as OauthProfileAccessLevelGroupLinks);
        }

        /// <summary>
        /// Returns true if OauthProfileAccessLevelGroupLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileAccessLevelGroupLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileAccessLevelGroupLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.MsgVpnAccessLevelExceptionsUri == input.MsgVpnAccessLevelExceptionsUri ||
                    (this.MsgVpnAccessLevelExceptionsUri != null &&
                    this.MsgVpnAccessLevelExceptionsUri.Equals(input.MsgVpnAccessLevelExceptionsUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.MsgVpnAccessLevelExceptionsUri != null)
                    hashCode = hashCode * 59 + this.MsgVpnAccessLevelExceptionsUri.GetHashCode();
                if (this.Uri != null)

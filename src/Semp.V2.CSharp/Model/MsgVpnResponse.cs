...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnResponse :  IEquatable<MsgVpnResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnResponse(MsgVpn data = default(MsgVpn), MsgVpnLinks links = default(MsgVpnLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpn Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnResponse input)
        {
            if (input == null)
                return false;

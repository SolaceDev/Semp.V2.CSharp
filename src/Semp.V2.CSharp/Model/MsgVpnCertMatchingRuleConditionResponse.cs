...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleConditionResponse :  IEquatable<MsgVpnCertMatchingRuleConditionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleConditionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnCertMatchingRuleConditionResponse(MsgVpnCertMatchingRuleCondition data = default(MsgVpnCertMatchingRuleCondition), MsgVpnCertMatchingRuleConditionLinks links = default(MsgVpnCertMatchingRuleConditionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnCertMatchingRuleConditionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnCertMatchingRuleCondition Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnCertMatchingRuleConditionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleConditionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleConditionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleConditionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleConditionResponse input)
        {
            if (input == null)
                return false;

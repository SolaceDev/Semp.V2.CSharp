...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeShareNameExceptionsResponse :  IEquatable<MsgVpnAclProfileSubscribeShareNameExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeShareNameExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileSubscribeShareNameExceptionsResponse(List<MsgVpnAclProfileSubscribeShareNameException> data = default(List<MsgVpnAclProfileSubscribeShareNameException>), List<MsgVpnAclProfileSubscribeShareNameExceptionLinks> links = default(List<MsgVpnAclProfileSubscribeShareNameExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileSubscribeShareNameExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAclProfileSubscribeShareNameException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAclProfileSubscribeShareNameExceptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeShareNameExceptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeShareNameExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeShareNameExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeShareNameExceptionsResponse input)
        {
            if (input == null)
                return false;

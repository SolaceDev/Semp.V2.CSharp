...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EventThresholdByValue :  IEquatable<EventThresholdByValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventThresholdByValue" /> class.
        /// </summary>
        /// <param name="clearValue">The clear threshold for the absolute value of this counter or rate. Falling below this value will trigger a corresponding event..</param>
        /// <param name="setValue">The set threshold for the absolute value of this counter or rate. Exceeding this value will trigger a corresponding event..</param>
        public EventThresholdByValue(long? clearValue = default(long?), long? setValue = default(long?))
        {
        ...
        /// </summary>
        /// <value>The clear threshold for the absolute value of this counter or rate. Falling below this value will trigger a corresponding event.</value>
        ...
        /// </summary>
        /// <value>The set threshold for the absolute value of this counter or rate. Exceeding this value will trigger a corresponding event.</value>
        ...
        {
            return this.Equals(input as EventThresholdByValue);
        }

        /// <summary>
        /// Returns true if EventThresholdByValue instances are equal
        /// </summary>
        /// <param name="input">Instance of EventThresholdByValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventThresholdByValue input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ClientCertAuthorityResponse :  IEquatable<ClientCertAuthorityResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCertAuthorityResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public ClientCertAuthorityResponse(ClientCertAuthority data = default(ClientCertAuthority), ClientCertAuthorityLinks links = default(ClientCertAuthorityLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for ClientCertAuthorityResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public ClientCertAuthority Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public ClientCertAuthorityLinks Links { get; set; }
        ...
        {
            return this.Equals(input as ClientCertAuthorityResponse);
        }

        /// <summary>
        /// Returns true if ClientCertAuthorityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCertAuthorityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCertAuthorityResponse input)
        {
            if (input == null)
                return false;

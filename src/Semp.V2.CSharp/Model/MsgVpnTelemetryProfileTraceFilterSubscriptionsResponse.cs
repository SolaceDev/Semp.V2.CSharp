...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse :  IEquatable<MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse(List<MsgVpnTelemetryProfileTraceFilterSubscription> data = default(List<MsgVpnTelemetryProfileTraceFilterSubscription>), List<MsgVpnTelemetryProfileTraceFilterSubscriptionLinks> links = default(List<MsgVpnTelemetryProfileTraceFilterSubscriptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnTelemetryProfileTraceFilterSubscription> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnTelemetryProfileTraceFilterSubscriptionLinks> Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse input)
        {
            if (input == null)
                return false;

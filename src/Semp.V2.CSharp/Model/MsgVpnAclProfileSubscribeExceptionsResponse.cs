...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeExceptionsResponse :  IEquatable<MsgVpnAclProfileSubscribeExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileSubscribeExceptionsResponse(List<MsgVpnAclProfileSubscribeException> data = default(List<MsgVpnAclProfileSubscribeException>), List<MsgVpnAclProfileSubscribeExceptionLinks> links = default(List<MsgVpnAclProfileSubscribeExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileSubscribeExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAclProfileSubscribeException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAclProfileSubscribeExceptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeExceptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeExceptionsResponse input)
        {
            if (input == null)
                return false;

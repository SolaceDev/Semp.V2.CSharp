...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutApiResponse :  IEquatable<AboutApiResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutApiResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public AboutApiResponse(AboutApi data = default(AboutApi), AboutApiLinks links = default(AboutApiLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for AboutApiResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public AboutApi Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public AboutApiLinks Links { get; set; }
        ...
        {
            return this.Equals(input as AboutApiResponse);
        }

        /// <summary>
        /// Returns true if AboutApiResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutApiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutApiResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse :  IEquatable<MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse(List<MsgVpnAuthenticationOauthProfileClientRequiredClaim> data = default(List<MsgVpnAuthenticationOauthProfileClientRequiredClaim>), List<MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks> links = default(List<MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAuthenticationOauthProfileClientRequiredClaim> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileClientRequiredClaimsResponse input)
        {
            if (input == null)
                return false;

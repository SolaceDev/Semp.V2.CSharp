...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleConditionsResponse :  IEquatable<MsgVpnCertMatchingRuleConditionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleConditionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnCertMatchingRuleConditionsResponse(List<MsgVpnCertMatchingRuleCondition> data = default(List<MsgVpnCertMatchingRuleCondition>), List<MsgVpnCertMatchingRuleConditionLinks> links = default(List<MsgVpnCertMatchingRuleConditionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnCertMatchingRuleConditionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnCertMatchingRuleCondition> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnCertMatchingRuleConditionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleConditionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleConditionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleConditionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleConditionsResponse input)
        {
            if (input == null)
                return false;

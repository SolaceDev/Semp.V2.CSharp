...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse :  IEquatable<MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse(List<MsgVpnDistributedCacheClusterGlobalCachingHomeCluster> data = default(List<MsgVpnDistributedCacheClusterGlobalCachingHomeCluster>), List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks> links = default(List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnDistributedCacheClusterGlobalCachingHomeCluster> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterGlobalCachingHomeClustersResponse input)
        {
            if (input == null)
                return false;

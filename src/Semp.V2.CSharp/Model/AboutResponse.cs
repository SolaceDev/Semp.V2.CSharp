...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutResponse :  IEquatable<AboutResponse>
    {
        /// <summary>
        ...
        public AboutResponse(About data = default(About), AboutLinks links = default(AboutLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for AboutResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        {
            return this.Equals(input as AboutResponse);
        }

        /// <summary>
        /// Returns true if AboutResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutResponse input)
        {
            if (input == null)
                return false;

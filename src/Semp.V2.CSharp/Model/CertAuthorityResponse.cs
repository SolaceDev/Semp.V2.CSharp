...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CertAuthorityResponse :  IEquatable<CertAuthorityResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertAuthorityResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public CertAuthorityResponse(CertAuthority data = default(CertAuthority), CertAuthorityLinks links = default(CertAuthorityLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for CertAuthorityResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public CertAuthority Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public CertAuthorityLinks Links { get; set; }
        ...
        {
            return this.Equals(input as CertAuthorityResponse);
        }

        /// <summary>
        /// Returns true if CertAuthorityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CertAuthorityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertAuthorityResponse input)
        {
            if (input == null)
                return false;

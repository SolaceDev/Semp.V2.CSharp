...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeRemoteMsgVpnLinks :  IEquatable<MsgVpnBridgeRemoteMsgVpnLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeRemoteMsgVpnLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Remote Message VPN object..</param>
        public MsgVpnBridgeRemoteMsgVpnLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Remote Message VPN object.</value>
        ...
        {
            return this.Equals(input as MsgVpnBridgeRemoteMsgVpnLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeRemoteMsgVpnLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeRemoteMsgVpnLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeRemoteMsgVpnLinks input)
        {
            if (input == null)
                return false;

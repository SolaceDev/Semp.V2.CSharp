...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplayLogsResponse :  IEquatable<MsgVpnReplayLogsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplayLogsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnReplayLogsResponse(List<MsgVpnReplayLog> data = default(List<MsgVpnReplayLog>), List<MsgVpnReplayLogLinks> links = default(List<MsgVpnReplayLogLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnReplayLogsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnReplayLog> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnReplayLogLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnReplayLogsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnReplayLogsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplayLogsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplayLogsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileAccessLevelGroupsResponse :  IEquatable<OauthProfileAccessLevelGroupsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileAccessLevelGroupsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileAccessLevelGroupsResponse(List<OauthProfileAccessLevelGroup> data = default(List<OauthProfileAccessLevelGroup>), List<OauthProfileAccessLevelGroupLinks> links = default(List<OauthProfileAccessLevelGroupLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileAccessLevelGroupsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<OauthProfileAccessLevelGroup> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<OauthProfileAccessLevelGroupLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileAccessLevelGroupsResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileAccessLevelGroupsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileAccessLevelGroupsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileAccessLevelGroupsResponse input)
        {
            if (input == null)
                return false;

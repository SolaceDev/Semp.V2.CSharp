...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientAllowedHostsResponse :  IEquatable<OauthProfileClientAllowedHostsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientAllowedHostsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileClientAllowedHostsResponse(List<OauthProfileClientAllowedHost> data = default(List<OauthProfileClientAllowedHost>), List<OauthProfileClientAllowedHostLinks> links = default(List<OauthProfileClientAllowedHostLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileClientAllowedHostsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<OauthProfileClientAllowedHost> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<OauthProfileClientAllowedHostLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileClientAllowedHostsResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileClientAllowedHostsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientAllowedHostsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientAllowedHostsResponse input)
        {
            if (input == null)
                return false;

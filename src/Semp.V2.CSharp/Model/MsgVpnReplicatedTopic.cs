...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplicatedTopic :  IEquatable<MsgVpnReplicatedTopic>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The replication mode for the Replicated Topic. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;async\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;sync\&quot; - Messages are acknowledged when replicated (spooled remotely). \&quot;async\&quot; - Messages are acknowledged when pending replication (spooled locally). &lt;/pre&gt; </value>
        ...
        /// </summary>
        /// <value>The replication mode for the Replicated Topic. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;async\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;sync\&quot; - Messages are acknowledged when replicated (spooled remotely). \&quot;async\&quot; - Messages are acknowledged when pending replication (spooled locally). &lt;/pre&gt; </value>
        [DataMember(Name="replicationMode", EmitDefaultValue=false)]
        public ReplicationModeEnum? ReplicationMode { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplicatedTopic" /> class.
        /// </summary>
        ...
        /// <param name="replicationMode">The replication mode for the Replicated Topic. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;async\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;sync\&quot; - Messages are acknowledged when replicated (spooled remotely). \&quot;async\&quot; - Messages are acknowledged when pending replication (spooled locally). &lt;/pre&gt; .</param>
        public MsgVpnReplicatedTopic(string msgVpnName = default(string), string replicatedTopic = default(string), ReplicationModeEnum? replicationMode = default(ReplicationModeEnum?))
        {
        ...
        /// </summary>
        /// <value>The topic for applying replication. Published messages matching this topic will be replicated to the standby site.</value>
        [DataMember(Name="replicatedTopic", EmitDefaultValue=false)]
        public string ReplicatedTopic { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReplicatedTopic: ").Append(ReplicatedTopic).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnReplicatedTopic);
        }

        /// <summary>
        /// Returns true if MsgVpnReplicatedTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplicatedTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplicatedTopic input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReplicatedTopic == input.ReplicatedTopic ||
                    (this.ReplicatedTopic != null &&
                    this.ReplicatedTopic.Equals(input.ReplicatedTopic))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReplicatedTopic != null)
                    hashCode = hashCode * 59 + this.ReplicatedTopic.GetHashCode();

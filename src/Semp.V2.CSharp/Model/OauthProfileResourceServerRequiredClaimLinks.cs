...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileResourceServerRequiredClaimLinks :  IEquatable<OauthProfileResourceServerRequiredClaimLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileResourceServerRequiredClaimLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Required Claim object..</param>
        public OauthProfileResourceServerRequiredClaimLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as OauthProfileResourceServerRequiredClaimLinks);
        }

        /// <summary>
        /// Returns true if OauthProfileResourceServerRequiredClaimLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileResourceServerRequiredClaimLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileResourceServerRequiredClaimLinks input)
        {
            if (input == null)
                return false;

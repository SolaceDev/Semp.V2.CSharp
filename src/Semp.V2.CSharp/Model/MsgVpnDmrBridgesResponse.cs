...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDmrBridgesResponse :  IEquatable<MsgVpnDmrBridgesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDmrBridgesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDmrBridgesResponse(List<MsgVpnDmrBridge> data = default(List<MsgVpnDmrBridge>), List<MsgVpnDmrBridgeLinks> links = default(List<MsgVpnDmrBridgeLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDmrBridgesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnDmrBridge> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnDmrBridgeLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDmrBridgesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDmrBridgesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDmrBridgesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDmrBridgesResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDmrBridge :  IEquatable<MsgVpnDmrBridge>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDmrBridge" /> class.
        /// </summary>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="remoteMsgVpnName">The remote Message VPN of the DMR Bridge. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        /// <param name="remoteNodeName">The name of the node at the remote end of the DMR Bridge..</param>
        public MsgVpnDmrBridge(string msgVpnName = default(string), string remoteMsgVpnName = default(string), string remoteNodeName = default(string))
        {
        ...
        /// </summary>
        /// <value>The remote Message VPN of the DMR Bridge. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        /// </summary>
        /// <value>The name of the node at the remote end of the DMR Bridge.</value>
        ...
        {
            return this.Equals(input as MsgVpnDmrBridge);
        }

        /// <summary>
        /// Returns true if MsgVpnDmrBridge instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDmrBridge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDmrBridge input)
        {
            if (input == null)
                return false;

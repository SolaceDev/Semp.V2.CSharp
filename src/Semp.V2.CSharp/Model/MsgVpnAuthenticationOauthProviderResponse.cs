...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProviderResponse :  IEquatable<MsgVpnAuthenticationOauthProviderResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProviderResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthenticationOauthProviderResponse(MsgVpnAuthenticationOauthProvider data = default(MsgVpnAuthenticationOauthProvider), MsgVpnAuthenticationOauthProviderLinks links = default(MsgVpnAuthenticationOauthProviderLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthenticationOauthProviderResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAuthenticationOauthProvider Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAuthenticationOauthProviderLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProviderResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProviderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProviderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProviderResponse input)
        {
            if (input == null)
                return false;

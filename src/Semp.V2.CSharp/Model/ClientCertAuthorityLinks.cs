...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ClientCertAuthorityLinks :  IEquatable<ClientCertAuthorityLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCertAuthorityLinks" /> class.
        /// </summary>
        /// <param name="ocspTlsTrustedCommonNamesUri">The URI of this Client Certificate Authority&#x27;s collection of OCSP Responder Trusted Common Name objects..</param>
        /// <param name="uri">The URI of this Client Certificate Authority object..</param>
        public ClientCertAuthorityLinks(string ocspTlsTrustedCommonNamesUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Client Certificate Authority&#x27;s collection of OCSP Responder Trusted Common Name objects.</value>
        ...
        /// </summary>
        /// <value>The URI of this Client Certificate Authority object.</value>
        ...
        {
            return this.Equals(input as ClientCertAuthorityLinks);
        }

        /// <summary>
        /// Returns true if ClientCertAuthorityLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCertAuthorityLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCertAuthorityLinks input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfilePublishTopicExceptionResponse :  IEquatable<MsgVpnAclProfilePublishTopicExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfilePublishTopicExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfilePublishTopicExceptionResponse(MsgVpnAclProfilePublishTopicException data = default(MsgVpnAclProfilePublishTopicException), MsgVpnAclProfilePublishTopicExceptionLinks links = default(MsgVpnAclProfilePublishTopicExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfilePublishTopicExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAclProfilePublishTopicException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAclProfilePublishTopicExceptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfilePublishTopicExceptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfilePublishTopicExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfilePublishTopicExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfilePublishTopicExceptionResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientUsernameResponse :  IEquatable<MsgVpnClientUsernameResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientUsernameResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnClientUsernameResponse(MsgVpnClientUsername data = default(MsgVpnClientUsername), MsgVpnClientUsernameLinks links = default(MsgVpnClientUsernameLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnClientUsernameResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnClientUsername Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnClientUsernameLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnClientUsernameResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnClientUsernameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientUsernameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientUsernameResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileAccessLevelGroup :  IEquatable<OauthProfileAccessLevelGroup>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The default message VPN access level for this group. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;none\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - User has no access to a Message VPN. \&quot;read-only\&quot; - User has read-only access to a Message VPN. \&quot;read-write\&quot; - User has read-write access to most Message VPN settings. &lt;/pre&gt; </value>
        [DataMember(Name="msgVpnAccessLevel", EmitDefaultValue=false)]
        public MsgVpnAccessLevelEnum? MsgVpnAccessLevel { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileAccessLevelGroup" /> class.
        /// </summary>
        /// <param name="description">A description for the group. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        /// <param name="globalAccessLevel">The global access level for this group. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;none\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - User has no access to global data. \&quot;read-only\&quot; - User has read-only access to global data. \&quot;read-write\&quot; - User has read-write access to most global data. \&quot;admin\&quot; - User has read-write access to all global data. &lt;/pre&gt; .</param>
        /// <param name="groupName">The name of the group..</param>
        /// <param name="msgVpnAccessLevel">The default message VPN access level for this group. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;none\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - User has no access to a Message VPN. \&quot;read-only\&quot; - User has read-only access to a Message VPN. \&quot;read-write\&quot; - User has read-write access to most Message VPN settings. &lt;/pre&gt; .</param>
        /// <param name="oauthProfileName">The name of the OAuth profile..</param>
        public OauthProfileAccessLevelGroup(string description = default(string), GlobalAccessLevelEnum? globalAccessLevel = default(GlobalAccessLevelEnum?), string groupName = default(string), MsgVpnAccessLevelEnum? msgVpnAccessLevel = default(MsgVpnAccessLevelEnum?), string oauthProfileName = default(string))
        {
        ...
        /// </summary>
        /// <value>A description for the group. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MsgVpnAccessLevel: ").Append(MsgVpnAccessLevel).Append("\n");
        ...
        {
            return this.Equals(input as OauthProfileAccessLevelGroup);
        }

        /// <summary>
        /// Returns true if OauthProfileAccessLevelGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileAccessLevelGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileAccessLevelGroup input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MsgVpnAccessLevel == input.MsgVpnAccessLevel ||
                    (this.MsgVpnAccessLevel != null &&
                    this.MsgVpnAccessLevel.Equals(input.MsgVpnAccessLevel))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MsgVpnAccessLevel != null)
                    hashCode = hashCode * 59 + this.MsgVpnAccessLevel.GetHashCode();

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientUsernameAttribute :  IEquatable<MsgVpnClientUsernameAttribute>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientUsernameAttribute" /> class.
        /// </summary>
        ...
        public MsgVpnClientUsernameAttribute(string attributeName = default(string), string attributeValue = default(string), string clientUsername = default(string), string msgVpnName = default(string))
        {
        ...
        {
            return this.Equals(input as MsgVpnClientUsernameAttribute);
        }

        /// <summary>
        /// Returns true if MsgVpnClientUsernameAttribute instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientUsernameAttribute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientUsernameAttribute input)
        {
            if (input == null)
                return false;

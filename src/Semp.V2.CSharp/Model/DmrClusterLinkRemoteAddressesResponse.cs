...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkRemoteAddressesResponse :  IEquatable<DmrClusterLinkRemoteAddressesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkRemoteAddressesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterLinkRemoteAddressesResponse(List<DmrClusterLinkRemoteAddress> data = default(List<DmrClusterLinkRemoteAddress>), List<DmrClusterLinkRemoteAddressLinks> links = default(List<DmrClusterLinkRemoteAddressLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterLinkRemoteAddressesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DmrClusterLinkRemoteAddress> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DmrClusterLinkRemoteAddressLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterLinkRemoteAddressesResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkRemoteAddressesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkRemoteAddressesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkRemoteAddressesResponse input)
        {
            if (input == null)
                return false;

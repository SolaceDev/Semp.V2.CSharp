...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRuleAttributeFilterResponse :  IEquatable<DmrClusterCertMatchingRuleAttributeFilterResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRuleAttributeFilterResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterCertMatchingRuleAttributeFilterResponse(DmrClusterCertMatchingRuleAttributeFilter data = default(DmrClusterCertMatchingRuleAttributeFilter), DmrClusterCertMatchingRuleAttributeFilterLinks links = default(DmrClusterCertMatchingRuleAttributeFilterLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterCertMatchingRuleAttributeFilterResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DmrClusterCertMatchingRuleAttributeFilter Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DmrClusterCertMatchingRuleAttributeFilterLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRuleAttributeFilterResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRuleAttributeFilterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRuleAttributeFilterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRuleAttributeFilterResponse input)
        {
            if (input == null)
                return false;

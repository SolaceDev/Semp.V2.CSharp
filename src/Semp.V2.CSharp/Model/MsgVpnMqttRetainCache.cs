...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttRetainCache :  IEquatable<MsgVpnMqttRetainCache>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttRetainCache" /> class.
        /// </summary>
        /// <param name="cacheName">The name of the MQTT Retain Cache..</param>
        /// <param name="enabled">Enable or disable this MQTT Retain Cache. When the cache is disabled, neither retain messages nor retain requests will be delivered by the cache. However, live retain messages will continue to be delivered to currently connected MQTT clients. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        ...
        public MsgVpnMqttRetainCache(string cacheName = default(string), bool? enabled = default(bool?), long? msgLifetime = default(long?), string msgVpnName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the MQTT Retain Cache.</value>
        ...
        /// </summary>
        /// <value>Enable or disable this MQTT Retain Cache. When the cache is disabled, neither retain messages nor retain requests will be delivered by the cache. However, live retain messages will continue to be delivered to currently connected MQTT clients. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        {
            return this.Equals(input as MsgVpnMqttRetainCache);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttRetainCache instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttRetainCache to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttRetainCache input)
        {
            if (input == null)
                return false;

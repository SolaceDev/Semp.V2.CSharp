...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplayLogTopicFilterSubscriptionsResponse :  IEquatable<MsgVpnReplayLogTopicFilterSubscriptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplayLogTopicFilterSubscriptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnReplayLogTopicFilterSubscriptionsResponse(List<MsgVpnReplayLogTopicFilterSubscription> data = default(List<MsgVpnReplayLogTopicFilterSubscription>), List<MsgVpnReplayLogTopicFilterSubscriptionLinks> links = default(List<MsgVpnReplayLogTopicFilterSubscriptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnReplayLogTopicFilterSubscriptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnReplayLogTopicFilterSubscription> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnReplayLogTopicFilterSubscriptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnReplayLogTopicFilterSubscriptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnReplayLogTopicFilterSubscriptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplayLogTopicFilterSubscriptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplayLogTopicFilterSubscriptionsResponse input)
        {
            if (input == null)
                return false;

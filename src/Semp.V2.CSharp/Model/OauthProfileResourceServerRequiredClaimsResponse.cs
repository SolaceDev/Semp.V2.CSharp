...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileResourceServerRequiredClaimsResponse :  IEquatable<OauthProfileResourceServerRequiredClaimsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileResourceServerRequiredClaimsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileResourceServerRequiredClaimsResponse(List<OauthProfileResourceServerRequiredClaim> data = default(List<OauthProfileResourceServerRequiredClaim>), List<OauthProfileResourceServerRequiredClaimLinks> links = default(List<OauthProfileResourceServerRequiredClaimLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileResourceServerRequiredClaimsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<OauthProfileResourceServerRequiredClaim> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<OauthProfileResourceServerRequiredClaimLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileResourceServerRequiredClaimsResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileResourceServerRequiredClaimsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileResourceServerRequiredClaimsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileResourceServerRequiredClaimsResponse input)
        {
            if (input == null)
                return false;

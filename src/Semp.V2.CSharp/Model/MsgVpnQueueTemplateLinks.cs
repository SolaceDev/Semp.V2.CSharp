...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueTemplateLinks :  IEquatable<MsgVpnQueueTemplateLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueTemplateLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Queue Template object..</param>
        public MsgVpnQueueTemplateLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Queue Template object.</value>
        ...
        {
            return this.Equals(input as MsgVpnQueueTemplateLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueTemplateLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueTemplateLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueTemplateLinks input)
        {
            if (input == null)
                return false;

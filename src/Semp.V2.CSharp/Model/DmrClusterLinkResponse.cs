...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkResponse :  IEquatable<DmrClusterLinkResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterLinkResponse(DmrClusterLink data = default(DmrClusterLink), DmrClusterLinkLinks links = default(DmrClusterLinkLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterLinkResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DmrClusterLink Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DmrClusterLinkLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterLinkResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkResponse input)
        {
            if (input == null)
                return false;

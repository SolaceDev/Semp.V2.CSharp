...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleCondition :  IEquatable<MsgVpnCertMatchingRuleCondition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleCondition" /> class.
        /// </summary>
        /// <param name="attribute">Client Username Attribute to be compared with certificate content. Either an attribute or an expression must be provided on creation, but not both. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        ...
        public MsgVpnCertMatchingRuleCondition(string attribute = default(string), string expression = default(string), string msgVpnName = default(string), string ruleName = default(string), SourceEnum? source = default(SourceEnum?))
        {
        ...
        /// </summary>
        /// <value>Client Username Attribute to be compared with certificate content. Either an attribute or an expression must be provided on creation, but not both. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleCondition);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleCondition input)
        {
            if (input == null)
                return false;

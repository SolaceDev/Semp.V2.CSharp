...
namespace Semp.V2.CSharp.Model
{
        ...
        public partial class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader :  IEquatable<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader>
    {
        ...
        public MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader(string headerName = default(string), string headerValue = default(string), string msgVpnName = default(string), string queueBindingName = default(string), string restDeliveryPointName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the protected HTTP request header.</value>
        ...
        /// </summary>
        /// <value>The value of the protected HTTP request header. Unlike a non-protected request header, this value cannot be displayed after it is set, and does not support substitution expressions. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader {\n");
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplayLogLinks :  IEquatable<MsgVpnReplayLogLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplayLogLinks" /> class.
        /// </summary>
        /// <param name="topicFilterSubscriptionsUri">The URI of this Replay Log&#x27;s collection of Topic Filter Subscription objects. Available since 2.27..</param>
        /// <param name="uri">The URI of this Replay Log object..</param>
        public MsgVpnReplayLogLinks(string topicFilterSubscriptionsUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Replay Log&#x27;s collection of Topic Filter Subscription objects. Available since 2.27.</value>
        [DataMember(Name="topicFilterSubscriptionsUri", EmitDefaultValue=false)]
        public string TopicFilterSubscriptionsUri { get; set; }

        /// <summary>
        /// The URI of this Replay Log object.
        /// </summary>
        /// <value>The URI of this Replay Log object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TopicFilterSubscriptionsUri: ").Append(TopicFilterSubscriptionsUri).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnReplayLogLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnReplayLogLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplayLogLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplayLogLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TopicFilterSubscriptionsUri == input.TopicFilterSubscriptionsUri ||
                    (this.TopicFilterSubscriptionsUri != null &&
                    this.TopicFilterSubscriptionsUri.Equals(input.TopicFilterSubscriptionsUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.TopicFilterSubscriptionsUri != null)
                    hashCode = hashCode * 59 + this.TopicFilterSubscriptionsUri.GetHashCode();
                if (this.Uri != null)

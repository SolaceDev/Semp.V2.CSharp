...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutUserLinks :  IEquatable<AboutUserLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutUserLinks" /> class.
        /// </summary>
        /// <param name="msgVpnsUri">The URI of this User&#x27;s collection of User Message VPN objects..</param>
        /// <param name="uri">The URI of this User object..</param>
        public AboutUserLinks(string msgVpnsUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this User&#x27;s collection of User Message VPN objects.</value>
        ...
        /// </summary>
        /// <value>The URI of this User object.</value>
        ...
        {
            return this.Equals(input as AboutUserLinks);
        }

        /// <summary>
        /// Returns true if AboutUserLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutUserLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutUserLinks input)
        {
            if (input == null)
                return false;

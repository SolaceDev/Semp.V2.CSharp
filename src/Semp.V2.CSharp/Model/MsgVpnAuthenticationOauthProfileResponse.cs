...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileResponse :  IEquatable<MsgVpnAuthenticationOauthProfileResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthenticationOauthProfileResponse(MsgVpnAuthenticationOauthProfile data = default(MsgVpnAuthenticationOauthProfile), MsgVpnAuthenticationOauthProfileLinks links = default(MsgVpnAuthenticationOauthProfileLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthenticationOauthProfileResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAuthenticationOauthProfile Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAuthenticationOauthProfileLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttSessionsResponse :  IEquatable<MsgVpnMqttSessionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttSessionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnMqttSessionsResponse(List<MsgVpnMqttSession> data = default(List<MsgVpnMqttSession>), List<MsgVpnMqttSessionLinks> links = default(List<MsgVpnMqttSessionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnMqttSessionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnMqttSession> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnMqttSessionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnMqttSessionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttSessionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttSessionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttSessionsResponse input)
        {
            if (input == null)
                return false;

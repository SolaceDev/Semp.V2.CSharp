...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutUserMsgVpnResponse :  IEquatable<AboutUserMsgVpnResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutUserMsgVpnResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public AboutUserMsgVpnResponse(AboutUserMsgVpn data = default(AboutUserMsgVpn), AboutUserMsgVpnLinks links = default(AboutUserMsgVpnLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for AboutUserMsgVpnResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public AboutUserMsgVpn Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public AboutUserMsgVpnLinks Links { get; set; }
        ...
        {
            return this.Equals(input as AboutUserMsgVpnResponse);
        }

        /// <summary>
        /// Returns true if AboutUserMsgVpnResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutUserMsgVpnResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutUserMsgVpnResponse input)
        {
            if (input == null)
                return false;

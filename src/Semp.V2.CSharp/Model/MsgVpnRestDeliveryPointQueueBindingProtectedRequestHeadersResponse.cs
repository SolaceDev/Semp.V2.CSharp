...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse :  IEquatable<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse(List<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader> data = default(List<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader>), List<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks> links = default(List<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks> Links { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name="meta", EmitDefaultValue=false)]
        public SempMeta Meta { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse :  IEquatable<MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse(List<MsgVpnRestDeliveryPointQueueBindingRequestHeader> data = default(List<MsgVpnRestDeliveryPointQueueBindingRequestHeader>), List<MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks> links = default(List<MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnRestDeliveryPointQueueBindingRequestHeader> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse input)
        {
            if (input == null)
                return false;

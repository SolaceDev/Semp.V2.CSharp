...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks :  IEquatable<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks" /> class.
        /// </summary>
        /// <param name="topicPrefixesUri">The URI of this Home Cache Cluster&#x27;s collection of Topic Prefix objects..</param>
        /// <param name="uri">The URI of this Home Cache Cluster object..</param>
        public MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks(string topicPrefixesUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Home Cache Cluster&#x27;s collection of Topic Prefix objects.</value>
        [DataMember(Name="topicPrefixesUri", EmitDefaultValue=false)]
        public string TopicPrefixesUri { get; set; }

        /// <summary>
        /// The URI of this Home Cache Cluster object.
        /// </summary>
        /// <value>The URI of this Home Cache Cluster object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TopicPrefixesUri: ").Append(TopicPrefixesUri).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterGlobalCachingHomeClusterLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TopicPrefixesUri == input.TopicPrefixesUri ||
                    (this.TopicPrefixesUri != null &&
                    this.TopicPrefixesUri.Equals(input.TopicPrefixesUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.TopicPrefixesUri != null)
                    hashCode = hashCode * 59 + this.TopicPrefixesUri.GetHashCode();
                if (this.Uri != null)

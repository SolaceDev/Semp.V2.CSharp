...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileTraceFilterSubscription :  IEquatable<MsgVpnTelemetryProfileTraceFilterSubscription>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The syntax of the trace filter subscription. The allowed values and their meaning are:  &lt;pre&gt; \&quot;smf\&quot; - Subscription uses SMF syntax. \&quot;mqtt\&quot; - Subscription uses MQTT syntax. &lt;/pre&gt; </value>
        [JsonConverter(typeof(StringEnumConverter))]
                public enum SubscriptionSyntaxEnum
        {
            /// <summary>
        ...
        /// </summary>
        /// <value>The syntax of the trace filter subscription. The allowed values and their meaning are:  &lt;pre&gt; \&quot;smf\&quot; - Subscription uses SMF syntax. \&quot;mqtt\&quot; - Subscription uses MQTT syntax. &lt;/pre&gt; </value>
        [DataMember(Name="subscriptionSyntax", EmitDefaultValue=false)]
        public SubscriptionSyntaxEnum? SubscriptionSyntax { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileTraceFilterSubscription" /> class.
        /// </summary>
        ...
        /// <param name="subscriptionSyntax">The syntax of the trace filter subscription. The allowed values and their meaning are:  &lt;pre&gt; \&quot;smf\&quot; - Subscription uses SMF syntax. \&quot;mqtt\&quot; - Subscription uses MQTT syntax. &lt;/pre&gt; .</param>
        ...
        public MsgVpnTelemetryProfileTraceFilterSubscription(string msgVpnName = default(string), string subscription = default(string), SubscriptionSyntaxEnum? subscriptionSyntax = default(SubscriptionSyntaxEnum?), string telemetryProfileName = default(string), string traceFilterName = default(string))
        {
            this.MsgVpnName = msgVpnName;
            this.Subscription = subscription;
            this.SubscriptionSyntax = subscriptionSyntax;
            this.TelemetryProfileName = telemetryProfileName;
            this.TraceFilterName = traceFilterName;
        }
        ...
        /// </summary>
        /// <value>Messages matching this subscription will follow this filter&#x27;s configuration.</value>
        ...
        /// </summary>
        /// <value>A name used to identify the trace filter. Consider a name that describes the subscriptions contained within the filter, such as the name of the application and/or the scenario in which the trace filter might be enabled, such as \&quot;appNameDebug\&quot;.</value>
        [DataMember(Name="traceFilterName", EmitDefaultValue=false)]
        public string TraceFilterName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileTraceFilterSubscription {\n");
            sb.Append("  MsgVpnName: ").Append(MsgVpnName).Append("\n");
            sb.Append("  Subscription: ").Append(Subscription).Append("\n");
            sb.Append("  SubscriptionSyntax: ").Append(SubscriptionSyntax).Append("\n");
            sb.Append("  TelemetryProfileName: ").Append(TelemetryProfileName).Append("\n");
            sb.Append("  TraceFilterName: ").Append(TraceFilterName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileTraceFilterSubscription);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileTraceFilterSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileTraceFilterSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileTraceFilterSubscription input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SubscriptionSyntax == input.SubscriptionSyntax ||
                    (this.SubscriptionSyntax != null &&
                    this.SubscriptionSyntax.Equals(input.SubscriptionSyntax))
                ) && 
                (
                ...
                (
                    this.TraceFilterName == input.TraceFilterName ||
                    (this.TraceFilterName != null &&
                    this.TraceFilterName.Equals(input.TraceFilterName))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SubscriptionSyntax != null)
                    hashCode = hashCode * 59 + this.SubscriptionSyntax.GetHashCode();
                if (this.TelemetryProfileName != null)
                    hashCode = hashCode * 59 + this.TelemetryProfileName.GetHashCode();
                if (this.TraceFilterName != null)
                    hashCode = hashCode * 59 + this.TraceFilterName.GetHashCode();
                return hashCode;
            }
        }
    }

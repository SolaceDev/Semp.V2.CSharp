...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkTlsTrustedCommonNameResponse :  IEquatable<DmrClusterLinkTlsTrustedCommonNameResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkTlsTrustedCommonNameResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterLinkTlsTrustedCommonNameResponse(DmrClusterLinkTlsTrustedCommonName data = default(DmrClusterLinkTlsTrustedCommonName), DmrClusterLinkTlsTrustedCommonNameLinks links = default(DmrClusterLinkTlsTrustedCommonNameLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterLinkTlsTrustedCommonNameResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DmrClusterLinkTlsTrustedCommonName Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DmrClusterLinkTlsTrustedCommonNameLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterLinkTlsTrustedCommonNameResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkTlsTrustedCommonNameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkTlsTrustedCommonNameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkTlsTrustedCommonNameResponse input)
        {
            if (input == null)
                return false;

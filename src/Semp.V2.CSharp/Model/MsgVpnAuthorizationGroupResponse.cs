...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthorizationGroupResponse :  IEquatable<MsgVpnAuthorizationGroupResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthorizationGroupResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthorizationGroupResponse(MsgVpnAuthorizationGroup data = default(MsgVpnAuthorizationGroup), MsgVpnAuthorizationGroupLinks links = default(MsgVpnAuthorizationGroupLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthorizationGroupResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAuthorizationGroup Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAuthorizationGroupLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthorizationGroupResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthorizationGroupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthorizationGroupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthorizationGroupResponse input)
        {
            if (input == null)
                return false;

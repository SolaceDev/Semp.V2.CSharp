...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplayLog :  IEquatable<MsgVpnReplayLog>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplayLog" /> class.
        /// </summary>
        /// <param name="egressEnabled">Enable or disable the transmission of messages from the Replay Log. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="ingressEnabled">Enable or disable the reception of messages to the Replay Log. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="maxSpoolUsage">The maximum spool usage allowed by the Replay Log, in megabytes (MB). If this limit is exceeded, old messages will be trimmed. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;0&#x60;..</param>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="replayLogName">The name of the Replay Log..</param>
        /// <param name="topicFilterEnabled">Enable or disable topic filtering for the Replay Log. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;. Available since 2.27..</param>
        public MsgVpnReplayLog(bool? egressEnabled = default(bool?), bool? ingressEnabled = default(bool?), long? maxSpoolUsage = default(long?), string msgVpnName = default(string), string replayLogName = default(string), bool? topicFilterEnabled = default(bool?))
        {
        ...
        /// </summary>
        /// <value>Enable or disable the transmission of messages from the Replay Log. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        /// </summary>
        /// <value>Enable or disable the reception of messages to the Replay Log. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        /// </summary>
        /// <value>The maximum spool usage allowed by the Replay Log, in megabytes (MB). If this limit is exceeded, old messages will be trimmed. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;0&#x60;.</value>
        ...
        /// </summary>
        /// <value>The name of the Replay Log.</value>
        [DataMember(Name="replayLogName", EmitDefaultValue=false)]
        public string ReplayLogName { get; set; }
        ...
        /// </summary>
        /// <value>Enable or disable topic filtering for the Replay Log. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;. Available since 2.27.</value>
        [DataMember(Name="topicFilterEnabled", EmitDefaultValue=false)]
        public bool? TopicFilterEnabled { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReplayLogName: ").Append(ReplayLogName).Append("\n");
            sb.Append("  TopicFilterEnabled: ").Append(TopicFilterEnabled).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnReplayLog);
        }

        /// <summary>
        /// Returns true if MsgVpnReplayLog instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplayLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplayLog input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReplayLogName == input.ReplayLogName ||
                    (this.ReplayLogName != null &&
                    this.ReplayLogName.Equals(input.ReplayLogName))
                ) && 
                (
                    this.TopicFilterEnabled == input.TopicFilterEnabled ||
                    (this.TopicFilterEnabled != null &&
                    this.TopicFilterEnabled.Equals(input.TopicFilterEnabled))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReplayLogName != null)
                    hashCode = hashCode * 59 + this.ReplayLogName.GetHashCode();
                if (this.TopicFilterEnabled != null)
                    hashCode = hashCode * 59 + this.TopicFilterEnabled.GetHashCode();
                return hashCode;
            }
        }
    }

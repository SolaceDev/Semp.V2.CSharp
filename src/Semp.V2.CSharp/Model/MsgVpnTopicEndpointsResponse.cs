...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTopicEndpointsResponse :  IEquatable<MsgVpnTopicEndpointsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTopicEndpointsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTopicEndpointsResponse(List<MsgVpnTopicEndpoint> data = default(List<MsgVpnTopicEndpoint>), List<MsgVpnTopicEndpointLinks> links = default(List<MsgVpnTopicEndpointLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTopicEndpointsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnTopicEndpoint> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnTopicEndpointLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnTopicEndpointsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTopicEndpointsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTopicEndpointsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTopicEndpointsResponse input)
        {
            if (input == null)
                return false;

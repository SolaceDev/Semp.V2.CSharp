...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeTopicExceptionResponse :  IEquatable<MsgVpnAclProfileSubscribeTopicExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeTopicExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileSubscribeTopicExceptionResponse(MsgVpnAclProfileSubscribeTopicException data = default(MsgVpnAclProfileSubscribeTopicException), MsgVpnAclProfileSubscribeTopicExceptionLinks links = default(MsgVpnAclProfileSubscribeTopicExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileSubscribeTopicExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAclProfileSubscribeTopicException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAclProfileSubscribeTopicExceptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeTopicExceptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeTopicExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeTopicExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeTopicExceptionResponse input)
        {
            if (input == null)
                return false;

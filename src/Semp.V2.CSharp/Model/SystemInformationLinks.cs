...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SystemInformationLinks :  IEquatable<SystemInformationLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemInformationLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this System Information object..</param>
        public SystemInformationLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this System Information object.</value>
        ...
        {
            return this.Equals(input as SystemInformationLinks);
        }

        /// <summary>
        /// Returns true if SystemInformationLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemInformationLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemInformationLinks input)
        {
            if (input == null)
                return false;

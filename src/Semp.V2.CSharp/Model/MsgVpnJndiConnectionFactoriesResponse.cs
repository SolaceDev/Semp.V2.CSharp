...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiConnectionFactoriesResponse :  IEquatable<MsgVpnJndiConnectionFactoriesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiConnectionFactoriesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnJndiConnectionFactoriesResponse(List<MsgVpnJndiConnectionFactory> data = default(List<MsgVpnJndiConnectionFactory>), List<MsgVpnJndiConnectionFactoryLinks> links = default(List<MsgVpnJndiConnectionFactoryLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnJndiConnectionFactoriesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnJndiConnectionFactory> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnJndiConnectionFactoryLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnJndiConnectionFactoriesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiConnectionFactoriesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiConnectionFactoriesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiConnectionFactoriesResponse input)
        {
            if (input == null)
                return false;

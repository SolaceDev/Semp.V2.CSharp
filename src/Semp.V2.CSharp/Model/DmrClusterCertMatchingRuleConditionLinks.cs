...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRuleConditionLinks :  IEquatable<DmrClusterCertMatchingRuleConditionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRuleConditionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Certificate Matching Rule Condition object..</param>
        public DmrClusterCertMatchingRuleConditionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Certificate Matching Rule Condition object.</value>
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRuleConditionLinks);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRuleConditionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRuleConditionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRuleConditionLinks input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplicatedTopicLinks :  IEquatable<MsgVpnReplicatedTopicLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplicatedTopicLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Replicated Topic object..</param>
        public MsgVpnReplicatedTopicLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Replicated Topic object.</value>
        ...
        {
            return this.Equals(input as MsgVpnReplicatedTopicLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnReplicatedTopicLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplicatedTopicLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplicatedTopicLinks input)
        {
            if (input == null)
                return false;

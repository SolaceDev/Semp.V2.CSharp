...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientAuthorizationParameter :  IEquatable<OauthProfileClientAuthorizationParameter>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientAuthorizationParameter" /> class.
        /// </summary>
        /// <param name="authorizationParameterName">The name of the authorization parameter..</param>
        /// <param name="authorizationParameterValue">The authorization parameter value. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        /// <param name="oauthProfileName">The name of the OAuth profile..</param>
        public OauthProfileClientAuthorizationParameter(string authorizationParameterName = default(string), string authorizationParameterValue = default(string), string oauthProfileName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the authorization parameter.</value>
        [DataMember(Name="authorizationParameterName", EmitDefaultValue=false)]
        public string AuthorizationParameterName { get; set; }
        ...
        /// </summary>
        /// <value>The authorization parameter value. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        [DataMember(Name="authorizationParameterValue", EmitDefaultValue=false)]
        public string AuthorizationParameterValue { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AuthorizationParameterName: ").Append(AuthorizationParameterName).Append("\n");
            sb.Append("  AuthorizationParameterValue: ").Append(AuthorizationParameterValue).Append("\n");
        ...
        {
            return this.Equals(input as OauthProfileClientAuthorizationParameter);
        }

        /// <summary>
        /// Returns true if OauthProfileClientAuthorizationParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientAuthorizationParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientAuthorizationParameter input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AuthorizationParameterName == input.AuthorizationParameterName ||
                    (this.AuthorizationParameterName != null &&
                    this.AuthorizationParameterName.Equals(input.AuthorizationParameterName))
                ) && 
                (
                    this.AuthorizationParameterValue == input.AuthorizationParameterValue ||
                    (this.AuthorizationParameterValue != null &&
                    this.AuthorizationParameterValue.Equals(input.AuthorizationParameterValue))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AuthorizationParameterName != null)
                    hashCode = hashCode * 59 + this.AuthorizationParameterName.GetHashCode();
                if (this.AuthorizationParameterValue != null)
                    hashCode = hashCode * 59 + this.AuthorizationParameterValue.GetHashCode();

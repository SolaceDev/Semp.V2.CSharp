...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileDefaultMsgVpnAccessLevelExceptionResponse :  IEquatable<OauthProfileDefaultMsgVpnAccessLevelExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileDefaultMsgVpnAccessLevelExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileDefaultMsgVpnAccessLevelExceptionResponse(OauthProfileDefaultMsgVpnAccessLevelException data = default(OauthProfileDefaultMsgVpnAccessLevelException), OauthProfileDefaultMsgVpnAccessLevelExceptionLinks links = default(OauthProfileDefaultMsgVpnAccessLevelExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileDefaultMsgVpnAccessLevelExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public OauthProfileDefaultMsgVpnAccessLevelException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public OauthProfileDefaultMsgVpnAccessLevelExceptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileDefaultMsgVpnAccessLevelExceptionResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileDefaultMsgVpnAccessLevelExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileDefaultMsgVpnAccessLevelExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileDefaultMsgVpnAccessLevelExceptionResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterInstance :  IEquatable<MsgVpnDistributedCacheClusterInstance>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterInstance" /> class.
        /// </summary>
        /// <param name="autoStartEnabled">Enable or disable auto-start for the Cache Instance. When enabled, the Cache Instance will automatically attempt to transition from the Stopped operational state to Up whenever it restarts or reconnects to the message broker. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="cacheName">The name of the Distributed Cache..</param>
        /// <param name="clusterName">The name of the Cache Cluster..</param>
        /// <param name="enabled">Enable or disable the Cache Instance. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="instanceName">The name of the Cache Instance..</param>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="stopOnLostMsgEnabled">Enable or disable stop-on-lost-message for the Cache Instance. When enabled, the Cache Instance will transition to the stopped operational state upon losing a message. When stopped, it cannot accept or respond to cache requests, but continues to cache messages. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;true&#x60;..</param>
        public MsgVpnDistributedCacheClusterInstance(bool? autoStartEnabled = default(bool?), string cacheName = default(string), string clusterName = default(string), bool? enabled = default(bool?), string instanceName = default(string), string msgVpnName = default(string), bool? stopOnLostMsgEnabled = default(bool?))
        {
        ...
        /// </summary>
        /// <value>Enable or disable auto-start for the Cache Instance. When enabled, the Cache Instance will automatically attempt to transition from the Stopped operational state to Up whenever it restarts or reconnects to the message broker. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        [DataMember(Name="autoStartEnabled", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Enable or disable the Cache Instance. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        /// </summary>
        /// <value>The name of the Cache Instance.</value>
        ...
        /// </summary>
        /// <value>Enable or disable stop-on-lost-message for the Cache Instance. When enabled, the Cache Instance will transition to the stopped operational state upon losing a message. When stopped, it cannot accept or respond to cache requests, but continues to cache messages. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;true&#x60;.</value>
        [DataMember(Name="stopOnLostMsgEnabled", EmitDefaultValue=false)]
        public bool? StopOnLostMsgEnabled { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AutoStartEnabled: ").Append(AutoStartEnabled).Append("\n");
            sb.Append("  CacheName: ").Append(CacheName).Append("\n");
            sb.Append("  ClusterName: ").Append(ClusterName).Append("\n");
            sb.Append("  Enabled: ").Append(Enabled).Append("\n");
            sb.Append("  InstanceName: ").Append(InstanceName).Append("\n");
            sb.Append("  MsgVpnName: ").Append(MsgVpnName).Append("\n");
            sb.Append("  StopOnLostMsgEnabled: ").Append(StopOnLostMsgEnabled).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterInstance);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterInstance instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterInstance input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AutoStartEnabled == input.AutoStartEnabled ||
                    (this.AutoStartEnabled != null &&
                    this.AutoStartEnabled.Equals(input.AutoStartEnabled))
                ) && 
                (
                ...
                (
                    this.StopOnLostMsgEnabled == input.StopOnLostMsgEnabled ||
                    (this.StopOnLostMsgEnabled != null &&
                    this.StopOnLostMsgEnabled.Equals(input.StopOnLostMsgEnabled))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AutoStartEnabled != null)
                    hashCode = hashCode * 59 + this.AutoStartEnabled.GetHashCode();
                ...
                if (this.StopOnLostMsgEnabled != null)
                    hashCode = hashCode * 59 + this.StopOnLostMsgEnabled.GetHashCode();
                return hashCode;
            }
        }
    }

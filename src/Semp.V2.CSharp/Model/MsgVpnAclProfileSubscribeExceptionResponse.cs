...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeExceptionResponse :  IEquatable<MsgVpnAclProfileSubscribeExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileSubscribeExceptionResponse(MsgVpnAclProfileSubscribeException data = default(MsgVpnAclProfileSubscribeException), MsgVpnAclProfileSubscribeExceptionLinks links = default(MsgVpnAclProfileSubscribeExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileSubscribeExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAclProfileSubscribeException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAclProfileSubscribeExceptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeExceptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeExceptionResponse input)
        {
            if (input == null)
                return false;

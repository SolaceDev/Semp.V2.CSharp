...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueTemplateResponse :  IEquatable<MsgVpnQueueTemplateResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueTemplateResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnQueueTemplateResponse(MsgVpnQueueTemplate data = default(MsgVpnQueueTemplate), MsgVpnQueueTemplateLinks links = default(MsgVpnQueueTemplateLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnQueueTemplateResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnQueueTemplate Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnQueueTemplateLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnQueueTemplateResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueTemplateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueTemplateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueTemplateResponse input)
        {
            if (input == null)
                return false;

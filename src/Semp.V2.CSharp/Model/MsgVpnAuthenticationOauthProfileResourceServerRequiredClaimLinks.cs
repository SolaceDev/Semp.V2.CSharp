...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks :  IEquatable<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Required Claim object..</param>
        public MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Required Claim object.</value>
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks input)
        {
            if (input == null)
                return false;

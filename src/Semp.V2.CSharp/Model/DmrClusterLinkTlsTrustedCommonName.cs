...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkTlsTrustedCommonName :  IEquatable<DmrClusterLinkTlsTrustedCommonName>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkTlsTrustedCommonName" /> class.
        /// </summary>
        /// <param name="dmrClusterName">The name of the Cluster. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation..</param>
        /// <param name="remoteNodeName">The name of the node at the remote end of the Link. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation..</param>
        ...
        public DmrClusterLinkTlsTrustedCommonName(string dmrClusterName = default(string), string remoteNodeName = default(string), string tlsTrustedCommonName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the Cluster. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        /// </summary>
        /// <value>The name of the node at the remote end of the Link. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        {
            return this.Equals(input as DmrClusterLinkTlsTrustedCommonName);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkTlsTrustedCommonName instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkTlsTrustedCommonName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkTlsTrustedCommonName input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse :  IEquatable<OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse(List<OauthProfileDefaultMsgVpnAccessLevelException> data = default(List<OauthProfileDefaultMsgVpnAccessLevelException>), List<OauthProfileDefaultMsgVpnAccessLevelExceptionLinks> links = default(List<OauthProfileDefaultMsgVpnAccessLevelExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<OauthProfileDefaultMsgVpnAccessLevelException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<OauthProfileDefaultMsgVpnAccessLevelExceptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileDefaultMsgVpnAccessLevelExceptionsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiTopicsResponse :  IEquatable<MsgVpnJndiTopicsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiTopicsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnJndiTopicsResponse(List<MsgVpnJndiTopic> data = default(List<MsgVpnJndiTopic>), List<MsgVpnJndiTopicLinks> links = default(List<MsgVpnJndiTopicLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnJndiTopicsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnJndiTopic> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnJndiTopicLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnJndiTopicsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiTopicsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiTopicsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiTopicsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkTlsTrustedCommonNameLinks :  IEquatable<DmrClusterLinkTlsTrustedCommonNameLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkTlsTrustedCommonNameLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Trusted Common Name object..</param>
        public DmrClusterLinkTlsTrustedCommonNameLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as DmrClusterLinkTlsTrustedCommonNameLinks);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkTlsTrustedCommonNameLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkTlsTrustedCommonNameLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkTlsTrustedCommonNameLinks input)
        {
            if (input == null)
                return false;

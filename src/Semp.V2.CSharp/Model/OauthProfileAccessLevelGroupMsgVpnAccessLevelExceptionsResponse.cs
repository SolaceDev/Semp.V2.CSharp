...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse :  IEquatable<OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse(List<OauthProfileAccessLevelGroupMsgVpnAccessLevelException> data = default(List<OauthProfileAccessLevelGroupMsgVpnAccessLevelException>), List<OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks> links = default(List<OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<OauthProfileAccessLevelGroupMsgVpnAccessLevelException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionsResponse input)
        {
            if (input == null)
                return false;

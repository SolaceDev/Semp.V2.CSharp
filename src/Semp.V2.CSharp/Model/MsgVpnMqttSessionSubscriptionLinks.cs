...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttSessionSubscriptionLinks :  IEquatable<MsgVpnMqttSessionSubscriptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttSessionSubscriptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Subscription object..</param>
        public MsgVpnMqttSessionSubscriptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Subscription object.</value>
        ...
        {
            return this.Equals(input as MsgVpnMqttSessionSubscriptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttSessionSubscriptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttSessionSubscriptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttSessionSubscriptionLinks input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CertAuthorityOcspTlsTrustedCommonNameLinks :  IEquatable<CertAuthorityOcspTlsTrustedCommonNameLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertAuthorityOcspTlsTrustedCommonNameLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this OCSP Responder Trusted Common Name object..</param>
        public CertAuthorityOcspTlsTrustedCommonNameLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as CertAuthorityOcspTlsTrustedCommonNameLinks);
        }

        /// <summary>
        /// Returns true if CertAuthorityOcspTlsTrustedCommonNameLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of CertAuthorityOcspTlsTrustedCommonNameLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertAuthorityOcspTlsTrustedCommonNameLinks input)
        {
            if (input == null)
                return false;

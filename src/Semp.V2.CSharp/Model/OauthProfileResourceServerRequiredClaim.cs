...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileResourceServerRequiredClaim :  IEquatable<OauthProfileResourceServerRequiredClaim>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileResourceServerRequiredClaim" /> class.
        /// </summary>
        ...
        /// <param name="resourceServerRequiredClaimValue">The required claim value, which must be a string containing a valid JSON value..</param>
        public OauthProfileResourceServerRequiredClaim(string oauthProfileName = default(string), string resourceServerRequiredClaimName = default(string), string resourceServerRequiredClaimValue = default(string))
        {
        ...
        /// </summary>
        /// <value>The required claim value, which must be a string containing a valid JSON value.</value>
        ...
        {
            return this.Equals(input as OauthProfileResourceServerRequiredClaim);
        }

        /// <summary>
        /// Returns true if OauthProfileResourceServerRequiredClaim instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileResourceServerRequiredClaim to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileResourceServerRequiredClaim input)
        {
            if (input == null)
                return false;

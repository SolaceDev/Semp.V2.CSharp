...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnSequencedTopicResponse :  IEquatable<MsgVpnSequencedTopicResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnSequencedTopicResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnSequencedTopicResponse(MsgVpnSequencedTopic data = default(MsgVpnSequencedTopic), MsgVpnSequencedTopicLinks links = default(MsgVpnSequencedTopicLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnSequencedTopicResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnSequencedTopic Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnSequencedTopicLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnSequencedTopicResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnSequencedTopicResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnSequencedTopicResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnSequencedTopicResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileDefaultMsgVpnAccessLevelExceptionLinks :  IEquatable<OauthProfileDefaultMsgVpnAccessLevelExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileDefaultMsgVpnAccessLevelExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Message VPN Access-Level Exception object..</param>
        public OauthProfileDefaultMsgVpnAccessLevelExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as OauthProfileDefaultMsgVpnAccessLevelExceptionLinks);
        }

        /// <summary>
        /// Returns true if OauthProfileDefaultMsgVpnAccessLevelExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileDefaultMsgVpnAccessLevelExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileDefaultMsgVpnAccessLevelExceptionLinks input)
        {
            if (input == null)
                return false;

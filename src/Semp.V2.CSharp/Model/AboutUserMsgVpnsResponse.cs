...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutUserMsgVpnsResponse :  IEquatable<AboutUserMsgVpnsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutUserMsgVpnsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public AboutUserMsgVpnsResponse(List<AboutUserMsgVpn> data = default(List<AboutUserMsgVpn>), List<AboutUserMsgVpnLinks> links = default(List<AboutUserMsgVpnLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for AboutUserMsgVpnsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<AboutUserMsgVpn> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<AboutUserMsgVpnLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as AboutUserMsgVpnsResponse);
        }

        /// <summary>
        /// Returns true if AboutUserMsgVpnsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutUserMsgVpnsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutUserMsgVpnsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientProfilesResponse :  IEquatable<MsgVpnClientProfilesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientProfilesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnClientProfilesResponse(List<MsgVpnClientProfile> data = default(List<MsgVpnClientProfile>), List<MsgVpnClientProfileLinks> links = default(List<MsgVpnClientProfileLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnClientProfilesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnClientProfile> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnClientProfileLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnClientProfilesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnClientProfilesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientProfilesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientProfilesResponse input)
        {
            if (input == null)
                return false;

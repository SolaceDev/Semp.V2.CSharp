...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks :  IEquatable<MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Receiver ACL Connect Exception object..</param>
        public MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Receiver ACL Connect Exception object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks input)
        {
            if (input == null)
                return false;

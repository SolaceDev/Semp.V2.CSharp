...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheResponse :  IEquatable<MsgVpnDistributedCacheResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheResponse(MsgVpnDistributedCache data = default(MsgVpnDistributedCache), MsgVpnDistributedCacheLinks links = default(MsgVpnDistributedCacheLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnDistributedCache Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnDistributedCacheLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientAllowedHost :  IEquatable<OauthProfileClientAllowedHost>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientAllowedHost" /> class.
        /// </summary>
        ...
        public OauthProfileClientAllowedHost(string allowedHost = default(string), string oauthProfileName = default(string))
        {
        ...
        /// </summary>
        /// <value>An allowed value for the Host header.</value>
        [DataMember(Name="allowedHost", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AllowedHost: ").Append(AllowedHost).Append("\n");
        ...
        {
            return this.Equals(input as OauthProfileClientAllowedHost);
        }

        /// <summary>
        /// Returns true if OauthProfileClientAllowedHost instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientAllowedHost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientAllowedHost input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AllowedHost == input.AllowedHost ||
                    (this.AllowedHost != null &&
                    this.AllowedHost.Equals(input.AllowedHost))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AllowedHost != null)
                    hashCode = hashCode * 59 + this.AllowedHost.GetHashCode();

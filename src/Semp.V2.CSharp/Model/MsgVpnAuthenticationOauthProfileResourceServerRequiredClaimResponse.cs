...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse :  IEquatable<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse(MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim data = default(MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim), MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks links = default(MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimResponse input)
        {
            if (input == null)
                return false;

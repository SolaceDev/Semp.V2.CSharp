...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfilePublishTopicExceptionsResponse :  IEquatable<MsgVpnAclProfilePublishTopicExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfilePublishTopicExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfilePublishTopicExceptionsResponse(List<MsgVpnAclProfilePublishTopicException> data = default(List<MsgVpnAclProfilePublishTopicException>), List<MsgVpnAclProfilePublishTopicExceptionLinks> links = default(List<MsgVpnAclProfilePublishTopicExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfilePublishTopicExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAclProfilePublishTopicException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAclProfilePublishTopicExceptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfilePublishTopicExceptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfilePublishTopicExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfilePublishTopicExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfilePublishTopicExceptionsResponse input)
        {
            if (input == null)
                return false;

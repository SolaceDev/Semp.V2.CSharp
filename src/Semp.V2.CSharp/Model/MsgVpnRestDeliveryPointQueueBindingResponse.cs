...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingResponse :  IEquatable<MsgVpnRestDeliveryPointQueueBindingResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointQueueBindingResponse(MsgVpnRestDeliveryPointQueueBinding data = default(MsgVpnRestDeliveryPointQueueBinding), MsgVpnRestDeliveryPointQueueBindingLinks links = default(MsgVpnRestDeliveryPointQueueBindingLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointQueueBindingResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnRestDeliveryPointQueueBinding Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnRestDeliveryPointQueueBindingLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingResponse input)
        {
            if (input == null)
                return false;

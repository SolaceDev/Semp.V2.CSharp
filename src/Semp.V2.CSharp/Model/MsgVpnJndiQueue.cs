...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiQueue :  IEquatable<MsgVpnJndiQueue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiQueue" /> class.
        /// </summary>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="physicalName">The physical name of the JMS Queue. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        /// <param name="queueName">The JNDI name of the JMS Queue..</param>
        public MsgVpnJndiQueue(string msgVpnName = default(string), string physicalName = default(string), string queueName = default(string))
        {
        ...
        /// </summary>
        /// <value>The physical name of the JMS Queue. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        /// </summary>
        /// <value>The JNDI name of the JMS Queue.</value>
        ...
        {
            return this.Equals(input as MsgVpnJndiQueue);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiQueue instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiQueue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiQueue input)
        {
            if (input == null)
                return false;

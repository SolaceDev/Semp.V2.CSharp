...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttRetainCacheResponse :  IEquatable<MsgVpnMqttRetainCacheResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttRetainCacheResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnMqttRetainCacheResponse(MsgVpnMqttRetainCache data = default(MsgVpnMqttRetainCache), MsgVpnMqttRetainCacheLinks links = default(MsgVpnMqttRetainCacheLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnMqttRetainCacheResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnMqttRetainCache Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnMqttRetainCacheLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnMqttRetainCacheResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttRetainCacheResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttRetainCacheResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttRetainCacheResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SystemInformation :  IEquatable<SystemInformation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemInformation" /> class.
        /// </summary>
        /// <param name="platform">The platform running the SEMP API. Deprecated since 2.2. /systemInformation was replaced by /about/api..</param>
        /// <param name="sempVersion">The version of the SEMP API. Deprecated since 2.2. /systemInformation was replaced by /about/api..</param>
        public SystemInformation(string platform = default(string), string sempVersion = default(string))
        {
        ...
        /// </summary>
        /// <value>The platform running the SEMP API. Deprecated since 2.2. /systemInformation was replaced by /about/api.</value>
        ...
        /// </summary>
        /// <value>The version of the SEMP API. Deprecated since 2.2. /systemInformation was replaced by /about/api.</value>
        [DataMember(Name="sempVersion", EmitDefaultValue=false)]
        public string SempVersion { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SempVersion: ").Append(SempVersion).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(SystemInformation input)
        {
            ...
            return 
                ...
                (
                    this.SempVersion == input.SempVersion ||
                    (this.SempVersion != null &&
                    this.SempVersion.Equals(input.SempVersion))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SempVersion != null)
                    hashCode = hashCode * 59 + this.SempVersion.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DomainCertAuthority :  IEquatable<DomainCertAuthority>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainCertAuthority" /> class.
        /// </summary>
        /// <param name="certAuthorityName">The name of the Certificate Authority..</param>
        /// <param name="certContent">The PEM formatted content for the trusted root certificate of a domain Certificate Authority. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        public DomainCertAuthority(string certAuthorityName = default(string), string certContent = default(string))
        {
        ...
        /// </summary>
        /// <value>The PEM formatted content for the trusted root certificate of a domain Certificate Authority. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        {
            return this.Equals(input as DomainCertAuthority);
        }

        /// <summary>
        /// Returns true if DomainCertAuthority instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainCertAuthority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainCertAuthority input)
        {
            if (input == null)
                return false;

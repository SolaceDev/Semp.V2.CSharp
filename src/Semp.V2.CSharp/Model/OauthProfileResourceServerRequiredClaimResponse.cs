...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileResourceServerRequiredClaimResponse :  IEquatable<OauthProfileResourceServerRequiredClaimResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileResourceServerRequiredClaimResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileResourceServerRequiredClaimResponse(OauthProfileResourceServerRequiredClaim data = default(OauthProfileResourceServerRequiredClaim), OauthProfileResourceServerRequiredClaimLinks links = default(OauthProfileResourceServerRequiredClaimLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileResourceServerRequiredClaimResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public OauthProfileResourceServerRequiredClaim Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public OauthProfileResourceServerRequiredClaimLinks Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileResourceServerRequiredClaimResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileResourceServerRequiredClaimResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileResourceServerRequiredClaimResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileResourceServerRequiredClaimResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileTraceFilterResponse :  IEquatable<MsgVpnTelemetryProfileTraceFilterResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileTraceFilterResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTelemetryProfileTraceFilterResponse(MsgVpnTelemetryProfileTraceFilter data = default(MsgVpnTelemetryProfileTraceFilter), MsgVpnTelemetryProfileTraceFilterLinks links = default(MsgVpnTelemetryProfileTraceFilterLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTelemetryProfileTraceFilterResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnTelemetryProfileTraceFilter Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnTelemetryProfileTraceFilterLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileTraceFilterResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileTraceFilterResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileTraceFilterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileTraceFilterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileTraceFilterResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRuleLinks :  IEquatable<DmrClusterCertMatchingRuleLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRuleLinks" /> class.
        /// </summary>
        /// <param name="attributeFiltersUri">The URI of this Certificate Matching Rule&#x27;s collection of Certificate Matching Rule Attribute Filter objects..</param>
        ...
        public DmrClusterCertMatchingRuleLinks(string attributeFiltersUri = default(string), string conditionsUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Certificate Matching Rule&#x27;s collection of Certificate Matching Rule Attribute Filter objects.</value>
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRuleLinks);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRuleLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRuleLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRuleLinks input)
        {
            if (input == null)
                return false;

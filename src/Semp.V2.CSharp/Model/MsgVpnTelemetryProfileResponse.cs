...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileResponse :  IEquatable<MsgVpnTelemetryProfileResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTelemetryProfileResponse(MsgVpnTelemetryProfile data = default(MsgVpnTelemetryProfile), MsgVpnTelemetryProfileLinks links = default(MsgVpnTelemetryProfileLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTelemetryProfileResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnTelemetryProfile Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnTelemetryProfileLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EventThresholdByPercent :  IEquatable<EventThresholdByPercent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventThresholdByPercent" /> class.
        /// </summary>
        /// <param name="clearPercent">The clear threshold for the value of this counter as a percentage of its maximum value. Falling below this value will trigger a corresponding event..</param>
        /// <param name="setPercent">The set threshold for the value of this counter as a percentage of its maximum value. Exceeding this value will trigger a corresponding event..</param>
        public EventThresholdByPercent(long? clearPercent = default(long?), long? setPercent = default(long?))
        {
        ...
        /// </summary>
        /// <value>The clear threshold for the value of this counter as a percentage of its maximum value. Falling below this value will trigger a corresponding event.</value>
        ...
        /// </summary>
        /// <value>The set threshold for the value of this counter as a percentage of its maximum value. Exceeding this value will trigger a corresponding event.</value>
        ...
        {
            return this.Equals(input as EventThresholdByPercent);
        }

        /// <summary>
        /// Returns true if EventThresholdByPercent instances are equal
        /// </summary>
        /// <param name="input">Instance of EventThresholdByPercent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventThresholdByPercent input)
        {
            if (input == null)
                return false;

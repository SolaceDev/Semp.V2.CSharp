...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeShareNameExceptionResponse :  IEquatable<MsgVpnAclProfileSubscribeShareNameExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeShareNameExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileSubscribeShareNameExceptionResponse(MsgVpnAclProfileSubscribeShareNameException data = default(MsgVpnAclProfileSubscribeShareNameException), MsgVpnAclProfileSubscribeShareNameExceptionLinks links = default(MsgVpnAclProfileSubscribeShareNameExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileSubscribeShareNameExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAclProfileSubscribeShareNameException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAclProfileSubscribeShareNameExceptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeShareNameExceptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeShareNameExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeShareNameExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeShareNameExceptionResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeTlsTrustedCommonNameResponse :  IEquatable<MsgVpnBridgeTlsTrustedCommonNameResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeTlsTrustedCommonNameResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnBridgeTlsTrustedCommonNameResponse(MsgVpnBridgeTlsTrustedCommonName data = default(MsgVpnBridgeTlsTrustedCommonName), MsgVpnBridgeTlsTrustedCommonNameLinks links = default(MsgVpnBridgeTlsTrustedCommonNameLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnBridgeTlsTrustedCommonNameResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnBridgeTlsTrustedCommonName Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnBridgeTlsTrustedCommonNameLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnBridgeTlsTrustedCommonNameResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeTlsTrustedCommonNameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeTlsTrustedCommonNameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeTlsTrustedCommonNameResponse input)
        {
            if (input == null)
                return false;

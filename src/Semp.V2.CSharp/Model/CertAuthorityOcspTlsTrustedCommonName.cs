...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CertAuthorityOcspTlsTrustedCommonName :  IEquatable<CertAuthorityOcspTlsTrustedCommonName>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertAuthorityOcspTlsTrustedCommonName" /> class.
        /// </summary>
        /// <param name="certAuthorityName">The name of the Certificate Authority. Deprecated since 2.19. Replaced by clientCertAuthorities..</param>
        /// <param name="ocspTlsTrustedCommonName">The expected Trusted Common Name of the OCSP responder remote certificate. Deprecated since 2.19. Replaced by clientCertAuthorities..</param>
        public CertAuthorityOcspTlsTrustedCommonName(string certAuthorityName = default(string), string ocspTlsTrustedCommonName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the Certificate Authority. Deprecated since 2.19. Replaced by clientCertAuthorities.</value>
        ...
        /// </summary>
        /// <value>The expected Trusted Common Name of the OCSP responder remote certificate. Deprecated since 2.19. Replaced by clientCertAuthorities.</value>
        [DataMember(Name="ocspTlsTrustedCommonName", EmitDefaultValue=false)]
        public string OcspTlsTrustedCommonName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OcspTlsTrustedCommonName: ").Append(OcspTlsTrustedCommonName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CertAuthorityOcspTlsTrustedCommonName);
        }

        /// <summary>
        /// Returns true if CertAuthorityOcspTlsTrustedCommonName instances are equal
        /// </summary>
        /// <param name="input">Instance of CertAuthorityOcspTlsTrustedCommonName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertAuthorityOcspTlsTrustedCommonName input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OcspTlsTrustedCommonName == input.OcspTlsTrustedCommonName ||
                    (this.OcspTlsTrustedCommonName != null &&
                    this.OcspTlsTrustedCommonName.Equals(input.OcspTlsTrustedCommonName))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OcspTlsTrustedCommonName != null)
                    hashCode = hashCode * 59 + this.OcspTlsTrustedCommonName.GetHashCode();
                return hashCode;
            }
        }
    }

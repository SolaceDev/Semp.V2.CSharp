...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim :  IEquatable<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim" /> class.
        /// </summary>
        ...
        /// <param name="resourceServerRequiredClaimValue">The required claim value..</param>
        public MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim(string msgVpnName = default(string), string oauthProfileName = default(string), string resourceServerRequiredClaimName = default(string), string resourceServerRequiredClaimValue = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the access token claim to verify.</value>
        [DataMember(Name="resourceServerRequiredClaimName", EmitDefaultValue=false)]
        public string ResourceServerRequiredClaimName { get; set; }

        /// <summary>
        /// The required claim value.
        /// </summary>
        /// <value>The required claim value.</value>
        [DataMember(Name="resourceServerRequiredClaimValue", EmitDefaultValue=false)]
        public string ResourceServerRequiredClaimValue { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResourceServerRequiredClaimName: ").Append(ResourceServerRequiredClaimName).Append("\n");
            sb.Append("  ResourceServerRequiredClaimValue: ").Append(ResourceServerRequiredClaimValue).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ResourceServerRequiredClaimName == input.ResourceServerRequiredClaimName ||
                    (this.ResourceServerRequiredClaimName != null &&
                    this.ResourceServerRequiredClaimName.Equals(input.ResourceServerRequiredClaimName))
                ) && 
                (
                    this.ResourceServerRequiredClaimValue == input.ResourceServerRequiredClaimValue ||
                    (this.ResourceServerRequiredClaimValue != null &&
                    this.ResourceServerRequiredClaimValue.Equals(input.ResourceServerRequiredClaimValue))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResourceServerRequiredClaimName != null)
                    hashCode = hashCode * 59 + this.ResourceServerRequiredClaimName.GetHashCode();
                if (this.ResourceServerRequiredClaimValue != null)
                    hashCode = hashCode * 59 + this.ResourceServerRequiredClaimValue.GetHashCode();
                return hashCode;
            }
        }
    }

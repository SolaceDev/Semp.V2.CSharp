...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleLinks :  IEquatable<MsgVpnCertMatchingRuleLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleLinks" /> class.
        /// </summary>
        /// <param name="attributeFiltersUri">The URI of this Certificate Matching Rule&#x27;s collection of Certificate Matching Rule Attribute Filter objects. Available since 2.28..</param>
        /// <param name="conditionsUri">The URI of this Certificate Matching Rule&#x27;s collection of Certificate Matching Rule Condition objects..</param>
        /// <param name="uri">The URI of this Certificate Matching Rule object..</param>
        public MsgVpnCertMatchingRuleLinks(string attributeFiltersUri = default(string), string conditionsUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Certificate Matching Rule&#x27;s collection of Certificate Matching Rule Attribute Filter objects. Available since 2.28.</value>
        [DataMember(Name="attributeFiltersUri", EmitDefaultValue=false)]
        public string AttributeFiltersUri { get; set; }

        /// <summary>
        /// The URI of this Certificate Matching Rule&#x27;s collection of Certificate Matching Rule Condition objects.
        /// </summary>
        /// <value>The URI of this Certificate Matching Rule&#x27;s collection of Certificate Matching Rule Condition objects.</value>
        [DataMember(Name="conditionsUri", EmitDefaultValue=false)]
        public string ConditionsUri { get; set; }

        /// <summary>
        /// The URI of this Certificate Matching Rule object.
        /// </summary>
        /// <value>The URI of this Certificate Matching Rule object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AttributeFiltersUri: ").Append(AttributeFiltersUri).Append("\n");
            sb.Append("  ConditionsUri: ").Append(ConditionsUri).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AttributeFiltersUri == input.AttributeFiltersUri ||
                    (this.AttributeFiltersUri != null &&
                    this.AttributeFiltersUri.Equals(input.AttributeFiltersUri))
                ) && 
                (
                    this.ConditionsUri == input.ConditionsUri ||
                    (this.ConditionsUri != null &&
                    this.ConditionsUri.Equals(input.ConditionsUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AttributeFiltersUri != null)
                    hashCode = hashCode * 59 + this.AttributeFiltersUri.GetHashCode();
                if (this.ConditionsUri != null)
                    hashCode = hashCode * 59 + this.ConditionsUri.GetHashCode();
                if (this.Uri != null)

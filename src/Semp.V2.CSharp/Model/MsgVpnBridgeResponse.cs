...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeResponse :  IEquatable<MsgVpnBridgeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnBridgeResponse(MsgVpnBridge data = default(MsgVpnBridge), MsgVpnBridgeLinks links = default(MsgVpnBridgeLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnBridgeResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnBridge Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnBridgeLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnBridgeResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeResponse input)
        {
            if (input == null)
                return false;

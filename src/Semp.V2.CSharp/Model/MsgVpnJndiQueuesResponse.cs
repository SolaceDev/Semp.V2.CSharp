...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiQueuesResponse :  IEquatable<MsgVpnJndiQueuesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiQueuesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnJndiQueuesResponse(List<MsgVpnJndiQueue> data = default(List<MsgVpnJndiQueue>), List<MsgVpnJndiQueueLinks> links = default(List<MsgVpnJndiQueueLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnJndiQueuesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnJndiQueue> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnJndiQueueLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnJndiQueuesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiQueuesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiQueuesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiQueuesResponse input)
        {
            if (input == null)
                return false;

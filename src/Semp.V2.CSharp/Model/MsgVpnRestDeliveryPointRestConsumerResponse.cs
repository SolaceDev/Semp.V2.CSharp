...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerResponse :  IEquatable<MsgVpnRestDeliveryPointRestConsumerResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointRestConsumerResponse(MsgVpnRestDeliveryPointRestConsumer data = default(MsgVpnRestDeliveryPointRestConsumer), MsgVpnRestDeliveryPointRestConsumerLinks links = default(MsgVpnRestDeliveryPointRestConsumerLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointRestConsumerResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnRestDeliveryPointRestConsumer Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnRestDeliveryPointRestConsumerLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerResponse input)
        {
            if (input == null)
                return false;

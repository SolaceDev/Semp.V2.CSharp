...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileTraceFilterLinks :  IEquatable<MsgVpnTelemetryProfileTraceFilterLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileTraceFilterLinks" /> class.
        /// </summary>
        /// <param name="subscriptionsUri">The URI of this Trace Filter&#x27;s collection of Telemetry Trace Filter Subscription objects..</param>
        /// <param name="uri">The URI of this Trace Filter object..</param>
        public MsgVpnTelemetryProfileTraceFilterLinks(string subscriptionsUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Trace Filter&#x27;s collection of Telemetry Trace Filter Subscription objects.</value>
        [DataMember(Name="subscriptionsUri", EmitDefaultValue=false)]
        public string SubscriptionsUri { get; set; }

        /// <summary>
        /// The URI of this Trace Filter object.
        /// </summary>
        /// <value>The URI of this Trace Filter object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileTraceFilterLinks {\n");
            sb.Append("  SubscriptionsUri: ").Append(SubscriptionsUri).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileTraceFilterLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileTraceFilterLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileTraceFilterLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileTraceFilterLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.SubscriptionsUri == input.SubscriptionsUri ||
                    (this.SubscriptionsUri != null &&
                    this.SubscriptionsUri.Equals(input.SubscriptionsUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.SubscriptionsUri != null)
                    hashCode = hashCode * 59 + this.SubscriptionsUri.GetHashCode();
                if (this.Uri != null)

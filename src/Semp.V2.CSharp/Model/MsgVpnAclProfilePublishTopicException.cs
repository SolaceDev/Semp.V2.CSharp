...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfilePublishTopicException :  IEquatable<MsgVpnAclProfilePublishTopicException>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The syntax of the topic for the exception to the default action taken. The allowed values and their meaning are:  &lt;pre&gt; \&quot;smf\&quot; - Topic uses SMF syntax. \&quot;mqtt\&quot; - Topic uses MQTT syntax. &lt;/pre&gt; </value>
        [DataMember(Name="publishTopicExceptionSyntax", EmitDefaultValue=false)]
        public PublishTopicExceptionSyntaxEnum? PublishTopicExceptionSyntax { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfilePublishTopicException" /> class.
        /// </summary>
        ...
        /// <param name="publishTopicExceptionSyntax">The syntax of the topic for the exception to the default action taken. The allowed values and their meaning are:  &lt;pre&gt; \&quot;smf\&quot; - Topic uses SMF syntax. \&quot;mqtt\&quot; - Topic uses MQTT syntax. &lt;/pre&gt; .</param>
        public MsgVpnAclProfilePublishTopicException(string aclProfileName = default(string), string msgVpnName = default(string), string publishTopicException = default(string), PublishTopicExceptionSyntaxEnum? publishTopicExceptionSyntax = default(PublishTopicExceptionSyntaxEnum?))
        {
        ...
        [DataMember(Name="publishTopicException", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PublishTopicException: ").Append(PublishTopicException).Append("\n");
            sb.Append("  PublishTopicExceptionSyntax: ").Append(PublishTopicExceptionSyntax).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnAclProfilePublishTopicException);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfilePublishTopicException instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfilePublishTopicException to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfilePublishTopicException input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PublishTopicException == input.PublishTopicException ||
                    (this.PublishTopicException != null &&
                    this.PublishTopicException.Equals(input.PublishTopicException))
                ) && 
                (
                    this.PublishTopicExceptionSyntax == input.PublishTopicExceptionSyntax ||
                    (this.PublishTopicExceptionSyntax != null &&
                    this.PublishTopicExceptionSyntax.Equals(input.PublishTopicExceptionSyntax))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PublishTopicException != null)
                    hashCode = hashCode * 59 + this.PublishTopicException.GetHashCode();
                if (this.PublishTopicExceptionSyntax != null)
                    hashCode = hashCode * 59 + this.PublishTopicExceptionSyntax.GetHashCode();
                return hashCode;
            }
        }
    }

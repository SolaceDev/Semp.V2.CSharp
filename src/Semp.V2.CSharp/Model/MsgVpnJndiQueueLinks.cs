...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiQueueLinks :  IEquatable<MsgVpnJndiQueueLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiQueueLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this JNDI Queue object..</param>
        public MsgVpnJndiQueueLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this JNDI Queue object.</value>
        ...
        {
            return this.Equals(input as MsgVpnJndiQueueLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiQueueLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiQueueLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiQueueLinks input)
        {
            if (input == null)
                return false;

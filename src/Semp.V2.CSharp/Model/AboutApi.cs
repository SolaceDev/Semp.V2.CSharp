...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutApi :  IEquatable<AboutApi>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutApi" /> class.
        /// </summary>
        /// <param name="platform">The platform running the SEMP API..</param>
        /// <param name="sempVersion">The version of the SEMP API..</param>
        public AboutApi(string platform = default(string), string sempVersion = default(string))
        {
        ...
        /// </summary>
        /// <value>The platform running the SEMP API.</value>
        ...
        /// </summary>
        /// <value>The version of the SEMP API.</value>
        ...
        {
            return this.Equals(input as AboutApi);
        }

        /// <summary>
        /// Returns true if AboutApi instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutApi to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutApi input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientUsernameAttributeLinks :  IEquatable<MsgVpnClientUsernameAttributeLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientUsernameAttributeLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Client Username Attribute object..</param>
        public MsgVpnClientUsernameAttributeLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Client Username Attribute object.</value>
        ...
        {
            return this.Equals(input as MsgVpnClientUsernameAttributeLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnClientUsernameAttributeLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientUsernameAttributeLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientUsernameAttributeLinks input)
        {
            if (input == null)
                return false;

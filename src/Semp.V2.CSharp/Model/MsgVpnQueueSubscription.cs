...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueSubscription :  IEquatable<MsgVpnQueueSubscription>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueSubscription" /> class.
        /// </summary>
        ...
        public MsgVpnQueueSubscription(string msgVpnName = default(string), string queueName = default(string), string subscriptionTopic = default(string))
        {
        ...
        {
            return this.Equals(input as MsgVpnQueueSubscription);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueSubscription input)
        {
            if (input == null)
                return false;

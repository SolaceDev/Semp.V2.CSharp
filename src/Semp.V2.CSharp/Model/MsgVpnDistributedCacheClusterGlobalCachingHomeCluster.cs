...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterGlobalCachingHomeCluster :  IEquatable<MsgVpnDistributedCacheClusterGlobalCachingHomeCluster>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterGlobalCachingHomeCluster" /> class.
        /// </summary>
        ...
        public MsgVpnDistributedCacheClusterGlobalCachingHomeCluster(string cacheName = default(string), string clusterName = default(string), string homeClusterName = default(string), string msgVpnName = default(string))
        {
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterGlobalCachingHomeCluster);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterGlobalCachingHomeCluster instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterGlobalCachingHomeCluster to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterGlobalCachingHomeCluster input)
        {
            if (input == null)
                return false;

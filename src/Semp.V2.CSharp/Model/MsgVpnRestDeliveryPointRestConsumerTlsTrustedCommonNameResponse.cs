...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse :  IEquatable<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse(MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName data = default(MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName), MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks links = default(MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse input)
        {
            if (input == null)
                return false;

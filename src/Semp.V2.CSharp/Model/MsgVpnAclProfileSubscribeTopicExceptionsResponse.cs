...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeTopicExceptionsResponse :  IEquatable<MsgVpnAclProfileSubscribeTopicExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeTopicExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileSubscribeTopicExceptionsResponse(List<MsgVpnAclProfileSubscribeTopicException> data = default(List<MsgVpnAclProfileSubscribeTopicException>), List<MsgVpnAclProfileSubscribeTopicExceptionLinks> links = default(List<MsgVpnAclProfileSubscribeTopicExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileSubscribeTopicExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAclProfileSubscribeTopicException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAclProfileSubscribeTopicExceptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeTopicExceptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeTopicExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeTopicExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeTopicExceptionsResponse input)
        {
            if (input == null)
                return false;

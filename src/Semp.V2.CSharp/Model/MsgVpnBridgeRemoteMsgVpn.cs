...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeRemoteMsgVpn :  IEquatable<MsgVpnBridgeRemoteMsgVpn>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeRemoteMsgVpn" /> class.
        /// </summary>
        ...
        /// <param name="clientUsername">The Client Username the Bridge uses to login to the remote Message VPN. This per remote Message VPN value overrides the value provided for the Bridge overall. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        /// <param name="compressedDataEnabled">Enable or disable data compression for the remote Message VPN connection. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="connectOrder">The preference given to incoming connections from remote Message VPN hosts, from 1 (highest priority) to 4 (lowest priority). Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;4&#x60;..</param>
        /// <param name="egressFlowWindowSize">The number of outstanding guaranteed messages that can be transmitted over the remote Message VPN connection before an acknowledgement is received. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;255&#x60;..</param>
        /// <param name="enabled">Enable or disable the remote Message VPN. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="password">The password for the Client Username. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        /// <param name="queueBinding">The queue binding of the Bridge in the remote Message VPN. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        ...
        /// <param name="tlsEnabled">Enable or disable encryption (TLS) for the remote Message VPN connection. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="unidirectionalClientProfile">The Client Profile for the unidirectional Bridge of the remote Message VPN. The Client Profile must exist in the local Message VPN, and it is used only for the TCP parameters. Note that the default client profile has a TCP maximum window size of 2MB. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;#client-profile\&quot;&#x60;..</param>
        public MsgVpnBridgeRemoteMsgVpn(string bridgeName = default(string), BridgeVirtualRouterEnum? bridgeVirtualRouter = default(BridgeVirtualRouterEnum?), string clientUsername = default(string), bool? compressedDataEnabled = default(bool?), int? connectOrder = default(int?), long? egressFlowWindowSize = default(long?), bool? enabled = default(bool?), string msgVpnName = default(string), string password = default(string), string queueBinding = default(string), string remoteMsgVpnInterface = default(string), string remoteMsgVpnLocation = default(string), string remoteMsgVpnName = default(string), bool? tlsEnabled = default(bool?), string unidirectionalClientProfile = default(string))
        {
        ...
        /// <summary>
        /// The Client Username the Bridge uses to login to the remote Message VPN. This per remote Message VPN value overrides the value provided for the Bridge overall. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.
        /// </summary>
        /// <value>The Client Username the Bridge uses to login to the remote Message VPN. This per remote Message VPN value overrides the value provided for the Bridge overall. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        [DataMember(Name="clientUsername", EmitDefaultValue=false)]
        public string ClientUsername { get; set; }

        /// <summary>
        /// Enable or disable data compression for the remote Message VPN connection. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.
        /// </summary>
        /// <value>Enable or disable data compression for the remote Message VPN connection. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        [DataMember(Name="compressedDataEnabled", EmitDefaultValue=false)]
        public bool? CompressedDataEnabled { get; set; }
        ...
        /// </summary>
        /// <value>The preference given to incoming connections from remote Message VPN hosts, from 1 (highest priority) to 4 (lowest priority). Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;4&#x60;.</value>
        [DataMember(Name="connectOrder", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>The number of outstanding guaranteed messages that can be transmitted over the remote Message VPN connection before an acknowledgement is received. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;255&#x60;.</value>
        ...
        /// </summary>
        /// <value>Enable or disable the remote Message VPN. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        /// </summary>
        /// <value>The queue binding of the Bridge in the remote Message VPN. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        [DataMember(Name="queueBinding", EmitDefaultValue=false)]
        public string QueueBinding { get; set; }
        ...
        /// </summary>
        /// <value>The physical interface on the local Message VPN host for connecting to the remote Message VPN. By default, an interface is chosen automatically (recommended), but if specified, &#x60;remoteMsgVpnLocation&#x60; must not be a virtual router name.</value>
        [DataMember(Name="remoteMsgVpnInterface", EmitDefaultValue=false)]
        public string RemoteMsgVpnInterface { get; set; }
        ...
        /// </summary>
        /// <value>The location of the remote Message VPN as either an FQDN with port, IP address with port, or virtual router name (starting with \&quot;v:\&quot;).</value>
        [DataMember(Name="remoteMsgVpnLocation", EmitDefaultValue=false)]
        public string RemoteMsgVpnLocation { get; set; }

        /// <summary>
        /// The name of the remote Message VPN.
        /// </summary>
        /// <value>The name of the remote Message VPN.</value>
        [DataMember(Name="remoteMsgVpnName", EmitDefaultValue=false)]
        public string RemoteMsgVpnName { get; set; }

        /// <summary>
        /// Enable or disable encryption (TLS) for the remote Message VPN connection. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.
        /// </summary>
        /// <value>Enable or disable encryption (TLS) for the remote Message VPN connection. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        /// </summary>
        /// <value>The Client Profile for the unidirectional Bridge of the remote Message VPN. The Client Profile must exist in the local Message VPN, and it is used only for the TCP parameters. Note that the default client profile has a TCP maximum window size of 2MB. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;#client-profile\&quot;&#x60;.</value>
        [DataMember(Name="unidirectionalClientProfile", EmitDefaultValue=false)]
        public string UnidirectionalClientProfile { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CompressedDataEnabled: ").Append(CompressedDataEnabled).Append("\n");
            sb.Append("  ConnectOrder: ").Append(ConnectOrder).Append("\n");
            ...
            sb.Append("  QueueBinding: ").Append(QueueBinding).Append("\n");
            sb.Append("  RemoteMsgVpnInterface: ").Append(RemoteMsgVpnInterface).Append("\n");
            sb.Append("  RemoteMsgVpnLocation: ").Append(RemoteMsgVpnLocation).Append("\n");
            sb.Append("  RemoteMsgVpnName: ").Append(RemoteMsgVpnName).Append("\n");
            sb.Append("  TlsEnabled: ").Append(TlsEnabled).Append("\n");
            sb.Append("  UnidirectionalClientProfile: ").Append(UnidirectionalClientProfile).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnBridgeRemoteMsgVpn);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeRemoteMsgVpn instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeRemoteMsgVpn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeRemoteMsgVpn input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ClientUsername == input.ClientUsername ||
                    (this.ClientUsername != null &&
                    this.ClientUsername.Equals(input.ClientUsername))
                ) && 
                (
                    this.CompressedDataEnabled == input.CompressedDataEnabled ||
                    (this.CompressedDataEnabled != null &&
                    this.CompressedDataEnabled.Equals(input.CompressedDataEnabled))
                ) && 
                (
                    this.ConnectOrder == input.ConnectOrder ||
                    (this.ConnectOrder != null &&
                    this.ConnectOrder.Equals(input.ConnectOrder))
                ) && 
                (
                ...
                (
                    this.QueueBinding == input.QueueBinding ||
                    (this.QueueBinding != null &&
                    this.QueueBinding.Equals(input.QueueBinding))
                ) && 
                (
                    this.RemoteMsgVpnInterface == input.RemoteMsgVpnInterface ||
                    (this.RemoteMsgVpnInterface != null &&
                    this.RemoteMsgVpnInterface.Equals(input.RemoteMsgVpnInterface))
                ) && 
                (
                    this.RemoteMsgVpnLocation == input.RemoteMsgVpnLocation ||
                    (this.RemoteMsgVpnLocation != null &&
                    this.RemoteMsgVpnLocation.Equals(input.RemoteMsgVpnLocation))
                ) && 
                (
                    this.RemoteMsgVpnName == input.RemoteMsgVpnName ||
                    (this.RemoteMsgVpnName != null &&
                    this.RemoteMsgVpnName.Equals(input.RemoteMsgVpnName))
                ) && 
                (
                ...
                (
                    this.UnidirectionalClientProfile == input.UnidirectionalClientProfile ||
                    (this.UnidirectionalClientProfile != null &&
                    this.UnidirectionalClientProfile.Equals(input.UnidirectionalClientProfile))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClientUsername != null)
                    hashCode = hashCode * 59 + this.ClientUsername.GetHashCode();
                if (this.CompressedDataEnabled != null)
                    hashCode = hashCode * 59 + this.CompressedDataEnabled.GetHashCode();
                if (this.ConnectOrder != null)
                    hashCode = hashCode * 59 + this.ConnectOrder.GetHashCode();
                ...
                if (this.QueueBinding != null)
                    hashCode = hashCode * 59 + this.QueueBinding.GetHashCode();
                if (this.RemoteMsgVpnInterface != null)
                    hashCode = hashCode * 59 + this.RemoteMsgVpnInterface.GetHashCode();
                if (this.RemoteMsgVpnLocation != null)
                    hashCode = hashCode * 59 + this.RemoteMsgVpnLocation.GetHashCode();
                if (this.RemoteMsgVpnName != null)
                    hashCode = hashCode * 59 + this.RemoteMsgVpnName.GetHashCode();
                if (this.TlsEnabled != null)
                    hashCode = hashCode * 59 + this.TlsEnabled.GetHashCode();
                if (this.UnidirectionalClientProfile != null)
                    hashCode = hashCode * 59 + this.UnidirectionalClientProfile.GetHashCode();
                return hashCode;
            }
        }
    }

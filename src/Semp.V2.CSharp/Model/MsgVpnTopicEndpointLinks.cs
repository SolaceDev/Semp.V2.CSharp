...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTopicEndpointLinks :  IEquatable<MsgVpnTopicEndpointLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTopicEndpointLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Topic Endpoint object..</param>
        public MsgVpnTopicEndpointLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Topic Endpoint object.</value>
        ...
        {
            return this.Equals(input as MsgVpnTopicEndpointLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnTopicEndpointLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTopicEndpointLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTopicEndpointLinks input)
        {
            if (input == null)
                return false;

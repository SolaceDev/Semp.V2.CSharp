...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTopicEndpointTemplatesResponse :  IEquatable<MsgVpnTopicEndpointTemplatesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTopicEndpointTemplatesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTopicEndpointTemplatesResponse(List<MsgVpnTopicEndpointTemplate> data = default(List<MsgVpnTopicEndpointTemplate>), List<MsgVpnTopicEndpointTemplateLinks> links = default(List<MsgVpnTopicEndpointTemplateLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTopicEndpointTemplatesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnTopicEndpointTemplate> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnTopicEndpointTemplateLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnTopicEndpointTemplatesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTopicEndpointTemplatesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTopicEndpointTemplatesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTopicEndpointTemplatesResponse input)
        {
            if (input == null)
                return false;

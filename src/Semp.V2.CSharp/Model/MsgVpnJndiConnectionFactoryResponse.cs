...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiConnectionFactoryResponse :  IEquatable<MsgVpnJndiConnectionFactoryResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiConnectionFactoryResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnJndiConnectionFactoryResponse(MsgVpnJndiConnectionFactory data = default(MsgVpnJndiConnectionFactory), MsgVpnJndiConnectionFactoryLinks links = default(MsgVpnJndiConnectionFactoryLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnJndiConnectionFactoryResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnJndiConnectionFactory Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnJndiConnectionFactoryLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnJndiConnectionFactoryResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiConnectionFactoryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiConnectionFactoryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiConnectionFactoryResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueResponse :  IEquatable<MsgVpnQueueResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnQueueResponse(MsgVpnQueue data = default(MsgVpnQueue), MsgVpnQueueLinks links = default(MsgVpnQueueLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnQueueResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnQueue Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnQueueLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnQueueResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueResponse input)
        {
            if (input == null)
                return false;

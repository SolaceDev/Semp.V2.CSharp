...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProvidersResponse :  IEquatable<MsgVpnAuthenticationOauthProvidersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProvidersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthenticationOauthProvidersResponse(List<MsgVpnAuthenticationOauthProvider> data = default(List<MsgVpnAuthenticationOauthProvider>), List<MsgVpnAuthenticationOauthProviderLinks> links = default(List<MsgVpnAuthenticationOauthProviderLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthenticationOauthProvidersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAuthenticationOauthProvider> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAuthenticationOauthProviderLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProvidersResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProvidersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProvidersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProvidersResponse input)
        {
            if (input == null)
                return false;

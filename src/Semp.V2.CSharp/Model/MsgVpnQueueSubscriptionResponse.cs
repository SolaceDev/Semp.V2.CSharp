...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueSubscriptionResponse :  IEquatable<MsgVpnQueueSubscriptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueSubscriptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnQueueSubscriptionResponse(MsgVpnQueueSubscription data = default(MsgVpnQueueSubscription), MsgVpnQueueSubscriptionLinks links = default(MsgVpnQueueSubscriptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnQueueSubscriptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnQueueSubscription Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnQueueSubscriptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnQueueSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueSubscriptionResponse input)
        {
            if (input == null)
                return false;

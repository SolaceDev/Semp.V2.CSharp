...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeRemoteMsgVpnResponse :  IEquatable<MsgVpnBridgeRemoteMsgVpnResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeRemoteMsgVpnResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnBridgeRemoteMsgVpnResponse(MsgVpnBridgeRemoteMsgVpn data = default(MsgVpnBridgeRemoteMsgVpn), MsgVpnBridgeRemoteMsgVpnLinks links = default(MsgVpnBridgeRemoteMsgVpnLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnBridgeRemoteMsgVpnResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnBridgeRemoteMsgVpn Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnBridgeRemoteMsgVpnLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnBridgeRemoteMsgVpnResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeRemoteMsgVpnResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeRemoteMsgVpnResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeRemoteMsgVpnResponse input)
        {
            if (input == null)
                return false;

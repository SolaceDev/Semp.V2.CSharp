...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientProfileResponse :  IEquatable<MsgVpnClientProfileResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientProfileResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnClientProfileResponse(MsgVpnClientProfile data = default(MsgVpnClientProfile), MsgVpnClientProfileLinks links = default(MsgVpnClientProfileLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnClientProfileResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnClientProfile Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnClientProfileLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnClientProfileResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnClientProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientProfileResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientUsernameAttributeResponse :  IEquatable<MsgVpnClientUsernameAttributeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientUsernameAttributeResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnClientUsernameAttributeResponse(MsgVpnClientUsernameAttribute data = default(MsgVpnClientUsernameAttribute), MsgVpnClientUsernameAttributeLinks links = default(MsgVpnClientUsernameAttributeLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnClientUsernameAttributeResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnClientUsernameAttribute Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnClientUsernameAttributeLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnClientUsernameAttributeResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnClientUsernameAttributeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientUsernameAttributeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientUsernameAttributeResponse input)
        {
            if (input == null)
                return false;

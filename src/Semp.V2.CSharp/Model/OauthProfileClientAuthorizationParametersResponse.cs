...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientAuthorizationParametersResponse :  IEquatable<OauthProfileClientAuthorizationParametersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientAuthorizationParametersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileClientAuthorizationParametersResponse(List<OauthProfileClientAuthorizationParameter> data = default(List<OauthProfileClientAuthorizationParameter>), List<OauthProfileClientAuthorizationParameterLinks> links = default(List<OauthProfileClientAuthorizationParameterLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileClientAuthorizationParametersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<OauthProfileClientAuthorizationParameter> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<OauthProfileClientAuthorizationParameterLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileClientAuthorizationParametersResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileClientAuthorizationParametersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientAuthorizationParametersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientAuthorizationParametersResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileDefaultMsgVpnAccessLevelException :  IEquatable<OauthProfileDefaultMsgVpnAccessLevelException>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileDefaultMsgVpnAccessLevelException" /> class.
        /// </summary>
        ...
        public OauthProfileDefaultMsgVpnAccessLevelException(AccessLevelEnum? accessLevel = default(AccessLevelEnum?), string msgVpnName = default(string), string oauthProfileName = default(string))
        {
        ...
        {
            return this.Equals(input as OauthProfileDefaultMsgVpnAccessLevelException);
        }

        /// <summary>
        /// Returns true if OauthProfileDefaultMsgVpnAccessLevelException instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileDefaultMsgVpnAccessLevelException to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileDefaultMsgVpnAccessLevelException input)
        {
            if (input == null)
                return false;

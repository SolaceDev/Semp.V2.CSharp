...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ClientCertAuthoritiesResponse :  IEquatable<ClientCertAuthoritiesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCertAuthoritiesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public ClientCertAuthoritiesResponse(List<ClientCertAuthority> data = default(List<ClientCertAuthority>), List<ClientCertAuthorityLinks> links = default(List<ClientCertAuthorityLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for ClientCertAuthoritiesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<ClientCertAuthority> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<ClientCertAuthorityLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as ClientCertAuthoritiesResponse);
        }

        /// <summary>
        /// Returns true if ClientCertAuthoritiesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCertAuthoritiesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCertAuthoritiesResponse input)
        {
            if (input == null)
                return false;

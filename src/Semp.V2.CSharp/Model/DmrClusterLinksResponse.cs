...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinksResponse :  IEquatable<DmrClusterLinksResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinksResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterLinksResponse(List<DmrClusterLink> data = default(List<DmrClusterLink>), List<DmrClusterLinkLinks> links = default(List<DmrClusterLinkLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterLinksResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DmrClusterLink> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DmrClusterLinkLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterLinksResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterLinksResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinksResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinksResponse input)
        {
            if (input == null)
                return false;

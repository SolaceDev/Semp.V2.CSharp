...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterTopic :  IEquatable<MsgVpnDistributedCacheClusterTopic>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterTopic" /> class.
        /// </summary>
        ...
        public MsgVpnDistributedCacheClusterTopic(string cacheName = default(string), string clusterName = default(string), string msgVpnName = default(string), string topic = default(string))
        {
        ...
        /// </summary>
        /// <value>The value of the Topic in the form a/b/c.</value>
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterTopic);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterTopic input)
        {
            if (input == null)
                return false;

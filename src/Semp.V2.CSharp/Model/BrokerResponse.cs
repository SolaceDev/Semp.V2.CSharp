...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BrokerResponse :  IEquatable<BrokerResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public BrokerResponse(Broker data = default(Broker), BrokerLinks links = default(BrokerLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for BrokerResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public Broker Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public BrokerLinks Links { get; set; }
        ...
        {
            return this.Equals(input as BrokerResponse);
        }

        /// <summary>
        /// Returns true if BrokerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientAuthorizationParameterResponse :  IEquatable<OauthProfileClientAuthorizationParameterResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientAuthorizationParameterResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileClientAuthorizationParameterResponse(OauthProfileClientAuthorizationParameter data = default(OauthProfileClientAuthorizationParameter), OauthProfileClientAuthorizationParameterLinks links = default(OauthProfileClientAuthorizationParameterLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileClientAuthorizationParameterResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public OauthProfileClientAuthorizationParameter Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public OauthProfileClientAuthorizationParameterLinks Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileClientAuthorizationParameterResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileClientAuthorizationParameterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientAuthorizationParameterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientAuthorizationParameterResponse input)
        {
            if (input == null)
                return false;

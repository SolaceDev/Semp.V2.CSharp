...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse :  IEquatable<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse(List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix> data = default(List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix>), List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks> links = default(List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse input)
        {
            if (input == null)
                return false;

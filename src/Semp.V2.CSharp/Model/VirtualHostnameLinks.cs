...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VirtualHostnameLinks :  IEquatable<VirtualHostnameLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirtualHostnameLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Virtual Hostname object..</param>
        public VirtualHostnameLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Virtual Hostname object.</value>
        ...
        {
            return this.Equals(input as VirtualHostnameLinks);
        }

        /// <summary>
        /// Returns true if VirtualHostnameLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of VirtualHostnameLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtualHostnameLinks input)
        {
            if (input == null)
                return false;

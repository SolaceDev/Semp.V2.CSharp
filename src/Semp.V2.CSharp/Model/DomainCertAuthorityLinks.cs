...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DomainCertAuthorityLinks :  IEquatable<DomainCertAuthorityLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainCertAuthorityLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Domain Certificate Authority object..</param>
        public DomainCertAuthorityLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Domain Certificate Authority object.</value>
        ...
        {
            return this.Equals(input as DomainCertAuthorityLinks);
        }

        /// <summary>
        /// Returns true if DomainCertAuthorityLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainCertAuthorityLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainCertAuthorityLinks input)
        {
            if (input == null)
                return false;

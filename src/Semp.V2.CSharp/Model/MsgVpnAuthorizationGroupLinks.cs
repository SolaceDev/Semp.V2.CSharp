...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthorizationGroupLinks :  IEquatable<MsgVpnAuthorizationGroupLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthorizationGroupLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Authorization Group object..</param>
        public MsgVpnAuthorizationGroupLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Authorization Group object.</value>
        ...
        {
            return this.Equals(input as MsgVpnAuthorizationGroupLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthorizationGroupLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthorizationGroupLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthorizationGroupLinks input)
        {
            if (input == null)
                return false;

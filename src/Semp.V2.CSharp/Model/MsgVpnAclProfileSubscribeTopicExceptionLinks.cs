...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeTopicExceptionLinks :  IEquatable<MsgVpnAclProfileSubscribeTopicExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeTopicExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Subscribe Topic Exception object..</param>
        public MsgVpnAclProfileSubscribeTopicExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Subscribe Topic Exception object.</value>
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeTopicExceptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeTopicExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeTopicExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeTopicExceptionLinks input)
        {
            if (input == null)
                return false;

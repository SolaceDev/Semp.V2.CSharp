...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeRemoteSubscription :  IEquatable<MsgVpnBridgeRemoteSubscription>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeRemoteSubscription" /> class.
        /// </summary>
        ...
        /// <param name="deliverAlwaysEnabled">Enable or disable deliver-always for the Bridge remote subscription topic instead of a deliver-to-one remote priority. A given topic for the Bridge may be deliver-to-one or deliver-always but not both..</param>
        ...
        public MsgVpnBridgeRemoteSubscription(string bridgeName = default(string), BridgeVirtualRouterEnum? bridgeVirtualRouter = default(BridgeVirtualRouterEnum?), bool? deliverAlwaysEnabled = default(bool?), string msgVpnName = default(string), string remoteSubscriptionTopic = default(string))
        {
        ...
        /// </summary>
        /// <value>Enable or disable deliver-always for the Bridge remote subscription topic instead of a deliver-to-one remote priority. A given topic for the Bridge may be deliver-to-one or deliver-always but not both.</value>
        [DataMember(Name="deliverAlwaysEnabled", EmitDefaultValue=false)]
        public bool? DeliverAlwaysEnabled { get; set; }
        ...
        /// </summary>
        /// <value>The topic of the Bridge remote subscription.</value>
        [DataMember(Name="remoteSubscriptionTopic", EmitDefaultValue=false)]
        public string RemoteSubscriptionTopic { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeliverAlwaysEnabled: ").Append(DeliverAlwaysEnabled).Append("\n");
            sb.Append("  MsgVpnName: ").Append(MsgVpnName).Append("\n");
            sb.Append("  RemoteSubscriptionTopic: ").Append(RemoteSubscriptionTopic).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnBridgeRemoteSubscription);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeRemoteSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeRemoteSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeRemoteSubscription input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DeliverAlwaysEnabled == input.DeliverAlwaysEnabled ||
                    (this.DeliverAlwaysEnabled != null &&
                    this.DeliverAlwaysEnabled.Equals(input.DeliverAlwaysEnabled))
                ) && 
                (
                ...
                (
                    this.RemoteSubscriptionTopic == input.RemoteSubscriptionTopic ||
                    (this.RemoteSubscriptionTopic != null &&
                    this.RemoteSubscriptionTopic.Equals(input.RemoteSubscriptionTopic))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeliverAlwaysEnabled != null)
                    hashCode = hashCode * 59 + this.DeliverAlwaysEnabled.GetHashCode();
                if (this.MsgVpnName != null)
                    hashCode = hashCode * 59 + this.MsgVpnName.GetHashCode();
                if (this.RemoteSubscriptionTopic != null)
                    hashCode = hashCode * 59 + this.RemoteSubscriptionTopic.GetHashCode();
                return hashCode;
            }
        }
    }

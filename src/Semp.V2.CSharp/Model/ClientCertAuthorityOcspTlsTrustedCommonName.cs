...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ClientCertAuthorityOcspTlsTrustedCommonName :  IEquatable<ClientCertAuthorityOcspTlsTrustedCommonName>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCertAuthorityOcspTlsTrustedCommonName" /> class.
        /// </summary>
        ...
        public ClientCertAuthorityOcspTlsTrustedCommonName(string certAuthorityName = default(string), string ocspTlsTrustedCommonName = default(string))
        {
        ...
        /// </summary>
        /// <value>The expected Trusted Common Name of the OCSP responder remote certificate.</value>
        ...
        {
            return this.Equals(input as ClientCertAuthorityOcspTlsTrustedCommonName);
        }

        /// <summary>
        /// Returns true if ClientCertAuthorityOcspTlsTrustedCommonName instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCertAuthorityOcspTlsTrustedCommonName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCertAuthorityOcspTlsTrustedCommonName input)
        {
            if (input == null)
                return false;

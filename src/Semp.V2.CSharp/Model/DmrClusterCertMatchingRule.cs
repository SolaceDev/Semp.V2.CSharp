...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRule :  IEquatable<DmrClusterCertMatchingRule>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRule" /> class.
        /// </summary>
        /// <param name="dmrClusterName">The name of the Cluster..</param>
        /// <param name="enabled">Enable or disable a certificate matching rule. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="ruleName">The name of the rule..</param>
        public DmrClusterCertMatchingRule(string dmrClusterName = default(string), bool? enabled = default(bool?), string ruleName = default(string))
        {
        ...
        /// </summary>
        /// <value>Enable or disable a certificate matching rule. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRule);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRule instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRule input)
        {
            if (input == null)
                return false;

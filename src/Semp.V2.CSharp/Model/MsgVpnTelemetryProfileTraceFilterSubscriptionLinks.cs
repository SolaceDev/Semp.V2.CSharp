...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileTraceFilterSubscriptionLinks :  IEquatable<MsgVpnTelemetryProfileTraceFilterSubscriptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileTraceFilterSubscriptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Telemetry Trace Filter Subscription object..</param>
        public MsgVpnTelemetryProfileTraceFilterSubscriptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Telemetry Trace Filter Subscription object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileTraceFilterSubscriptionLinks {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileTraceFilterSubscriptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileTraceFilterSubscriptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileTraceFilterSubscriptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileTraceFilterSubscriptionLinks input)
        {
            if (input == null)
                return false;

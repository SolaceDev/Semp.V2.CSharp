...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeTlsTrustedCommonNameLinks :  IEquatable<MsgVpnBridgeTlsTrustedCommonNameLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeTlsTrustedCommonNameLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Trusted Common Name object..</param>
        public MsgVpnBridgeTlsTrustedCommonNameLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as MsgVpnBridgeTlsTrustedCommonNameLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeTlsTrustedCommonNameLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeTlsTrustedCommonNameLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeTlsTrustedCommonNameLinks input)
        {
            if (input == null)
                return false;

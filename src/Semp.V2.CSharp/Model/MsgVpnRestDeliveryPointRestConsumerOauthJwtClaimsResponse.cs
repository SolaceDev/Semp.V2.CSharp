...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse :  IEquatable<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse(List<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim> data = default(List<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim>), List<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks> links = default(List<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse input)
        {
            if (input == null)
                return false;

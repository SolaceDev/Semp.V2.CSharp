...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClustersResponse :  IEquatable<DmrClustersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClustersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClustersResponse(List<DmrCluster> data = default(List<DmrCluster>), List<DmrClusterLinks> links = default(List<DmrClusterLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClustersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DmrCluster> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DmrClusterLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClustersResponse);
        }

        /// <summary>
        /// Returns true if DmrClustersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClustersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClustersResponse input)
        {
            if (input == null)
                return false;

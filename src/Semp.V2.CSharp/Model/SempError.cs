...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SempError :  IEquatable<SempError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SempError" /> class.
        /// </summary>
        /// <param name="code">The error code which uniquely identifies the error that has occurred. (required).</param>
        /// <param name="description">The verbose description of the problem. (required).</param>
        /// <param name="status">The terse status string associated with &#x60;code&#x60;. (required).</param>
        public SempError(int? code = default(int?), string description = default(string), string status = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for SempError and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for SempError and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for SempError and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        /// </summary>
        /// <value>The error code which uniquely identifies the error that has occurred.</value>
        ...
        /// </summary>
        /// <value>The verbose description of the problem.</value>
        ...
        /// </summary>
        /// <value>The terse status string associated with &#x60;code&#x60;.</value>
        ...
        {
            return this.Equals(input as SempError);
        }

        /// <summary>
        /// Returns true if SempError instances are equal
        /// </summary>
        /// <param name="input">Instance of SempError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SempError input)
        {
            if (input == null)
                return false;

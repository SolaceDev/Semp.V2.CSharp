...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDmrBridgeResponse :  IEquatable<MsgVpnDmrBridgeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDmrBridgeResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDmrBridgeResponse(MsgVpnDmrBridge data = default(MsgVpnDmrBridge), MsgVpnDmrBridgeLinks links = default(MsgVpnDmrBridgeLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDmrBridgeResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnDmrBridge Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnDmrBridgeLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDmrBridgeResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDmrBridgeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDmrBridgeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDmrBridgeResponse input)
        {
            if (input == null)
                return false;

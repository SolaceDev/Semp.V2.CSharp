...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthorizationGroupsResponse :  IEquatable<MsgVpnAuthorizationGroupsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthorizationGroupsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthorizationGroupsResponse(List<MsgVpnAuthorizationGroup> data = default(List<MsgVpnAuthorizationGroup>), List<MsgVpnAuthorizationGroupLinks> links = default(List<MsgVpnAuthorizationGroupLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthorizationGroupsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAuthorizationGroup> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAuthorizationGroupLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthorizationGroupsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthorizationGroupsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthorizationGroupsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthorizationGroupsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse :  IEquatable<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse(List<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim> data = default(List<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim>), List<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks> links = default(List<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileResourceServerRequiredClaimsResponse input)
        {
            if (input == null)
                return false;

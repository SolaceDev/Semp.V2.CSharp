...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileClientRequiredClaim :  IEquatable<MsgVpnAuthenticationOauthProfileClientRequiredClaim>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileClientRequiredClaim" /> class.
        /// </summary>
        /// <param name="clientRequiredClaimName">The name of the ID token claim to verify..</param>
        /// <param name="clientRequiredClaimValue">The required claim value..</param>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="oauthProfileName">The name of the OAuth profile..</param>
        public MsgVpnAuthenticationOauthProfileClientRequiredClaim(string clientRequiredClaimName = default(string), string clientRequiredClaimValue = default(string), string msgVpnName = default(string), string oauthProfileName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the ID token claim to verify.</value>
        [DataMember(Name="clientRequiredClaimName", EmitDefaultValue=false)]
        public string ClientRequiredClaimName { get; set; }

        /// <summary>
        /// The required claim value.
        /// </summary>
        /// <value>The required claim value.</value>
        [DataMember(Name="clientRequiredClaimValue", EmitDefaultValue=false)]
        public string ClientRequiredClaimValue { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ClientRequiredClaimName: ").Append(ClientRequiredClaimName).Append("\n");
            sb.Append("  ClientRequiredClaimValue: ").Append(ClientRequiredClaimValue).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileClientRequiredClaim);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileClientRequiredClaim instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileClientRequiredClaim to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileClientRequiredClaim input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ClientRequiredClaimName == input.ClientRequiredClaimName ||
                    (this.ClientRequiredClaimName != null &&
                    this.ClientRequiredClaimName.Equals(input.ClientRequiredClaimName))
                ) && 
                (
                    this.ClientRequiredClaimValue == input.ClientRequiredClaimValue ||
                    (this.ClientRequiredClaimValue != null &&
                    this.ClientRequiredClaimValue.Equals(input.ClientRequiredClaimValue))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ClientRequiredClaimName != null)
                    hashCode = hashCode * 59 + this.ClientRequiredClaimName.GetHashCode();
                if (this.ClientRequiredClaimValue != null)
                    hashCode = hashCode * 59 + this.ClientRequiredClaimValue.GetHashCode();

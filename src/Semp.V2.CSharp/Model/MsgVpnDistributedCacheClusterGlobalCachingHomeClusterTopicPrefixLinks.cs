...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks :  IEquatable<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Topic Prefix object..</param>
        public MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Topic Prefix object.</value>
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks input)
        {
            if (input == null)
                return false;

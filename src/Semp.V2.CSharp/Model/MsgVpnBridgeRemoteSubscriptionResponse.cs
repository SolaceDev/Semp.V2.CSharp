...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeRemoteSubscriptionResponse :  IEquatable<MsgVpnBridgeRemoteSubscriptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeRemoteSubscriptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnBridgeRemoteSubscriptionResponse(MsgVpnBridgeRemoteSubscription data = default(MsgVpnBridgeRemoteSubscription), MsgVpnBridgeRemoteSubscriptionLinks links = default(MsgVpnBridgeRemoteSubscriptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnBridgeRemoteSubscriptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnBridgeRemoteSubscription Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnBridgeRemoteSubscriptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnBridgeRemoteSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeRemoteSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeRemoteSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeRemoteSubscriptionResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTopicEndpointResponse :  IEquatable<MsgVpnTopicEndpointResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTopicEndpointResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTopicEndpointResponse(MsgVpnTopicEndpoint data = default(MsgVpnTopicEndpoint), MsgVpnTopicEndpointLinks links = default(MsgVpnTopicEndpointLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTopicEndpointResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnTopicEndpoint Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnTopicEndpointLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnTopicEndpointResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTopicEndpointResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTopicEndpointResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTopicEndpointResponse input)
        {
            if (input == null)
                return false;

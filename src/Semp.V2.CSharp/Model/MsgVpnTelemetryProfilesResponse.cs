...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfilesResponse :  IEquatable<MsgVpnTelemetryProfilesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfilesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTelemetryProfilesResponse(List<MsgVpnTelemetryProfile> data = default(List<MsgVpnTelemetryProfile>), List<MsgVpnTelemetryProfileLinks> links = default(List<MsgVpnTelemetryProfileLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTelemetryProfilesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnTelemetryProfile> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnTelemetryProfileLinks> Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfilesResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfilesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfilesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfilesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfilesResponse input)
        {
            if (input == null)
                return false;

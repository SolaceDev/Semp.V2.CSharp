...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnSequencedTopicsResponse :  IEquatable<MsgVpnSequencedTopicsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnSequencedTopicsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnSequencedTopicsResponse(List<MsgVpnSequencedTopic> data = default(List<MsgVpnSequencedTopic>), List<MsgVpnSequencedTopicLinks> links = default(List<MsgVpnSequencedTopicLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnSequencedTopicsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnSequencedTopic> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnSequencedTopicLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnSequencedTopicsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnSequencedTopicsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnSequencedTopicsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnSequencedTopicsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DomainCertAuthoritiesResponse :  IEquatable<DomainCertAuthoritiesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainCertAuthoritiesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DomainCertAuthoritiesResponse(List<DomainCertAuthority> data = default(List<DomainCertAuthority>), List<DomainCertAuthorityLinks> links = default(List<DomainCertAuthorityLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DomainCertAuthoritiesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DomainCertAuthority> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DomainCertAuthorityLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DomainCertAuthoritiesResponse);
        }

        /// <summary>
        /// Returns true if DomainCertAuthoritiesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainCertAuthoritiesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainCertAuthoritiesResponse input)
        {
            if (input == null)
                return false;

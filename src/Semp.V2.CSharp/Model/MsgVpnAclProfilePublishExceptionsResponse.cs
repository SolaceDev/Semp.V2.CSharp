...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfilePublishExceptionsResponse :  IEquatable<MsgVpnAclProfilePublishExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfilePublishExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfilePublishExceptionsResponse(List<MsgVpnAclProfilePublishException> data = default(List<MsgVpnAclProfilePublishException>), List<MsgVpnAclProfilePublishExceptionLinks> links = default(List<MsgVpnAclProfilePublishExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfilePublishExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAclProfilePublishException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAclProfilePublishExceptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfilePublishExceptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfilePublishExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfilePublishExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfilePublishExceptionsResponse input)
        {
            if (input == null)
                return false;

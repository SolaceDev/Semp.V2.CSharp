...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiConnectionFactoryLinks :  IEquatable<MsgVpnJndiConnectionFactoryLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiConnectionFactoryLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this JNDI Connection Factory object..</param>
        public MsgVpnJndiConnectionFactoryLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this JNDI Connection Factory object.</value>
        ...
        {
            return this.Equals(input as MsgVpnJndiConnectionFactoryLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiConnectionFactoryLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiConnectionFactoryLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiConnectionFactoryLinks input)
        {
            if (input == null)
                return false;

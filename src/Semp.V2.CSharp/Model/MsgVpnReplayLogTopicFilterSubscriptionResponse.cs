...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplayLogTopicFilterSubscriptionResponse :  IEquatable<MsgVpnReplayLogTopicFilterSubscriptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplayLogTopicFilterSubscriptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnReplayLogTopicFilterSubscriptionResponse(MsgVpnReplayLogTopicFilterSubscription data = default(MsgVpnReplayLogTopicFilterSubscription), MsgVpnReplayLogTopicFilterSubscriptionLinks links = default(MsgVpnReplayLogTopicFilterSubscriptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnReplayLogTopicFilterSubscriptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnReplayLogTopicFilterSubscription Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnReplayLogTopicFilterSubscriptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnReplayLogTopicFilterSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnReplayLogTopicFilterSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplayLogTopicFilterSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplayLogTopicFilterSubscriptionResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileTraceFilter :  IEquatable<MsgVpnTelemetryProfileTraceFilter>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileTraceFilter" /> class.
        /// </summary>
        /// <param name="enabled">Enable or disable the trace filter. When the filter is disabled, the filter&#x27;s subscriptions will not trigger a message to be traced. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        ...
        public MsgVpnTelemetryProfileTraceFilter(bool? enabled = default(bool?), string msgVpnName = default(string), string telemetryProfileName = default(string), string traceFilterName = default(string))
        {
        ...
        /// <summary>
        /// Enable or disable the trace filter. When the filter is disabled, the filter&#x27;s subscriptions will not trigger a message to be traced. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.
        /// </summary>
        /// <value>Enable or disable the trace filter. When the filter is disabled, the filter&#x27;s subscriptions will not trigger a message to be traced. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileTraceFilter {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileTraceFilter);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileTraceFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileTraceFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileTraceFilter input)
        {
            if (input == null)
                return false;

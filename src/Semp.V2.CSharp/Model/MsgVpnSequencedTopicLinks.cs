...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnSequencedTopicLinks :  IEquatable<MsgVpnSequencedTopicLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnSequencedTopicLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Sequenced Topic object..</param>
        public MsgVpnSequencedTopicLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Sequenced Topic object.</value>
        ...
        {
            return this.Equals(input as MsgVpnSequencedTopicLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnSequencedTopicLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnSequencedTopicLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnSequencedTopicLinks input)
        {
            if (input == null)
                return false;

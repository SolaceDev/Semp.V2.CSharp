...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CertAuthorityOcspTlsTrustedCommonNamesResponse :  IEquatable<CertAuthorityOcspTlsTrustedCommonNamesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertAuthorityOcspTlsTrustedCommonNamesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public CertAuthorityOcspTlsTrustedCommonNamesResponse(List<CertAuthorityOcspTlsTrustedCommonName> data = default(List<CertAuthorityOcspTlsTrustedCommonName>), List<CertAuthorityOcspTlsTrustedCommonNameLinks> links = default(List<CertAuthorityOcspTlsTrustedCommonNameLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for CertAuthorityOcspTlsTrustedCommonNamesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<CertAuthorityOcspTlsTrustedCommonName> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<CertAuthorityOcspTlsTrustedCommonNameLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as CertAuthorityOcspTlsTrustedCommonNamesResponse);
        }

        /// <summary>
        /// Returns true if CertAuthorityOcspTlsTrustedCommonNamesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CertAuthorityOcspTlsTrustedCommonNamesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertAuthorityOcspTlsTrustedCommonNamesResponse input)
        {
            if (input == null)
                return false;

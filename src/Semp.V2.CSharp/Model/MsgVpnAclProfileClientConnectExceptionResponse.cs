...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileClientConnectExceptionResponse :  IEquatable<MsgVpnAclProfileClientConnectExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileClientConnectExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileClientConnectExceptionResponse(MsgVpnAclProfileClientConnectException data = default(MsgVpnAclProfileClientConnectException), MsgVpnAclProfileClientConnectExceptionLinks links = default(MsgVpnAclProfileClientConnectExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileClientConnectExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAclProfileClientConnectException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAclProfileClientConnectExceptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileClientConnectExceptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileClientConnectExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileClientConnectExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileClientConnectExceptionResponse input)
        {
            if (input == null)
                return false;

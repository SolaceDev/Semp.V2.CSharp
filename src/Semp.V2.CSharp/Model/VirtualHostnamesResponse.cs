...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VirtualHostnamesResponse :  IEquatable<VirtualHostnamesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirtualHostnamesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public VirtualHostnamesResponse(List<VirtualHostname> data = default(List<VirtualHostname>), List<VirtualHostnameLinks> links = default(List<VirtualHostnameLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for VirtualHostnamesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<VirtualHostname> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<VirtualHostnameLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as VirtualHostnamesResponse);
        }

        /// <summary>
        /// Returns true if VirtualHostnamesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of VirtualHostnamesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtualHostnamesResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse :  IEquatable<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse(MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix data = default(MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix), MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks links = default(MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse :  IEquatable<MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse(MsgVpnAuthenticationOauthProfileClientRequiredClaim data = default(MsgVpnAuthenticationOauthProfileClientRequiredClaim), MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks links = default(MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAuthenticationOauthProfileClientRequiredClaim Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileClientRequiredClaimResponse input)
        {
            if (input == null)
                return false;

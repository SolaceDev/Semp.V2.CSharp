...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttSessionSubscription :  IEquatable<MsgVpnMqttSessionSubscription>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttSessionSubscription" /> class.
        /// </summary>
        ...
        [DataMember(Name="subscriptionQos", EmitDefaultValue=false)]
        public long? SubscriptionQos { get; set; }

        /// <summary>
        /// The MQTT subscription topic.
        /// </summary>
        /// <value>The MQTT subscription topic.</value>
        [DataMember(Name="subscriptionTopic", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubscriptionQos: ").Append(SubscriptionQos).Append("\n");
            sb.Append("  SubscriptionTopic: ").Append(SubscriptionTopic).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnMqttSessionSubscription);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttSessionSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttSessionSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttSessionSubscription input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SubscriptionQos == input.SubscriptionQos ||
                    (this.SubscriptionQos != null &&
                    this.SubscriptionQos.Equals(input.SubscriptionQos))
                ) && 
                (
                    this.SubscriptionTopic == input.SubscriptionTopic ||
                    (this.SubscriptionTopic != null &&
                    this.SubscriptionTopic.Equals(input.SubscriptionTopic))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SubscriptionQos != null)
                    hashCode = hashCode * 59 + this.SubscriptionQos.GetHashCode();
                if (this.SubscriptionTopic != null)
                    hashCode = hashCode * 59 + this.SubscriptionTopic.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiTopic :  IEquatable<MsgVpnJndiTopic>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiTopic" /> class.
        /// </summary>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="physicalName">The physical name of the JMS Topic. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        /// <param name="topicName">The JNDI name of the JMS Topic..</param>
        public MsgVpnJndiTopic(string msgVpnName = default(string), string physicalName = default(string), string topicName = default(string))
        {
        ...
        /// </summary>
        /// <value>The physical name of the JMS Topic. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        [DataMember(Name="physicalName", EmitDefaultValue=false)]
        public string PhysicalName { get; set; }

        /// <summary>
        /// The JNDI name of the JMS Topic.
        /// </summary>
        /// <value>The JNDI name of the JMS Topic.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PhysicalName: ").Append(PhysicalName).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnJndiTopic);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiTopic input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PhysicalName == input.PhysicalName ||
                    (this.PhysicalName != null &&
                    this.PhysicalName.Equals(input.PhysicalName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PhysicalName != null)
                    hashCode = hashCode * 59 + this.PhysicalName.GetHashCode();

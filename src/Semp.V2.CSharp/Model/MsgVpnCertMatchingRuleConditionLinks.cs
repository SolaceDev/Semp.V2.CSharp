...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleConditionLinks :  IEquatable<MsgVpnCertMatchingRuleConditionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleConditionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Certificate Matching Rule Condition object..</param>
        public MsgVpnCertMatchingRuleConditionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleConditionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleConditionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleConditionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleConditionLinks input)
        {
            if (input == null)
                return false;

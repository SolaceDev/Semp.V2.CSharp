...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CertAuthorityLinks :  IEquatable<CertAuthorityLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertAuthorityLinks" /> class.
        /// </summary>
        /// <param name="ocspTlsTrustedCommonNamesUri">The URI of this Certificate Authority&#x27;s collection of OCSP Responder Trusted Common Name objects. Deprecated since 2.19. Replaced by clientCertAuthorities..</param>
        /// <param name="uri">The URI of this Certificate Authority object..</param>
        public CertAuthorityLinks(string ocspTlsTrustedCommonNamesUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Certificate Authority&#x27;s collection of OCSP Responder Trusted Common Name objects. Deprecated since 2.19. Replaced by clientCertAuthorities.</value>
        [DataMember(Name="ocspTlsTrustedCommonNamesUri", EmitDefaultValue=false)]
        public string OcspTlsTrustedCommonNamesUri { get; set; }

        /// <summary>
        /// The URI of this Certificate Authority object.
        /// </summary>
        /// <value>The URI of this Certificate Authority object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OcspTlsTrustedCommonNamesUri: ").Append(OcspTlsTrustedCommonNamesUri).Append("\n");
        ...
        {
            return this.Equals(input as CertAuthorityLinks);
        }

        /// <summary>
        /// Returns true if CertAuthorityLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of CertAuthorityLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertAuthorityLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.OcspTlsTrustedCommonNamesUri == input.OcspTlsTrustedCommonNamesUri ||
                    (this.OcspTlsTrustedCommonNamesUri != null &&
                    this.OcspTlsTrustedCommonNamesUri.Equals(input.OcspTlsTrustedCommonNamesUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.OcspTlsTrustedCommonNamesUri != null)
                    hashCode = hashCode * 59 + this.OcspTlsTrustedCommonNamesUri.GetHashCode();
                if (this.Uri != null)

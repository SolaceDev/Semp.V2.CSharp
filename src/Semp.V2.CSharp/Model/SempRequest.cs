...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SempRequest :  IEquatable<SempRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SempRequest" /> class.
        /// </summary>
        /// <param name="method">The HTTP method of the request which resulted in this response. (required).</param>
        /// <param name="uri">The URI of the request which resulted in this response..</param>
        public SempRequest(string method = default(string), string uri = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new InvalidDataException("method is a required property for SempRequest and cannot be null");
            }
            else
            {
                this.Method = method;
        ...
        /// </summary>
        /// <value>The HTTP method of the request which resulted in this response.</value>
        ...
        /// </summary>
        /// <value>The URI of the request which resulted in this response.</value>
        ...
        {
            return this.Equals(input as SempRequest);
        }

        /// <summary>
        /// Returns true if SempRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SempRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SempRequest input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiQueueResponse :  IEquatable<MsgVpnJndiQueueResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiQueueResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnJndiQueueResponse(MsgVpnJndiQueue data = default(MsgVpnJndiQueue), MsgVpnJndiQueueLinks links = default(MsgVpnJndiQueueLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnJndiQueueResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnJndiQueue Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnJndiQueueLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnJndiQueueResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiQueueResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiQueueResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiQueueResponse input)
        {
            if (input == null)
                return false;

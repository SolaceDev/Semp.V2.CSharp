...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterTopicLinks :  IEquatable<MsgVpnDistributedCacheClusterTopicLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterTopicLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Topic object..</param>
        public MsgVpnDistributedCacheClusterTopicLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Topic object.</value>
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterTopicLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterTopicLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterTopicLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterTopicLinks input)
        {
            if (input == null)
                return false;

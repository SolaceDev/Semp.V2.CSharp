...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnJndiTopicResponse :  IEquatable<MsgVpnJndiTopicResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnJndiTopicResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnJndiTopicResponse(MsgVpnJndiTopic data = default(MsgVpnJndiTopic), MsgVpnJndiTopicLinks links = default(MsgVpnJndiTopicLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnJndiTopicResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnJndiTopic Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnJndiTopicLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnJndiTopicResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnJndiTopicResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnJndiTopicResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnJndiTopicResponse input)
        {
            if (input == null)
                return false;

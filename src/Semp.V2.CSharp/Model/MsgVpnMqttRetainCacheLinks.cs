...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttRetainCacheLinks :  IEquatable<MsgVpnMqttRetainCacheLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttRetainCacheLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this MQTT Retain Cache object..</param>
        public MsgVpnMqttRetainCacheLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this MQTT Retain Cache object.</value>
        ...
        {
            return this.Equals(input as MsgVpnMqttRetainCacheLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttRetainCacheLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttRetainCacheLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttRetainCacheLinks input)
        {
            if (input == null)
                return false;

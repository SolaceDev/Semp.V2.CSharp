...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTopicEndpointTemplateLinks :  IEquatable<MsgVpnTopicEndpointTemplateLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTopicEndpointTemplateLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Topic Endpoint Template object..</param>
        public MsgVpnTopicEndpointTemplateLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Topic Endpoint Template object.</value>
        ...
        {
            return this.Equals(input as MsgVpnTopicEndpointTemplateLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnTopicEndpointTemplateLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTopicEndpointTemplateLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTopicEndpointTemplateLinks input)
        {
            if (input == null)
                return false;

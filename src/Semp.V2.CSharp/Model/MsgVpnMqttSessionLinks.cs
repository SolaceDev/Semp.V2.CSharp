...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttSessionLinks :  IEquatable<MsgVpnMqttSessionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttSessionLinks" /> class.
        /// </summary>
        /// <param name="subscriptionsUri">The URI of this MQTT Session&#x27;s collection of Subscription objects..</param>
        /// <param name="uri">The URI of this MQTT Session object..</param>
        public MsgVpnMqttSessionLinks(string subscriptionsUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this MQTT Session&#x27;s collection of Subscription objects.</value>
        ...
        /// </summary>
        /// <value>The URI of this MQTT Session object.</value>
        ...
        {
            return this.Equals(input as MsgVpnMqttSessionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttSessionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttSessionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttSessionLinks input)
        {
            if (input == null)
                return false;

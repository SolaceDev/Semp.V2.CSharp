...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileReceiverAclConnectException :  IEquatable<MsgVpnTelemetryProfileReceiverAclConnectException>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileReceiverAclConnectException" /> class.
        /// </summary>
        ...
        public MsgVpnTelemetryProfileReceiverAclConnectException(string msgVpnName = default(string), string receiverAclConnectExceptionAddress = default(string), string telemetryProfileName = default(string))
        {
            this.MsgVpnName = msgVpnName;
            this.ReceiverAclConnectExceptionAddress = receiverAclConnectExceptionAddress;
        ...
        /// </summary>
        /// <value>The IP address/netmask of the receiver connect exception in CIDR form.</value>
        [DataMember(Name="receiverAclConnectExceptionAddress", EmitDefaultValue=false)]
        public string ReceiverAclConnectExceptionAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileReceiverAclConnectException {\n");
            sb.Append("  MsgVpnName: ").Append(MsgVpnName).Append("\n");
            sb.Append("  ReceiverAclConnectExceptionAddress: ").Append(ReceiverAclConnectExceptionAddress).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileReceiverAclConnectException);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileReceiverAclConnectException instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileReceiverAclConnectException to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileReceiverAclConnectException input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReceiverAclConnectExceptionAddress == input.ReceiverAclConnectExceptionAddress ||
                    (this.ReceiverAclConnectExceptionAddress != null &&
                    this.ReceiverAclConnectExceptionAddress.Equals(input.ReceiverAclConnectExceptionAddress))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReceiverAclConnectExceptionAddress != null)
                    hashCode = hashCode * 59 + this.ReceiverAclConnectExceptionAddress.GetHashCode();

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientUsernameLinks :  IEquatable<MsgVpnClientUsernameLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientUsernameLinks" /> class.
        /// </summary>
        /// <param name="attributesUri">The URI of this Client Username&#x27;s collection of Client Username Attribute objects. Available since 2.27..</param>
        /// <param name="uri">The URI of this Client Username object..</param>
        public MsgVpnClientUsernameLinks(string attributesUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Client Username&#x27;s collection of Client Username Attribute objects. Available since 2.27.</value>
        ...
        /// </summary>
        /// <value>The URI of this Client Username object.</value>
        ...
        {
            return this.Equals(input as MsgVpnClientUsernameLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnClientUsernameLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientUsernameLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientUsernameLinks input)
        {
            if (input == null)
                return false;

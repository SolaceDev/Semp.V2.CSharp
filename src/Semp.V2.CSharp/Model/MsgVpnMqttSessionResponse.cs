...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttSessionResponse :  IEquatable<MsgVpnMqttSessionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttSessionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnMqttSessionResponse(MsgVpnMqttSession data = default(MsgVpnMqttSession), MsgVpnMqttSessionLinks links = default(MsgVpnMqttSessionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnMqttSessionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnMqttSession Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnMqttSessionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnMqttSessionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttSessionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttSessionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttSessionResponse input)
        {
            if (input == null)
                return false;

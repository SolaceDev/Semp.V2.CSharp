...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkAttributeLinks :  IEquatable<DmrClusterLinkAttributeLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkAttributeLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Link Attribute object..</param>
        public DmrClusterLinkAttributeLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Link Attribute object.</value>
        ...
        {
            return this.Equals(input as DmrClusterLinkAttributeLinks);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkAttributeLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkAttributeLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkAttributeLinks input)
        {
            if (input == null)
                return false;

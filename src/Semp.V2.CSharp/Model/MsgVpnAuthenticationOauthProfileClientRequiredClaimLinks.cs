...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks :  IEquatable<MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Required Claim object..</param>
        public MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfileClientRequiredClaimLinks input)
        {
            if (input == null)
                return false;

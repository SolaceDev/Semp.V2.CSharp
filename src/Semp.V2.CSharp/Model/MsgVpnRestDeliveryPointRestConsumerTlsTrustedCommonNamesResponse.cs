...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse :  IEquatable<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse(List<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName> data = default(List<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName>), List<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks> links = default(List<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse input)
        {
            if (input == null)
                return false;

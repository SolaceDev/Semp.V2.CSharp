...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks :  IEquatable<MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Request Header object..</param>
        public MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Request Header object.</value>
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks input)
        {
            if (input == null)
                return false;

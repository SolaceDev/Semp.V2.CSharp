...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeShareNameExceptionLinks :  IEquatable<MsgVpnAclProfileSubscribeShareNameExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeShareNameExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Subscribe Share Name Exception object..</param>
        public MsgVpnAclProfileSubscribeShareNameExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Subscribe Share Name Exception object.</value>
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeShareNameExceptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeShareNameExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeShareNameExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeShareNameExceptionLinks input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeTlsTrustedCommonNamesResponse :  IEquatable<MsgVpnBridgeTlsTrustedCommonNamesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeTlsTrustedCommonNamesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnBridgeTlsTrustedCommonNamesResponse(List<MsgVpnBridgeTlsTrustedCommonName> data = default(List<MsgVpnBridgeTlsTrustedCommonName>), List<MsgVpnBridgeTlsTrustedCommonNameLinks> links = default(List<MsgVpnBridgeTlsTrustedCommonNameLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnBridgeTlsTrustedCommonNamesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnBridgeTlsTrustedCommonName> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnBridgeTlsTrustedCommonNameLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnBridgeTlsTrustedCommonNamesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeTlsTrustedCommonNamesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeTlsTrustedCommonNamesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeTlsTrustedCommonNamesResponse input)
        {
            if (input == null)
                return false;

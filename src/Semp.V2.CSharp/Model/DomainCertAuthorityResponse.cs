...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DomainCertAuthorityResponse :  IEquatable<DomainCertAuthorityResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainCertAuthorityResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DomainCertAuthorityResponse(DomainCertAuthority data = default(DomainCertAuthority), DomainCertAuthorityLinks links = default(DomainCertAuthorityLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DomainCertAuthorityResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DomainCertAuthority Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DomainCertAuthorityLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DomainCertAuthorityResponse);
        }

        /// <summary>
        /// Returns true if DomainCertAuthorityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainCertAuthorityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainCertAuthorityResponse input)
        {
            if (input == null)
                return false;

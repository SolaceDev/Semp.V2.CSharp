...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplayLogResponse :  IEquatable<MsgVpnReplayLogResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplayLogResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnReplayLogResponse(MsgVpnReplayLog data = default(MsgVpnReplayLog), MsgVpnReplayLogLinks links = default(MsgVpnReplayLogLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnReplayLogResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnReplayLog Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnReplayLogLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnReplayLogResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnReplayLogResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplayLogResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplayLogResponse input)
        {
            if (input == null)
                return false;

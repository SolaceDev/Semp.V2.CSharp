...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse :  IEquatable<MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse(List<MsgVpnTelemetryProfileReceiverAclConnectException> data = default(List<MsgVpnTelemetryProfileReceiverAclConnectException>), List<MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks> links = default(List<MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnTelemetryProfileReceiverAclConnectException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks> Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse input)
        {
            if (input == null)
                return false;

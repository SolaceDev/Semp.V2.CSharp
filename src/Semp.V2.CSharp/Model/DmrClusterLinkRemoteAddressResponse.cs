...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkRemoteAddressResponse :  IEquatable<DmrClusterLinkRemoteAddressResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkRemoteAddressResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterLinkRemoteAddressResponse(DmrClusterLinkRemoteAddress data = default(DmrClusterLinkRemoteAddress), DmrClusterLinkRemoteAddressLinks links = default(DmrClusterLinkRemoteAddressLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterLinkRemoteAddressResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DmrClusterLinkRemoteAddress Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DmrClusterLinkRemoteAddressLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterLinkRemoteAddressResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkRemoteAddressResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkRemoteAddressResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkRemoteAddressResponse input)
        {
            if (input == null)
                return false;

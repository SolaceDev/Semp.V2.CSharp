...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientUsernameAttributesResponse :  IEquatable<MsgVpnClientUsernameAttributesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientUsernameAttributesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnClientUsernameAttributesResponse(List<MsgVpnClientUsernameAttribute> data = default(List<MsgVpnClientUsernameAttribute>), List<MsgVpnClientUsernameAttributeLinks> links = default(List<MsgVpnClientUsernameAttributeLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnClientUsernameAttributesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnClientUsernameAttribute> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnClientUsernameAttributeLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnClientUsernameAttributesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnClientUsernameAttributesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientUsernameAttributesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientUsernameAttributesResponse input)
        {
            if (input == null)
                return false;

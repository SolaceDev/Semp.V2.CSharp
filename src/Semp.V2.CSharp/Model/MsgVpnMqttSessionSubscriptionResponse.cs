...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttSessionSubscriptionResponse :  IEquatable<MsgVpnMqttSessionSubscriptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttSessionSubscriptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnMqttSessionSubscriptionResponse(MsgVpnMqttSessionSubscription data = default(MsgVpnMqttSessionSubscription), MsgVpnMqttSessionSubscriptionLinks links = default(MsgVpnMqttSessionSubscriptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnMqttSessionSubscriptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnMqttSessionSubscription Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnMqttSessionSubscriptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnMqttSessionSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttSessionSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttSessionSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttSessionSubscriptionResponse input)
        {
            if (input == null)
                return false;

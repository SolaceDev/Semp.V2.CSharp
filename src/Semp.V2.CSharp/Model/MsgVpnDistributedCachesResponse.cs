...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCachesResponse :  IEquatable<MsgVpnDistributedCachesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCachesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCachesResponse(List<MsgVpnDistributedCache> data = default(List<MsgVpnDistributedCache>), List<MsgVpnDistributedCacheLinks> links = default(List<MsgVpnDistributedCacheLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCachesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnDistributedCache> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnDistributedCacheLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCachesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCachesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCachesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCachesResponse input)
        {
            if (input == null)
                return false;

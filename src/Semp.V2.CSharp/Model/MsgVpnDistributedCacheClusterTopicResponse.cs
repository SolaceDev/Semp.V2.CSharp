...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterTopicResponse :  IEquatable<MsgVpnDistributedCacheClusterTopicResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterTopicResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClusterTopicResponse(MsgVpnDistributedCacheClusterTopic data = default(MsgVpnDistributedCacheClusterTopic), MsgVpnDistributedCacheClusterTopicLinks links = default(MsgVpnDistributedCacheClusterTopicLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClusterTopicResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnDistributedCacheClusterTopic Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnDistributedCacheClusterTopicLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterTopicResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterTopicResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterTopicResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterTopicResponse input)
        {
            if (input == null)
                return false;

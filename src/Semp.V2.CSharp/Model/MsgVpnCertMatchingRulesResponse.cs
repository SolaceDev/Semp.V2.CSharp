...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRulesResponse :  IEquatable<MsgVpnCertMatchingRulesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRulesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnCertMatchingRulesResponse(List<MsgVpnCertMatchingRule> data = default(List<MsgVpnCertMatchingRule>), List<MsgVpnCertMatchingRuleLinks> links = default(List<MsgVpnCertMatchingRuleLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnCertMatchingRulesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnCertMatchingRule> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnCertMatchingRuleLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRulesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRulesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRulesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRulesResponse input)
        {
            if (input == null)
                return false;

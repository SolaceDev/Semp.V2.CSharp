...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutApiLinks :  IEquatable<AboutApiLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutApiLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this API Description object..</param>
        public AboutApiLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this API Description object.</value>
        ...
        {
            return this.Equals(input as AboutApiLinks);
        }

        /// <summary>
        /// Returns true if AboutApiLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutApiLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutApiLinks input)
        {
            if (input == null)
                return false;

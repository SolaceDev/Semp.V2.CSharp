...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRuleAttributeFilterLinks :  IEquatable<DmrClusterCertMatchingRuleAttributeFilterLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRuleAttributeFilterLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Certificate Matching Rule Attribute Filter object..</param>
        public DmrClusterCertMatchingRuleAttributeFilterLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Certificate Matching Rule Attribute Filter object.</value>
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRuleAttributeFilterLinks);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRuleAttributeFilterLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRuleAttributeFilterLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRuleAttributeFilterLinks input)
        {
            if (input == null)
                return false;

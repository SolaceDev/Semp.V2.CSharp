...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterTopicsResponse :  IEquatable<MsgVpnDistributedCacheClusterTopicsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterTopicsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClusterTopicsResponse(List<MsgVpnDistributedCacheClusterTopic> data = default(List<MsgVpnDistributedCacheClusterTopic>), List<MsgVpnDistributedCacheClusterTopicLinks> links = default(List<MsgVpnDistributedCacheClusterTopicLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClusterTopicsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnDistributedCacheClusterTopic> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnDistributedCacheClusterTopicLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterTopicsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterTopicsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterTopicsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterTopicsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueTemplatesResponse :  IEquatable<MsgVpnQueueTemplatesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueTemplatesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnQueueTemplatesResponse(List<MsgVpnQueueTemplate> data = default(List<MsgVpnQueueTemplate>), List<MsgVpnQueueTemplateLinks> links = default(List<MsgVpnQueueTemplateLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnQueueTemplatesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnQueueTemplate> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnQueueTemplateLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnQueueTemplatesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueTemplatesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueTemplatesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueTemplatesResponse input)
        {
            if (input == null)
                return false;

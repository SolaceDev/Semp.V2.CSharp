...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeRemoteMsgVpnsResponse :  IEquatable<MsgVpnBridgeRemoteMsgVpnsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeRemoteMsgVpnsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnBridgeRemoteMsgVpnsResponse(List<MsgVpnBridgeRemoteMsgVpn> data = default(List<MsgVpnBridgeRemoteMsgVpn>), List<MsgVpnBridgeRemoteMsgVpnLinks> links = default(List<MsgVpnBridgeRemoteMsgVpnLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnBridgeRemoteMsgVpnsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnBridgeRemoteMsgVpn> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnBridgeRemoteMsgVpnLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnBridgeRemoteMsgVpnsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeRemoteMsgVpnsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeRemoteMsgVpnsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeRemoteMsgVpnsResponse input)
        {
            if (input == null)
                return false;

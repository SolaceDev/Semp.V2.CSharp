...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttSessionSubscriptionsResponse :  IEquatable<MsgVpnMqttSessionSubscriptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttSessionSubscriptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnMqttSessionSubscriptionsResponse(List<MsgVpnMqttSessionSubscription> data = default(List<MsgVpnMqttSessionSubscription>), List<MsgVpnMqttSessionSubscriptionLinks> links = default(List<MsgVpnMqttSessionSubscriptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnMqttSessionSubscriptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnMqttSessionSubscription> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnMqttSessionSubscriptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnMqttSessionSubscriptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttSessionSubscriptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttSessionSubscriptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttSessionSubscriptionsResponse input)
        {
            if (input == null)
                return false;

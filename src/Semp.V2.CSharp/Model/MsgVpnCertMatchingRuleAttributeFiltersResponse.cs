...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleAttributeFiltersResponse :  IEquatable<MsgVpnCertMatchingRuleAttributeFiltersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleAttributeFiltersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnCertMatchingRuleAttributeFiltersResponse(List<MsgVpnCertMatchingRuleAttributeFilter> data = default(List<MsgVpnCertMatchingRuleAttributeFilter>), List<MsgVpnCertMatchingRuleAttributeFilterLinks> links = default(List<MsgVpnCertMatchingRuleAttributeFilterLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnCertMatchingRuleAttributeFiltersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnCertMatchingRuleAttributeFilter> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnCertMatchingRuleAttributeFilterLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleAttributeFiltersResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleAttributeFiltersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleAttributeFiltersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleAttributeFiltersResponse input)
        {
            if (input == null)
                return false;

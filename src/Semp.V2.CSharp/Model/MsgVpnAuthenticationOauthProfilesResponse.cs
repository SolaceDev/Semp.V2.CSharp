...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProfilesResponse :  IEquatable<MsgVpnAuthenticationOauthProfilesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProfilesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAuthenticationOauthProfilesResponse(List<MsgVpnAuthenticationOauthProfile> data = default(List<MsgVpnAuthenticationOauthProfile>), List<MsgVpnAuthenticationOauthProfileLinks> links = default(List<MsgVpnAuthenticationOauthProfileLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAuthenticationOauthProfilesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAuthenticationOauthProfile> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAuthenticationOauthProfileLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProfilesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProfilesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProfilesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProfilesResponse input)
        {
            if (input == null)
                return false;

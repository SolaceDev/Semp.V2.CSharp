...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileClientConnectExceptionsResponse :  IEquatable<MsgVpnAclProfileClientConnectExceptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileClientConnectExceptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileClientConnectExceptionsResponse(List<MsgVpnAclProfileClientConnectException> data = default(List<MsgVpnAclProfileClientConnectException>), List<MsgVpnAclProfileClientConnectExceptionLinks> links = default(List<MsgVpnAclProfileClientConnectExceptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileClientConnectExceptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAclProfileClientConnectException> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAclProfileClientConnectExceptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileClientConnectExceptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileClientConnectExceptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileClientConnectExceptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileClientConnectExceptionsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTopicEndpointTemplate :  IEquatable<MsgVpnTopicEndpointTemplate>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTopicEndpointTemplate" /> class.
        /// </summary>
        ...
        /// <param name="maxBindCount">The maximum number of consumer flows that can bind. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;1&#x60;..</param>
        ...
        /// <param name="rejectLowPriorityMsgLimit">The number of messages that are permitted before low priority messages are rejected. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;0&#x60;..</param>
        ...
        /// </summary>
        /// <value>The maximum number of consumer flows that can bind. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;1&#x60;.</value>
        ...
        /// </summary>
        /// <value>The number of messages that are permitted before low priority messages are rejected. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;0&#x60;.</value>
        ...
        [DataMember(Name="topicEndpointNameFilter", EmitDefaultValue=false)]
        public string TopicEndpointNameFilter { get; set; }

        /// <summary>
        /// The name of the Topic Endpoint Template.
        /// </summary>
        /// <value>The name of the Topic Endpoint Template.</value>
        [DataMember(Name="topicEndpointTemplateName", EmitDefaultValue=false)]
        public string TopicEndpointTemplateName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TopicEndpointNameFilter: ").Append(TopicEndpointNameFilter).Append("\n");
            sb.Append("  TopicEndpointTemplateName: ").Append(TopicEndpointTemplateName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnTopicEndpointTemplate);
        }

        /// <summary>
        /// Returns true if MsgVpnTopicEndpointTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTopicEndpointTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTopicEndpointTemplate input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TopicEndpointNameFilter == input.TopicEndpointNameFilter ||
                    (this.TopicEndpointNameFilter != null &&
                    this.TopicEndpointNameFilter.Equals(input.TopicEndpointNameFilter))
                ) && 
                (
                    this.TopicEndpointTemplateName == input.TopicEndpointTemplateName ||
                    (this.TopicEndpointTemplateName != null &&
                    this.TopicEndpointTemplateName.Equals(input.TopicEndpointTemplateName))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TopicEndpointNameFilter != null)
                    hashCode = hashCode * 59 + this.TopicEndpointNameFilter.GetHashCode();
                if (this.TopicEndpointTemplateName != null)
                    hashCode = hashCode * 59 + this.TopicEndpointTemplateName.GetHashCode();
                return hashCode;
            }
        }
    }

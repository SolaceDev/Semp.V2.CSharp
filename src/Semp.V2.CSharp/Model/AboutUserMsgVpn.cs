...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutUserMsgVpn :  IEquatable<AboutUserMsgVpn>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The Message VPN access level of the User. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - No access. \&quot;read-only\&quot; - Read only access. \&quot;read-write\&quot; - Read and write access. &lt;/pre&gt; </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutUserMsgVpn" /> class.
        /// </summary>
        /// <param name="accessLevel">The Message VPN access level of the User. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - No access. \&quot;read-only\&quot; - Read only access. \&quot;read-write\&quot; - Read and write access. &lt;/pre&gt; .</param>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        public AboutUserMsgVpn(AccessLevelEnum? accessLevel = default(AccessLevelEnum?), string msgVpnName = default(string))
        {
        ...
        {
            return this.Equals(input as AboutUserMsgVpn);
        }

        /// <summary>
        /// Returns true if AboutUserMsgVpn instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutUserMsgVpn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutUserMsgVpn input)
        {
            if (input == null)
                return false;

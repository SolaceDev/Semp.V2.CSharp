...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeRemoteSubscriptionsResponse :  IEquatable<MsgVpnBridgeRemoteSubscriptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeRemoteSubscriptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnBridgeRemoteSubscriptionsResponse(List<MsgVpnBridgeRemoteSubscription> data = default(List<MsgVpnBridgeRemoteSubscription>), List<MsgVpnBridgeRemoteSubscriptionLinks> links = default(List<MsgVpnBridgeRemoteSubscriptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnBridgeRemoteSubscriptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnBridgeRemoteSubscription> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnBridgeRemoteSubscriptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnBridgeRemoteSubscriptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeRemoteSubscriptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeRemoteSubscriptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeRemoteSubscriptionsResponse input)
        {
            if (input == null)
                return false;

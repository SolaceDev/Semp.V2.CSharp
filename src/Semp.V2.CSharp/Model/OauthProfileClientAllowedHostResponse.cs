...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientAllowedHostResponse :  IEquatable<OauthProfileClientAllowedHostResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientAllowedHostResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileClientAllowedHostResponse(OauthProfileClientAllowedHost data = default(OauthProfileClientAllowedHost), OauthProfileClientAllowedHostLinks links = default(OauthProfileClientAllowedHostLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileClientAllowedHostResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public OauthProfileClientAllowedHost Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public OauthProfileClientAllowedHostLinks Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileClientAllowedHostResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileClientAllowedHostResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientAllowedHostResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientAllowedHostResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks :  IEquatable<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Protected Request Header object..</param>
        public MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Protected Request Header object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks {\n");
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks input)
        {
            if (input == null)
                return false;

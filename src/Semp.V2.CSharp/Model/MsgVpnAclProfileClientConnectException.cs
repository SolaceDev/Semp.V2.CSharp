...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileClientConnectException :  IEquatable<MsgVpnAclProfileClientConnectException>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileClientConnectException" /> class.
        /// </summary>
        ...
        public MsgVpnAclProfileClientConnectException(string aclProfileName = default(string), string clientConnectExceptionAddress = default(string), string msgVpnName = default(string))
        {
        ...
        /// </summary>
        /// <value>The IP address/netmask of the client connect exception in canonical CIDR form.</value>
        [DataMember(Name="clientConnectExceptionAddress", EmitDefaultValue=false)]
        public string ClientConnectExceptionAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ClientConnectExceptionAddress: ").Append(ClientConnectExceptionAddress).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnAclProfileClientConnectException);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileClientConnectException instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileClientConnectException to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileClientConnectException input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ClientConnectExceptionAddress == input.ClientConnectExceptionAddress ||
                    (this.ClientConnectExceptionAddress != null &&
                    this.ClientConnectExceptionAddress.Equals(input.ClientConnectExceptionAddress))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClientConnectExceptionAddress != null)
                    hashCode = hashCode * 59 + this.ClientConnectExceptionAddress.GetHashCode();

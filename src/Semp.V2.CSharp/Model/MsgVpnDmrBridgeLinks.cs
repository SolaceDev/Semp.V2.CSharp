...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDmrBridgeLinks :  IEquatable<MsgVpnDmrBridgeLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDmrBridgeLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this DMR Bridge object..</param>
        public MsgVpnDmrBridgeLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this DMR Bridge object.</value>
        ...
        {
            return this.Equals(input as MsgVpnDmrBridgeLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnDmrBridgeLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDmrBridgeLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDmrBridgeLinks input)
        {
            if (input == null)
                return false;

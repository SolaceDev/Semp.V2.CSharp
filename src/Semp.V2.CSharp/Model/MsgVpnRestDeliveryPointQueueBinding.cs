...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBinding :  IEquatable<MsgVpnRestDeliveryPointQueueBinding>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The type of evaluation to perform on the request target. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;none\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - Do not evaluate substitution expressions on the request target. \&quot;substitution-expressions\&quot; - Evaluate substitution expressions on the request target. &lt;/pre&gt;  Available since 2.23.</value>
        ...
        /// </summary>
        /// <value>Enable or disable whether the authority for the request-target is replaced with that configured for the REST Consumer remote. When enabled, the broker sends HTTP requests in absolute-form, with the request-target&#x27;s authority taken from the REST Consumer&#x27;s remote host and port configuration. When disabled, the broker sends HTTP requests whose request-target matches that of the original request message, including whether to use absolute-form or origin-form. This configuration is applicable only when the Message VPN is in REST gateway mode. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;. Available since 2.6.</value>
        [DataMember(Name="gatewayReplaceTargetAuthorityEnabled", EmitDefaultValue=false)]
        public bool? GatewayReplaceTargetAuthorityEnabled { get; set; }
        ...
        [DataMember(Name="postRequestTarget", EmitDefaultValue=false)]
        public string PostRequestTarget { get; set; }

        /// <summary>
        /// The name of a queue in the Message VPN.
        /// </summary>
        /// <value>The name of a queue in the Message VPN.</value>
        [DataMember(Name="queueBindingName", EmitDefaultValue=false)]
        public string QueueBindingName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GatewayReplaceTargetAuthorityEnabled: ").Append(GatewayReplaceTargetAuthorityEnabled).Append("\n");
            sb.Append("  MsgVpnName: ").Append(MsgVpnName).Append("\n");
            sb.Append("  PostRequestTarget: ").Append(PostRequestTarget).Append("\n");
            sb.Append("  QueueBindingName: ").Append(QueueBindingName).Append("\n");
            sb.Append("  RequestTargetEvaluation: ").Append(RequestTargetEvaluation).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBinding);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBinding instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBinding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBinding input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.GatewayReplaceTargetAuthorityEnabled == input.GatewayReplaceTargetAuthorityEnabled ||
                    (this.GatewayReplaceTargetAuthorityEnabled != null &&
                    this.GatewayReplaceTargetAuthorityEnabled.Equals(input.GatewayReplaceTargetAuthorityEnabled))
                ) && 
                (
                ...
                (
                    this.PostRequestTarget == input.PostRequestTarget ||
                    (this.PostRequestTarget != null &&
                    this.PostRequestTarget.Equals(input.PostRequestTarget))
                ) && 
                (
                    this.QueueBindingName == input.QueueBindingName ||
                    (this.QueueBindingName != null &&
                    this.QueueBindingName.Equals(input.QueueBindingName))
                ) && 
                (
                    this.RequestTargetEvaluation == input.RequestTargetEvaluation ||
                    (this.RequestTargetEvaluation != null &&
                    this.RequestTargetEvaluation.Equals(input.RequestTargetEvaluation))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.GatewayReplaceTargetAuthorityEnabled != null)
                    hashCode = hashCode * 59 + this.GatewayReplaceTargetAuthorityEnabled.GetHashCode();
                if (this.MsgVpnName != null)
                    hashCode = hashCode * 59 + this.MsgVpnName.GetHashCode();
                if (this.PostRequestTarget != null)
                    hashCode = hashCode * 59 + this.PostRequestTarget.GetHashCode();
                if (this.QueueBindingName != null)
                    hashCode = hashCode * 59 + this.QueueBindingName.GetHashCode();
                if (this.RequestTargetEvaluation != null)
                    hashCode = hashCode * 59 + this.RequestTargetEvaluation.GetHashCode();

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrCluster :  IEquatable<DmrCluster>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The type of basic authentication to use for Cluster Links. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;internal\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;internal\&quot; - Use locally configured password. \&quot;none\&quot; - No authentication. &lt;/pre&gt; </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrCluster" /> class.
        /// </summary>
        /// <param name="authenticationBasicEnabled">Enable or disable basic authentication for Cluster Links. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;true&#x60;..</param>
        /// <param name="authenticationBasicPassword">The password used to authenticate incoming Cluster Links when using basic internal authentication. The same password is also used by outgoing Cluster Links if a per-Link password is not configured. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        /// <param name="authenticationBasicType">The type of basic authentication to use for Cluster Links. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;internal\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;internal\&quot; - Use locally configured password. \&quot;none\&quot; - No authentication. &lt;/pre&gt; .</param>
        ...
        /// <param name="authenticationClientCertEnabled">Enable or disable client certificate authentication for Cluster Links. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;true&#x60;..</param>
        ...
        /// <param name="directOnlyEnabled">Enable or disable direct messaging only. Guaranteed messages will not be transmitted through the cluster. The default value is &#x60;false&#x60;..</param>
        /// <param name="dmrClusterName">The name of the Cluster..</param>
        /// <param name="enabled">Enable or disable the Cluster. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="nodeName">The name of this node in the Cluster. This is the name that this broker (or redundant group of brokers) is know by to other nodes in the Cluster. The name is chosen automatically to be either this broker&#x27;s Router Name or Mate Router Name, depending on which Active Standby Role (primary or backup) this broker plays in its redundancy group..</param>
        /// <param name="tlsServerCertEnforceTrustedCommonNameEnabled">Enable or disable the enforcing of the common name provided by the remote broker against the list of trusted common names configured for the Link. If enabled, the certificate&#x27;s common name must match one of the trusted common names for the Link to be accepted. Common Name validation is not performed if Server Certificate Name Validation is enabled, even if Common Name validation is enabled. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;false&#x60;. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation..</param>
        /// <param name="tlsServerCertMaxChainDepth">The maximum allowed depth of a certificate chain. The depth of a chain is defined as the number of signing CA certificates that are present in the chain back to a trusted self-signed root CA certificate. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;3&#x60;..</param>
        /// <param name="tlsServerCertValidateDateEnabled">Enable or disable the validation of the \&quot;Not Before\&quot; and \&quot;Not After\&quot; validity dates in the certificate. When disabled, the certificate is accepted even if the certificate is not valid based on these dates. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;true&#x60;..</param>
        /// <param name="tlsServerCertValidateNameEnabled">Enable or disable the standard TLS authentication mechanism of verifying the name used to connect to the bridge. If enabled, the name used to connect to the bridge is checked against the names specified in the certificate returned by the remote router. Legacy Common Name validation is not performed if Server Certificate Name Validation is enabled, even if Common Name validation is also enabled. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;true&#x60;. Available since 2.18..</param>
        public DmrCluster(bool? authenticationBasicEnabled = default(bool?), string authenticationBasicPassword = default(string), AuthenticationBasicTypeEnum? authenticationBasicType = default(AuthenticationBasicTypeEnum?), string authenticationClientCertContent = default(string), bool? authenticationClientCertEnabled = default(bool?), string authenticationClientCertPassword = default(string), bool? directOnlyEnabled = default(bool?), string dmrClusterName = default(string), bool? enabled = default(bool?), string nodeName = default(string), bool? tlsServerCertEnforceTrustedCommonNameEnabled = default(bool?), long? tlsServerCertMaxChainDepth = default(long?), bool? tlsServerCertValidateDateEnabled = default(bool?), bool? tlsServerCertValidateNameEnabled = default(bool?))
        {
        ...
        /// </summary>
        /// <value>Enable or disable basic authentication for Cluster Links. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>The password used to authenticate incoming Cluster Links when using basic internal authentication. The same password is also used by outgoing Cluster Links if a per-Link password is not configured. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        /// </summary>
        /// <value>The PEM formatted content for the client certificate used to login to the remote node. It must consist of a private key and between one and three certificates comprising the certificate trust chain. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Changing this attribute requires an HTTPS connection. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        /// </summary>
        /// <value>Enable or disable client certificate authentication for Cluster Links. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>Enable or disable direct messaging only. Guaranteed messages will not be transmitted through the cluster. The default value is &#x60;false&#x60;.</value>
        [DataMember(Name="directOnlyEnabled", EmitDefaultValue=false)]
        public bool? DirectOnlyEnabled { get; set; }
        ...
        /// </summary>
        /// <value>Enable or disable the Cluster. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        /// </summary>
        /// <value>The name of this node in the Cluster. This is the name that this broker (or redundant group of brokers) is know by to other nodes in the Cluster. The name is chosen automatically to be either this broker&#x27;s Router Name or Mate Router Name, depending on which Active Standby Role (primary or backup) this broker plays in its redundancy group.</value>
        ...
        /// </summary>
        /// <value>Enable or disable the enforcing of the common name provided by the remote broker against the list of trusted common names configured for the Link. If enabled, the certificate&#x27;s common name must match one of the trusted common names for the Link to be accepted. Common Name validation is not performed if Server Certificate Name Validation is enabled, even if Common Name validation is enabled. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;false&#x60;. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.</value>
        [DataMember(Name="tlsServerCertEnforceTrustedCommonNameEnabled", EmitDefaultValue=false)]
        public bool? TlsServerCertEnforceTrustedCommonNameEnabled { get; set; }
        ...
        /// </summary>
        /// <value>The maximum allowed depth of a certificate chain. The depth of a chain is defined as the number of signing CA certificates that are present in the chain back to a trusted self-signed root CA certificate. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;3&#x60;.</value>
        [DataMember(Name="tlsServerCertMaxChainDepth", EmitDefaultValue=false)]
        public long? TlsServerCertMaxChainDepth { get; set; }
        ...
        /// </summary>
        /// <value>Enable or disable the validation of the \&quot;Not Before\&quot; and \&quot;Not After\&quot; validity dates in the certificate. When disabled, the certificate is accepted even if the certificate is not valid based on these dates. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;true&#x60;.</value>
        [DataMember(Name="tlsServerCertValidateDateEnabled", EmitDefaultValue=false)]
        public bool? TlsServerCertValidateDateEnabled { get; set; }
        ...
        [DataMember(Name="tlsServerCertValidateNameEnabled", EmitDefaultValue=false)]
        public bool? TlsServerCertValidateNameEnabled { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DirectOnlyEnabled: ").Append(DirectOnlyEnabled).Append("\n");
            sb.Append("  DmrClusterName: ").Append(DmrClusterName).Append("\n");
            sb.Append("  Enabled: ").Append(Enabled).Append("\n");
            sb.Append("  NodeName: ").Append(NodeName).Append("\n");
            sb.Append("  TlsServerCertEnforceTrustedCommonNameEnabled: ").Append(TlsServerCertEnforceTrustedCommonNameEnabled).Append("\n");
            sb.Append("  TlsServerCertMaxChainDepth: ").Append(TlsServerCertMaxChainDepth).Append("\n");
            sb.Append("  TlsServerCertValidateDateEnabled: ").Append(TlsServerCertValidateDateEnabled).Append("\n");
            sb.Append("  TlsServerCertValidateNameEnabled: ").Append(TlsServerCertValidateNameEnabled).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DmrCluster);
        }

        /// <summary>
        /// Returns true if DmrCluster instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrCluster to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrCluster input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DirectOnlyEnabled == input.DirectOnlyEnabled ||
                    (this.DirectOnlyEnabled != null &&
                    this.DirectOnlyEnabled.Equals(input.DirectOnlyEnabled))
                ) && 
                (
                ...
                (
                    this.TlsServerCertEnforceTrustedCommonNameEnabled == input.TlsServerCertEnforceTrustedCommonNameEnabled ||
                    (this.TlsServerCertEnforceTrustedCommonNameEnabled != null &&
                    this.TlsServerCertEnforceTrustedCommonNameEnabled.Equals(input.TlsServerCertEnforceTrustedCommonNameEnabled))
                ) && 
                (
                    this.TlsServerCertMaxChainDepth == input.TlsServerCertMaxChainDepth ||
                    (this.TlsServerCertMaxChainDepth != null &&
                    this.TlsServerCertMaxChainDepth.Equals(input.TlsServerCertMaxChainDepth))
                ) && 
                (
                    this.TlsServerCertValidateDateEnabled == input.TlsServerCertValidateDateEnabled ||
                    (this.TlsServerCertValidateDateEnabled != null &&
                    this.TlsServerCertValidateDateEnabled.Equals(input.TlsServerCertValidateDateEnabled))
                ) && 
                (
                    this.TlsServerCertValidateNameEnabled == input.TlsServerCertValidateNameEnabled ||
                    (this.TlsServerCertValidateNameEnabled != null &&
                    this.TlsServerCertValidateNameEnabled.Equals(input.TlsServerCertValidateNameEnabled))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DirectOnlyEnabled != null)
                    hashCode = hashCode * 59 + this.DirectOnlyEnabled.GetHashCode();
                ...
                if (this.TlsServerCertEnforceTrustedCommonNameEnabled != null)
                    hashCode = hashCode * 59 + this.TlsServerCertEnforceTrustedCommonNameEnabled.GetHashCode();
                if (this.TlsServerCertMaxChainDepth != null)
                    hashCode = hashCode * 59 + this.TlsServerCertMaxChainDepth.GetHashCode();
                if (this.TlsServerCertValidateDateEnabled != null)
                    hashCode = hashCode * 59 + this.TlsServerCertValidateDateEnabled.GetHashCode();
                if (this.TlsServerCertValidateNameEnabled != null)
                    hashCode = hashCode * 59 + this.TlsServerCertValidateNameEnabled.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkTlsTrustedCommonNamesResponse :  IEquatable<DmrClusterLinkTlsTrustedCommonNamesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkTlsTrustedCommonNamesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterLinkTlsTrustedCommonNamesResponse(List<DmrClusterLinkTlsTrustedCommonName> data = default(List<DmrClusterLinkTlsTrustedCommonName>), List<DmrClusterLinkTlsTrustedCommonNameLinks> links = default(List<DmrClusterLinkTlsTrustedCommonNameLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterLinkTlsTrustedCommonNamesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DmrClusterLinkTlsTrustedCommonName> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DmrClusterLinkTlsTrustedCommonNameLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterLinkTlsTrustedCommonNamesResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkTlsTrustedCommonNamesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkTlsTrustedCommonNamesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkTlsTrustedCommonNamesResponse input)
        {
            if (input == null)
                return false;

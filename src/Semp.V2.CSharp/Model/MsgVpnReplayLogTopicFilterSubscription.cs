...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplayLogTopicFilterSubscription :  IEquatable<MsgVpnReplayLogTopicFilterSubscription>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplayLogTopicFilterSubscription" /> class.
        /// </summary>
        ...
        public MsgVpnReplayLogTopicFilterSubscription(string msgVpnName = default(string), string replayLogName = default(string), string topicFilterSubscription = default(string))
        {
        ...
        /// </summary>
        /// <value>The topic of the Subscription.</value>
        [DataMember(Name="topicFilterSubscription", EmitDefaultValue=false)]
        public string TopicFilterSubscription { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TopicFilterSubscription: ").Append(TopicFilterSubscription).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnReplayLogTopicFilterSubscription);
        }

        /// <summary>
        /// Returns true if MsgVpnReplayLogTopicFilterSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplayLogTopicFilterSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplayLogTopicFilterSubscription input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TopicFilterSubscription == input.TopicFilterSubscription ||
                    (this.TopicFilterSubscription != null &&
                    this.TopicFilterSubscription.Equals(input.TopicFilterSubscription))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TopicFilterSubscription != null)
                    hashCode = hashCode * 59 + this.TopicFilterSubscription.GetHashCode();
                return hashCode;
            }
        }
    }

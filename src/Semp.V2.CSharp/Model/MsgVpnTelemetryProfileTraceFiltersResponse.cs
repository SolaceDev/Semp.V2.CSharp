...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileTraceFiltersResponse :  IEquatable<MsgVpnTelemetryProfileTraceFiltersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileTraceFiltersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTelemetryProfileTraceFiltersResponse(List<MsgVpnTelemetryProfileTraceFilter> data = default(List<MsgVpnTelemetryProfileTraceFilter>), List<MsgVpnTelemetryProfileTraceFilterLinks> links = default(List<MsgVpnTelemetryProfileTraceFilterLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTelemetryProfileTraceFiltersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnTelemetryProfileTraceFilter> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnTelemetryProfileTraceFilterLinks> Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileTraceFiltersResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileTraceFiltersResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileTraceFiltersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileTraceFiltersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileTraceFiltersResponse input)
        {
            if (input == null)
                return false;

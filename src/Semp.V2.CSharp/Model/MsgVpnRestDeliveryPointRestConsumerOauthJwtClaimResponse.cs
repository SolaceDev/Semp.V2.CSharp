...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse :  IEquatable<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse(MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim data = default(MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim), MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks links = default(MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse input)
        {
            if (input == null)
                return false;

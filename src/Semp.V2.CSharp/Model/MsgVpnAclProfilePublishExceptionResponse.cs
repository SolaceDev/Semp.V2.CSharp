...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfilePublishExceptionResponse :  IEquatable<MsgVpnAclProfilePublishExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfilePublishExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfilePublishExceptionResponse(MsgVpnAclProfilePublishException data = default(MsgVpnAclProfilePublishException), MsgVpnAclProfilePublishExceptionLinks links = default(MsgVpnAclProfilePublishExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfilePublishExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAclProfilePublishException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAclProfilePublishExceptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfilePublishExceptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfilePublishExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfilePublishExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfilePublishExceptionResponse input)
        {
            if (input == null)
                return false;

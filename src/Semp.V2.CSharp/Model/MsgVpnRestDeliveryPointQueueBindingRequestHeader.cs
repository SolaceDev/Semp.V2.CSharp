...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingRequestHeader :  IEquatable<MsgVpnRestDeliveryPointQueueBindingRequestHeader>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingRequestHeader" /> class.
        /// </summary>
        /// <param name="headerName">The name of the HTTP request header..</param>
        /// <param name="headerValue">A substitution expression for the value of the HTTP request header. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;..</param>
        ...
        public MsgVpnRestDeliveryPointQueueBindingRequestHeader(string headerName = default(string), string headerValue = default(string), string msgVpnName = default(string), string queueBindingName = default(string), string restDeliveryPointName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the HTTP request header.</value>
        ...
        /// </summary>
        /// <value>A substitution expression for the value of the HTTP request header. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;\&quot;&#x60;.</value>
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingRequestHeader);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingRequestHeader instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingRequestHeader to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingRequestHeader input)
        {
            if (input == null)
                return false;

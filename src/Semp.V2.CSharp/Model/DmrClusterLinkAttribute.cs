...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkAttribute :  IEquatable<DmrClusterLinkAttribute>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkAttribute" /> class.
        /// </summary>
        ...
        public DmrClusterLinkAttribute(string attributeName = default(string), string attributeValue = default(string), string dmrClusterName = default(string), string remoteNodeName = default(string))
        {
        ...
        {
            return this.Equals(input as DmrClusterLinkAttribute);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkAttribute instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkAttribute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkAttribute input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientProfileLinks :  IEquatable<MsgVpnClientProfileLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientProfileLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Client Profile object..</param>
        public MsgVpnClientProfileLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Client Profile object.</value>
        ...
        {
            return this.Equals(input as MsgVpnClientProfileLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnClientProfileLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientProfileLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientProfileLinks input)
        {
            if (input == null)
                return false;

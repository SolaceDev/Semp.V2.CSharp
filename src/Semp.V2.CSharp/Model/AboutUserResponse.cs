...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutUserResponse :  IEquatable<AboutUserResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutUserResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public AboutUserResponse(AboutUser data = default(AboutUser), AboutUserLinks links = default(AboutUserLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for AboutUserResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public AboutUser Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public AboutUserLinks Links { get; set; }
        ...
        {
            return this.Equals(input as AboutUserResponse);
        }

        /// <summary>
        /// Returns true if AboutUserResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutUserResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutUserResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientAllowedHostLinks :  IEquatable<OauthProfileClientAllowedHostLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientAllowedHostLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Allowed Host Value object..</param>
        public OauthProfileClientAllowedHostLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Allowed Host Value object.</value>
        ...
        {
            return this.Equals(input as OauthProfileClientAllowedHostLinks);
        }

        /// <summary>
        /// Returns true if OauthProfileClientAllowedHostLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientAllowedHostLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientAllowedHostLinks input)
        {
            if (input == null)
                return false;

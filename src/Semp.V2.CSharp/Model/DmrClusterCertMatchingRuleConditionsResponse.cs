...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRuleConditionsResponse :  IEquatable<DmrClusterCertMatchingRuleConditionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRuleConditionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterCertMatchingRuleConditionsResponse(List<DmrClusterCertMatchingRuleCondition> data = default(List<DmrClusterCertMatchingRuleCondition>), List<DmrClusterCertMatchingRuleConditionLinks> links = default(List<DmrClusterCertMatchingRuleConditionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterCertMatchingRuleConditionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DmrClusterCertMatchingRuleCondition> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DmrClusterCertMatchingRuleConditionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRuleConditionsResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRuleConditionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRuleConditionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRuleConditionsResponse input)
        {
            if (input == null)
                return false;

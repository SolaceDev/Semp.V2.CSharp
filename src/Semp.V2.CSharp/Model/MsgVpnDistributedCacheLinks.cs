...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheLinks :  IEquatable<MsgVpnDistributedCacheLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheLinks" /> class.
        /// </summary>
        /// <param name="clustersUri">The URI of this Distributed Cache&#x27;s collection of Cache Cluster objects..</param>
        /// <param name="uri">The URI of this Distributed Cache object..</param>
        public MsgVpnDistributedCacheLinks(string clustersUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Distributed Cache&#x27;s collection of Cache Cluster objects.</value>
        [DataMember(Name="clustersUri", EmitDefaultValue=false)]
        public string ClustersUri { get; set; }

        /// <summary>
        /// The URI of this Distributed Cache object.
        /// </summary>
        /// <value>The URI of this Distributed Cache object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ClustersUri: ").Append(ClustersUri).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ClustersUri == input.ClustersUri ||
                    (this.ClustersUri != null &&
                    this.ClustersUri.Equals(input.ClustersUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ClustersUri != null)
                    hashCode = hashCode * 59 + this.ClustersUri.GetHashCode();
                if (this.Uri != null)

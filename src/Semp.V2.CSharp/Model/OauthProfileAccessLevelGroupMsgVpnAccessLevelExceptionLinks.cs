...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks :  IEquatable<OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Message VPN Access-Level Exception object..</param>
        public OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Message VPN Access-Level Exception object.</value>
        ...
        {
            return this.Equals(input as OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks);
        }

        /// <summary>
        /// Returns true if OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterResponse :  IEquatable<MsgVpnDistributedCacheClusterResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClusterResponse(MsgVpnDistributedCacheCluster data = default(MsgVpnDistributedCacheCluster), MsgVpnDistributedCacheClusterLinks links = default(MsgVpnDistributedCacheClusterLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClusterResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnDistributedCacheCluster Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnDistributedCacheClusterLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterResponse input)
        {
            if (input == null)
                return false;

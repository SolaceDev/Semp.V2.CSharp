...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueuesResponse :  IEquatable<MsgVpnQueuesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueuesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnQueuesResponse(List<MsgVpnQueue> data = default(List<MsgVpnQueue>), List<MsgVpnQueueLinks> links = default(List<MsgVpnQueueLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnQueuesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnQueue> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnQueueLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnQueuesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnQueuesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueuesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueuesResponse input)
        {
            if (input == null)
                return false;

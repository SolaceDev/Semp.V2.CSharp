...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleAttributeFilterLinks :  IEquatable<MsgVpnCertMatchingRuleAttributeFilterLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleAttributeFilterLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Certificate Matching Rule Attribute Filter object..</param>
        public MsgVpnCertMatchingRuleAttributeFilterLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleAttributeFilterLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleAttributeFilterLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleAttributeFilterLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleAttributeFilterLinks input)
        {
            if (input == null)
                return false;

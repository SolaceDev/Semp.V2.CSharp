...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientRequiredClaim :  IEquatable<OauthProfileClientRequiredClaim>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientRequiredClaim" /> class.
        /// </summary>
        /// <param name="clientRequiredClaimName">The name of the ID token claim to verify..</param>
        /// <param name="clientRequiredClaimValue">The required claim value, which must be a string containing a valid JSON value..</param>
        /// <param name="oauthProfileName">The name of the OAuth profile..</param>
        public OauthProfileClientRequiredClaim(string clientRequiredClaimName = default(string), string clientRequiredClaimValue = default(string), string oauthProfileName = default(string))
        {
        ...
        {
            return this.Equals(input as OauthProfileClientRequiredClaim);
        }

        /// <summary>
        /// Returns true if OauthProfileClientRequiredClaim instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientRequiredClaim to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientRequiredClaim input)
        {
            if (input == null)
                return false;

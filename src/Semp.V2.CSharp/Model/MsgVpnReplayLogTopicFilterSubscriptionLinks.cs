...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnReplayLogTopicFilterSubscriptionLinks :  IEquatable<MsgVpnReplayLogTopicFilterSubscriptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnReplayLogTopicFilterSubscriptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Topic Filter Subscription object..</param>
        public MsgVpnReplayLogTopicFilterSubscriptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Topic Filter Subscription object.</value>
        ...
        {
            return this.Equals(input as MsgVpnReplayLogTopicFilterSubscriptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnReplayLogTopicFilterSubscriptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnReplayLogTopicFilterSubscriptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnReplayLogTopicFilterSubscriptionLinks input)
        {
            if (input == null)
                return false;

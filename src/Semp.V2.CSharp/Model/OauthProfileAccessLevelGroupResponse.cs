...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileAccessLevelGroupResponse :  IEquatable<OauthProfileAccessLevelGroupResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileAccessLevelGroupResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileAccessLevelGroupResponse(OauthProfileAccessLevelGroup data = default(OauthProfileAccessLevelGroup), OauthProfileAccessLevelGroupLinks links = default(OauthProfileAccessLevelGroupLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileAccessLevelGroupResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public OauthProfileAccessLevelGroup Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public OauthProfileAccessLevelGroupLinks Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileAccessLevelGroupResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileAccessLevelGroupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileAccessLevelGroupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileAccessLevelGroupResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAuthenticationOauthProviderLinks :  IEquatable<MsgVpnAuthenticationOauthProviderLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAuthenticationOauthProviderLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this OAuth Provider object..</param>
        public MsgVpnAuthenticationOauthProviderLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this OAuth Provider object.</value>
        ...
        {
            return this.Equals(input as MsgVpnAuthenticationOauthProviderLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAuthenticationOauthProviderLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAuthenticationOauthProviderLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAuthenticationOauthProviderLinks input)
        {
            if (input == null)
                return false;

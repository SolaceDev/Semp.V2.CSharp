...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientRequiredClaimsResponse :  IEquatable<OauthProfileClientRequiredClaimsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientRequiredClaimsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileClientRequiredClaimsResponse(List<OauthProfileClientRequiredClaim> data = default(List<OauthProfileClientRequiredClaim>), List<OauthProfileClientRequiredClaimLinks> links = default(List<OauthProfileClientRequiredClaimLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileClientRequiredClaimsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<OauthProfileClientRequiredClaim> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<OauthProfileClientRequiredClaimLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileClientRequiredClaimsResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileClientRequiredClaimsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientRequiredClaimsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientRequiredClaimsResponse input)
        {
            if (input == null)
                return false;

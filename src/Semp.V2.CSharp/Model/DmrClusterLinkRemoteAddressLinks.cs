...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkRemoteAddressLinks :  IEquatable<DmrClusterLinkRemoteAddressLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkRemoteAddressLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Remote Address object..</param>
        public DmrClusterLinkRemoteAddressLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Remote Address object.</value>
        ...
        {
            return this.Equals(input as DmrClusterLinkRemoteAddressLinks);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkRemoteAddressLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkRemoteAddressLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkRemoteAddressLinks input)
        {
            if (input == null)
                return false;

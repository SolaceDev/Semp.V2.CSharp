...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix :  IEquatable<MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix" /> class.
        /// </summary>
        ...
        public MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix(string cacheName = default(string), string clusterName = default(string), string homeClusterName = default(string), string msgVpnName = default(string), string topicPrefix = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the remote Home Cache Cluster.</value>
        [DataMember(Name="homeClusterName", EmitDefaultValue=false)]
        public string HomeClusterName { get; set; }
        ...
        /// </summary>
        /// <value>A topic prefix for global topics available from the remote Home Cache Cluster. A wildcard (/&gt;) is implied at the end of the prefix.</value>
        [DataMember(Name="topicPrefix", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HomeClusterName: ").Append(HomeClusterName).Append("\n");
            sb.Append("  MsgVpnName: ").Append(MsgVpnName).Append("\n");
            sb.Append("  TopicPrefix: ").Append(TopicPrefix).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HomeClusterName == input.HomeClusterName ||
                    (this.HomeClusterName != null &&
                    this.HomeClusterName.Equals(input.HomeClusterName))
                ) && 
                (
                ...
                (
                    ...
                    this.TopicPrefix.Equals(input.TopicPrefix))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HomeClusterName != null)
                    hashCode = hashCode * 59 + this.HomeClusterName.GetHashCode();
                if (this.MsgVpnName != null)
                    hashCode = hashCode * 59 + this.MsgVpnName.GetHashCode();
                if (this.TopicPrefix != null)
                    hashCode = hashCode * 59 + this.TopicPrefix.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleResponse :  IEquatable<MsgVpnCertMatchingRuleResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnCertMatchingRuleResponse(MsgVpnCertMatchingRule data = default(MsgVpnCertMatchingRule), MsgVpnCertMatchingRuleLinks links = default(MsgVpnCertMatchingRuleLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnCertMatchingRuleResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnCertMatchingRule Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnCertMatchingRuleLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleResponse input)
        {
            if (input == null)
                return false;

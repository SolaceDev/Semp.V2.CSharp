...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks :  IEquatable<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Trusted Common Name object..</param>
        public MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Trusted Common Name object.</value>
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileTraceFilterSubscriptionResponse :  IEquatable<MsgVpnTelemetryProfileTraceFilterSubscriptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileTraceFilterSubscriptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTelemetryProfileTraceFilterSubscriptionResponse(MsgVpnTelemetryProfileTraceFilterSubscription data = default(MsgVpnTelemetryProfileTraceFilterSubscription), MsgVpnTelemetryProfileTraceFilterSubscriptionLinks links = default(MsgVpnTelemetryProfileTraceFilterSubscriptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTelemetryProfileTraceFilterSubscriptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnTelemetryProfileTraceFilterSubscription Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnTelemetryProfileTraceFilterSubscriptionLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileTraceFilterSubscriptionResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileTraceFilterSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileTraceFilterSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileTraceFilterSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileTraceFilterSubscriptionResponse input)
        {
            if (input == null)
                return false;

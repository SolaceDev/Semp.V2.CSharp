...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileAccessLevelGroupMsgVpnAccessLevelException :  IEquatable<OauthProfileAccessLevelGroupMsgVpnAccessLevelException>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The message VPN access level. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;none\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - User has no access to a Message VPN. \&quot;read-only\&quot; - User has read-only access to a Message VPN. \&quot;read-write\&quot; - User has read-write access to most Message VPN settings. &lt;/pre&gt; </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileAccessLevelGroupMsgVpnAccessLevelException" /> class.
        /// </summary>
        /// <param name="accessLevel">The message VPN access level. Changes to this attribute are synchronized to HA mates via config-sync. The default value is &#x60;\&quot;none\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - User has no access to a Message VPN. \&quot;read-only\&quot; - User has read-only access to a Message VPN. \&quot;read-write\&quot; - User has read-write access to most Message VPN settings. &lt;/pre&gt; .</param>
        ...
        public OauthProfileAccessLevelGroupMsgVpnAccessLevelException(AccessLevelEnum? accessLevel = default(AccessLevelEnum?), string groupName = default(string), string msgVpnName = default(string), string oauthProfileName = default(string))
        {
        ...
        {
            return this.Equals(input as OauthProfileAccessLevelGroupMsgVpnAccessLevelException);
        }

        /// <summary>
        /// Returns true if OauthProfileAccessLevelGroupMsgVpnAccessLevelException instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileAccessLevelGroupMsgVpnAccessLevelException to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileAccessLevelGroupMsgVpnAccessLevelException input)
        {
            if (input == null)
                return false;

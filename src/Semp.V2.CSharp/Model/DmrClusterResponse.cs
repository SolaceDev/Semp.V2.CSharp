...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterResponse :  IEquatable<DmrClusterResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterResponse(DmrCluster data = default(DmrCluster), DmrClusterLinks links = default(DmrClusterLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DmrCluster Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DmrClusterLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterResponse input)
        {
            if (input == null)
                return false;

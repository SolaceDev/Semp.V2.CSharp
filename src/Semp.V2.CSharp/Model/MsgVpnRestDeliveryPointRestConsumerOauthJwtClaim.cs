...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim :  IEquatable<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim" /> class.
        /// </summary>
        ...
        /// <param name="oauthJwtClaimValue">The value of the additional claim, which must be a string containing a valid JSON value..</param>
        ...
        public MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim(string msgVpnName = default(string), string oauthJwtClaimName = default(string), string oauthJwtClaimValue = default(string), string restConsumerName = default(string), string restDeliveryPointName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the additional claim. Cannot be \&quot;exp\&quot;, \&quot;iat\&quot;, or \&quot;jti\&quot;.</value>
        [DataMember(Name="oauthJwtClaimName", EmitDefaultValue=false)]
        public string OauthJwtClaimName { get; set; }

        /// <summary>
        /// The value of the additional claim, which must be a string containing a valid JSON value.
        /// </summary>
        /// <value>The value of the additional claim, which must be a string containing a valid JSON value.</value>
        [DataMember(Name="oauthJwtClaimValue", EmitDefaultValue=false)]
        public string OauthJwtClaimValue { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OauthJwtClaimName: ").Append(OauthJwtClaimName).Append("\n");
            sb.Append("  OauthJwtClaimValue: ").Append(OauthJwtClaimValue).Append("\n");
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OauthJwtClaimName == input.OauthJwtClaimName ||
                    (this.OauthJwtClaimName != null &&
                    this.OauthJwtClaimName.Equals(input.OauthJwtClaimName))
                ) && 
                (
                    this.OauthJwtClaimValue == input.OauthJwtClaimValue ||
                    (this.OauthJwtClaimValue != null &&
                    this.OauthJwtClaimValue.Equals(input.OauthJwtClaimValue))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OauthJwtClaimName != null)
                    hashCode = hashCode * 59 + this.OauthJwtClaimName.GetHashCode();
                if (this.OauthJwtClaimValue != null)
                    hashCode = hashCode * 59 + this.OauthJwtClaimValue.GetHashCode();

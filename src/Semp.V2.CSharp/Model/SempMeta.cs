...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SempMeta :  IEquatable<SempMeta>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SempMeta" /> class.
        /// </summary>
        /// <param name="count">The total number of objects requested, irrespective of page size. This may be a count of all objects in a collection or a filtered subset. It represents a snapshot in time and may change when paging through results..</param>
        /// <param name="error">error.</param>
        /// <param name="paging">paging.</param>
        /// <param name="request">request (required).</param>
        /// <param name="responseCode">The HTTP response code, one of 200 (success), 4xx (client error), or 5xx (server error). (required).</param>
        public SempMeta(long? count = default(long?), SempError error = default(SempError), SempPaging paging = default(SempPaging), SempRequest request = default(SempRequest), int? responseCode = default(int?))
        {
            // to ensure "request" is required (not null)
            if (request == null)
            {
                throw new InvalidDataException("request is a required property for SempMeta and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("responseCode is a required property for SempMeta and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The total number of objects requested, irrespective of page size. This may be a count of all objects in a collection or a filtered subset. It represents a snapshot in time and may change when paging through results.</value>
        ...
        public SempError Error { get; set; }

        /// <summary>
        /// Gets or Sets Paging
        /// </summary>
        [DataMember(Name="paging", EmitDefaultValue=false)]
        public SempPaging Paging { get; set; }

        /// <summary>
        /// Gets or Sets Request
        /// </summary>
        [DataMember(Name="request", EmitDefaultValue=false)]
        public SempRequest Request { get; set; }

        /// <summary>
        /// The HTTP response code, one of 200 (success), 4xx (client error), or 5xx (server error).
        /// </summary>
        /// <value>The HTTP response code, one of 200 (success), 4xx (client error), or 5xx (server error).</value>
        ...
        {
            return this.Equals(input as SempMeta);
        }

        /// <summary>
        /// Returns true if SempMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of SempMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SempMeta input)
        {
            if (input == null)
                return false;

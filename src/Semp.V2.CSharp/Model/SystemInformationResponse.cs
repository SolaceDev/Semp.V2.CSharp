...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SystemInformationResponse :  IEquatable<SystemInformationResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemInformationResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public SystemInformationResponse(SystemInformation data = default(SystemInformation), SystemInformationLinks links = default(SystemInformationLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for SystemInformationResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public SystemInformation Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public SystemInformationLinks Links { get; set; }
        ...
        {
            return this.Equals(input as SystemInformationResponse);
        }

        /// <summary>
        /// Returns true if SystemInformationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemInformationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemInformationResponse input)
        {
            if (input == null)
                return false;

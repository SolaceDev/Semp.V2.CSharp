...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfilesResponse :  IEquatable<MsgVpnAclProfilesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfilesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfilesResponse(List<MsgVpnAclProfile> data = default(List<MsgVpnAclProfile>), List<MsgVpnAclProfileLinks> links = default(List<MsgVpnAclProfileLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfilesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnAclProfile> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnAclProfileLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfilesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfilesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfilesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfilesResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SempMetaOnlyResponse :  IEquatable<SempMetaOnlyResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SempMetaOnlyResponse" /> class.
        /// </summary>
        /// <param name="meta">meta (required).</param>
        public SempMetaOnlyResponse(SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for SempMetaOnlyResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        {
            return this.Equals(input as SempMetaOnlyResponse);
        }

        /// <summary>
        /// Returns true if SempMetaOnlyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SempMetaOnlyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SempMetaOnlyResponse input)
        {
            if (input == null)
                return false;

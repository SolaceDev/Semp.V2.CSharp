...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkRemoteAddress :  IEquatable<DmrClusterLinkRemoteAddress>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkRemoteAddress" /> class.
        /// </summary>
        ...
        public DmrClusterLinkRemoteAddress(string dmrClusterName = default(string), string remoteAddress = default(string), string remoteNodeName = default(string))
        {
        ...
        /// </summary>
        /// <value>The FQDN or IP address (and optional port) of the remote node. If a port is not provided, it will vary based on the transport encoding: 55555 (plain-text), 55443 (encrypted), or 55003 (compressed).</value>
        ...
        {
            return this.Equals(input as DmrClusterLinkRemoteAddress);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkRemoteAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkRemoteAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkRemoteAddress input)
        {
            if (input == null)
                return false;

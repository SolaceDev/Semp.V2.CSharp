...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClustersResponse :  IEquatable<MsgVpnDistributedCacheClustersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClustersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClustersResponse(List<MsgVpnDistributedCacheCluster> data = default(List<MsgVpnDistributedCacheCluster>), List<MsgVpnDistributedCacheClusterLinks> links = default(List<MsgVpnDistributedCacheClusterLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClustersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnDistributedCacheCluster> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnDistributedCacheClusterLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClustersResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClustersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClustersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClustersResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRule :  IEquatable<MsgVpnCertMatchingRule>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRule" /> class.
        /// </summary>
        /// <param name="enabled">Enable or disable a certificate matching rule. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;..</param>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="ruleName">The name of the rule..</param>
        public MsgVpnCertMatchingRule(bool? enabled = default(bool?), string msgVpnName = default(string), string ruleName = default(string))
        {
        ...
        /// </summary>
        /// <value>Enable or disable a certificate matching rule. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;false&#x60;.</value>
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRule);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRule instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRule input)
        {
            if (input == null)
                return false;

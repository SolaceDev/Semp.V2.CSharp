...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRuleAttributeFiltersResponse :  IEquatable<DmrClusterCertMatchingRuleAttributeFiltersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRuleAttributeFiltersResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterCertMatchingRuleAttributeFiltersResponse(List<DmrClusterCertMatchingRuleAttributeFilter> data = default(List<DmrClusterCertMatchingRuleAttributeFilter>), List<DmrClusterCertMatchingRuleAttributeFilterLinks> links = default(List<DmrClusterCertMatchingRuleAttributeFilterLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterCertMatchingRuleAttributeFiltersResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<DmrClusterCertMatchingRuleAttributeFilter> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<DmrClusterCertMatchingRuleAttributeFilterLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRuleAttributeFiltersResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRuleAttributeFiltersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRuleAttributeFiltersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRuleAttributeFiltersResponse input)
        {
            if (input == null)
                return false;

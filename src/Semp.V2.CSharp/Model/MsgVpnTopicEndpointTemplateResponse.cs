...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTopicEndpointTemplateResponse :  IEquatable<MsgVpnTopicEndpointTemplateResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTopicEndpointTemplateResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTopicEndpointTemplateResponse(MsgVpnTopicEndpointTemplate data = default(MsgVpnTopicEndpointTemplate), MsgVpnTopicEndpointTemplateLinks links = default(MsgVpnTopicEndpointTemplateLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTopicEndpointTemplateResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnTopicEndpointTemplate Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnTopicEndpointTemplateLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnTopicEndpointTemplateResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTopicEndpointTemplateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTopicEndpointTemplateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTopicEndpointTemplateResponse input)
        {
            if (input == null)
                return false;

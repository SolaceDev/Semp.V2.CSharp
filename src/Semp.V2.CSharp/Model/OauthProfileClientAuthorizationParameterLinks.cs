...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientAuthorizationParameterLinks :  IEquatable<OauthProfileClientAuthorizationParameterLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientAuthorizationParameterLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Authorization Parameter object..</param>
        public OauthProfileClientAuthorizationParameterLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Authorization Parameter object.</value>
        ...
        {
            return this.Equals(input as OauthProfileClientAuthorizationParameterLinks);
        }

        /// <summary>
        /// Returns true if OauthProfileClientAuthorizationParameterLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientAuthorizationParameterLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientAuthorizationParameterLinks input)
        {
            if (input == null)
                return false;

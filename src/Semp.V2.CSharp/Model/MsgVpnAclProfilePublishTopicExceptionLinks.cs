...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfilePublishTopicExceptionLinks :  IEquatable<MsgVpnAclProfilePublishTopicExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfilePublishTopicExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Publish Topic Exception object..</param>
        public MsgVpnAclProfilePublishTopicExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Publish Topic Exception object.</value>
        ...
        {
            return this.Equals(input as MsgVpnAclProfilePublishTopicExceptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfilePublishTopicExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfilePublishTopicExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfilePublishTopicExceptionLinks input)
        {
            if (input == null)
                return false;

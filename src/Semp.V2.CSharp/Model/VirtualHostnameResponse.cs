...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VirtualHostnameResponse :  IEquatable<VirtualHostnameResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirtualHostnameResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public VirtualHostnameResponse(VirtualHostname data = default(VirtualHostname), VirtualHostnameLinks links = default(VirtualHostnameLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for VirtualHostnameResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public VirtualHostname Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public VirtualHostnameLinks Links { get; set; }
        ...
        {
            return this.Equals(input as VirtualHostnameResponse);
        }

        /// <summary>
        /// Returns true if VirtualHostnameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of VirtualHostnameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtualHostnameResponse input)
        {
            if (input == null)
                return false;

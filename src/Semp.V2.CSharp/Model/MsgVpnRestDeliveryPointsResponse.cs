...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointsResponse :  IEquatable<MsgVpnRestDeliveryPointsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointsResponse(List<MsgVpnRestDeliveryPoint> data = default(List<MsgVpnRestDeliveryPoint>), List<MsgVpnRestDeliveryPointLinks> links = default(List<MsgVpnRestDeliveryPointLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnRestDeliveryPoint> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnRestDeliveryPointLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointsResponse input)
        {
            if (input == null)
                return false;

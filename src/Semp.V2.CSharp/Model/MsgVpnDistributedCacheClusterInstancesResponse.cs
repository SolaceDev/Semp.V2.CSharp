...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterInstancesResponse :  IEquatable<MsgVpnDistributedCacheClusterInstancesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterInstancesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClusterInstancesResponse(List<MsgVpnDistributedCacheClusterInstance> data = default(List<MsgVpnDistributedCacheClusterInstance>), List<MsgVpnDistributedCacheClusterInstanceLinks> links = default(List<MsgVpnDistributedCacheClusterInstanceLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClusterInstancesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnDistributedCacheClusterInstance> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnDistributedCacheClusterInstanceLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterInstancesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterInstancesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterInstancesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterInstancesResponse input)
        {
            if (input == null)
                return false;

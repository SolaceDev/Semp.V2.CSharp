...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnSequencedTopic :  IEquatable<MsgVpnSequencedTopic>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnSequencedTopic" /> class.
        /// </summary>
        /// <param name="msgVpnName">The name of the Message VPN..</param>
        /// <param name="sequencedTopic">Topic for applying sequence numbers..</param>
        public MsgVpnSequencedTopic(string msgVpnName = default(string), string sequencedTopic = default(string))
        {
        ...
        /// </summary>
        /// <value>Topic for applying sequence numbers.</value>
        [DataMember(Name="sequencedTopic", EmitDefaultValue=false)]
        public string SequencedTopic { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SequencedTopic: ").Append(SequencedTopic).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnSequencedTopic);
        }

        /// <summary>
        /// Returns true if MsgVpnSequencedTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnSequencedTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnSequencedTopic input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SequencedTopic == input.SequencedTopic ||
                    (this.SequencedTopic != null &&
                    this.SequencedTopic.Equals(input.SequencedTopic))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SequencedTopic != null)
                    hashCode = hashCode * 59 + this.SequencedTopic.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileSubscribeExceptionLinks :  IEquatable<MsgVpnAclProfileSubscribeExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileSubscribeExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Subscribe Topic Exception object..</param>
        public MsgVpnAclProfileSubscribeExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileSubscribeExceptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileSubscribeExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileSubscribeExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileSubscribeExceptionLinks input)
        {
            if (input == null)
                return false;

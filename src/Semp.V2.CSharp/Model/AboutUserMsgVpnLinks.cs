...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AboutUserMsgVpnLinks :  IEquatable<AboutUserMsgVpnLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboutUserMsgVpnLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this User Message VPN object..</param>
        public AboutUserMsgVpnLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this User Message VPN object.</value>
        ...
        {
            return this.Equals(input as AboutUserMsgVpnLinks);
        }

        /// <summary>
        /// Returns true if AboutUserMsgVpnLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of AboutUserMsgVpnLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboutUserMsgVpnLinks input)
        {
            if (input == null)
                return false;

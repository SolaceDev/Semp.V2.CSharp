...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingsResponse :  IEquatable<MsgVpnRestDeliveryPointQueueBindingsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointQueueBindingsResponse(List<MsgVpnRestDeliveryPointQueueBinding> data = default(List<MsgVpnRestDeliveryPointQueueBinding>), List<MsgVpnRestDeliveryPointQueueBindingLinks> links = default(List<MsgVpnRestDeliveryPointQueueBindingLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointQueueBindingsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnRestDeliveryPointQueueBinding> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnRestDeliveryPointQueueBindingLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingsResponse input)
        {
            if (input == null)
                return false;

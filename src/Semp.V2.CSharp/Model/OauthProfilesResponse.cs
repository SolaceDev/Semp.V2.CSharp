...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfilesResponse :  IEquatable<OauthProfilesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfilesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfilesResponse(List<OauthProfile> data = default(List<OauthProfile>), List<OauthProfileLinks> links = default(List<OauthProfileLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfilesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<OauthProfile> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<OauthProfileLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfilesResponse);
        }

        /// <summary>
        /// Returns true if OauthProfilesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfilesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfilesResponse input)
        {
            if (input == null)
                return false;

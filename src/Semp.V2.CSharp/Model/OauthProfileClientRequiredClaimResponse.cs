...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileClientRequiredClaimResponse :  IEquatable<OauthProfileClientRequiredClaimResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileClientRequiredClaimResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileClientRequiredClaimResponse(OauthProfileClientRequiredClaim data = default(OauthProfileClientRequiredClaim), OauthProfileClientRequiredClaimLinks links = default(OauthProfileClientRequiredClaimLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileClientRequiredClaimResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public OauthProfileClientRequiredClaim Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public OauthProfileClientRequiredClaimLinks Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileClientRequiredClaimResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileClientRequiredClaimResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileClientRequiredClaimResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileClientRequiredClaimResponse input)
        {
            if (input == null)
                return false;

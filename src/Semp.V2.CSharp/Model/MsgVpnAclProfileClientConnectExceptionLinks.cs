...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileClientConnectExceptionLinks :  IEquatable<MsgVpnAclProfileClientConnectExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileClientConnectExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Client Connect Exception object..</param>
        public MsgVpnAclProfileClientConnectExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Client Connect Exception object.</value>
        ...
        {
            return this.Equals(input as MsgVpnAclProfileClientConnectExceptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileClientConnectExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileClientConnectExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileClientConnectExceptionLinks input)
        {
            if (input == null)
                return false;

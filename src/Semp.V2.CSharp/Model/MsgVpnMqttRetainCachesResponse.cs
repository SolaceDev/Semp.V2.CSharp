...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnMqttRetainCachesResponse :  IEquatable<MsgVpnMqttRetainCachesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnMqttRetainCachesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnMqttRetainCachesResponse(List<MsgVpnMqttRetainCache> data = default(List<MsgVpnMqttRetainCache>), List<MsgVpnMqttRetainCacheLinks> links = default(List<MsgVpnMqttRetainCacheLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnMqttRetainCachesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnMqttRetainCache> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnMqttRetainCacheLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnMqttRetainCachesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnMqttRetainCachesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnMqttRetainCachesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnMqttRetainCachesResponse input)
        {
            if (input == null)
                return false;

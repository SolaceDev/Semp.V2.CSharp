...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueSubscriptionsResponse :  IEquatable<MsgVpnQueueSubscriptionsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueSubscriptionsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnQueueSubscriptionsResponse(List<MsgVpnQueueSubscription> data = default(List<MsgVpnQueueSubscription>), List<MsgVpnQueueSubscriptionLinks> links = default(List<MsgVpnQueueSubscriptionLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnQueueSubscriptionsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnQueueSubscription> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnQueueSubscriptionLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnQueueSubscriptionsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueSubscriptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueSubscriptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueSubscriptionsResponse input)
        {
            if (input == null)
                return false;

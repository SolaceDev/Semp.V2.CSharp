...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse :  IEquatable<MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse(MsgVpnTelemetryProfileReceiverAclConnectException data = default(MsgVpnTelemetryProfileReceiverAclConnectException), MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks links = default(MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnTelemetryProfileReceiverAclConnectException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnTelemetryProfileReceiverAclConnectExceptionResponse input)
        {
            if (input == null)
                return false;

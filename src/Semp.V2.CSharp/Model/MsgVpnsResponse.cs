...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnsResponse :  IEquatable<MsgVpnsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnsResponse(List<MsgVpn> data = default(List<MsgVpn>), List<MsgVpnLinks> links = default(List<MsgVpnLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnsResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpn> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnsResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnsResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterInstanceResponse :  IEquatable<MsgVpnDistributedCacheClusterInstanceResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterInstanceResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnDistributedCacheClusterInstanceResponse(MsgVpnDistributedCacheClusterInstance data = default(MsgVpnDistributedCacheClusterInstance), MsgVpnDistributedCacheClusterInstanceLinks links = default(MsgVpnDistributedCacheClusterInstanceLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnDistributedCacheClusterInstanceResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnDistributedCacheClusterInstance Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnDistributedCacheClusterInstanceLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterInstanceResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterInstanceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterInstanceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterInstanceResponse input)
        {
            if (input == null)
                return false;

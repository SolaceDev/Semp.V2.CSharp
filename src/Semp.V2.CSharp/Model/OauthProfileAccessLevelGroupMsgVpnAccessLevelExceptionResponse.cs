...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse :  IEquatable<OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse(OauthProfileAccessLevelGroupMsgVpnAccessLevelException data = default(OauthProfileAccessLevelGroupMsgVpnAccessLevelException), OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks links = default(OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public OauthProfileAccessLevelGroupMsgVpnAccessLevelException Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionLinks Links { get; set; }
        ...
        {
            return this.Equals(input as OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse);
        }

        /// <summary>
        /// Returns true if OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionResponse input)
        {
            if (input == null)
                return false;

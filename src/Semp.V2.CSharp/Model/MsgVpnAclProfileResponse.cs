...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfileResponse :  IEquatable<MsgVpnAclProfileResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfileResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnAclProfileResponse(MsgVpnAclProfile data = default(MsgVpnAclProfile), MsgVpnAclProfileLinks links = default(MsgVpnAclProfileLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnAclProfileResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnAclProfile Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnAclProfileLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnAclProfileResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfileResponse input)
        {
            if (input == null)
                return false;

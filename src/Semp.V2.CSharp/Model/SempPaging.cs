...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SempPaging :  IEquatable<SempPaging>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SempPaging" /> class.
        /// </summary>
        /// <param name="cursorQuery">The cursor, or position, for the next page of objects. Use this as the &#x60;cursor&#x60; query parameter of the next request. (required).</param>
        /// <param name="nextPageUri">The URI of the next page of objects. &#x60;cursorQuery&#x60; is already embedded within this URI. (required).</param>
        public SempPaging(string cursorQuery = default(string), string nextPageUri = default(string))
        {
            // to ensure "cursorQuery" is required (not null)
            if (cursorQuery == null)
            {
                throw new InvalidDataException("cursorQuery is a required property for SempPaging and cannot be null");
            }
            else
            {
                this.CursorQuery = cursorQuery;
            }
            // to ensure "nextPageUri" is required (not null)
            if (nextPageUri == null)
            {
                throw new InvalidDataException("nextPageUri is a required property for SempPaging and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The cursor, or position, for the next page of objects. Use this as the &#x60;cursor&#x60; query parameter of the next request.</value>
        [DataMember(Name="cursorQuery", EmitDefaultValue=false)]
        public string CursorQuery { get; set; }

        /// <summary>
        /// The URI of the next page of objects. &#x60;cursorQuery&#x60; is already embedded within this URI.
        /// </summary>
        /// <value>The URI of the next page of objects. &#x60;cursorQuery&#x60; is already embedded within this URI.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CursorQuery: ").Append(CursorQuery).Append("\n");
        ...
        {
            return this.Equals(input as SempPaging);
        }

        /// <summary>
        /// Returns true if SempPaging instances are equal
        /// </summary>
        /// <param name="input">Instance of SempPaging to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SempPaging input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CursorQuery == input.CursorQuery ||
                    (this.CursorQuery != null &&
                    this.CursorQuery.Equals(input.CursorQuery))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CursorQuery != null)
                    hashCode = hashCode * 59 + this.CursorQuery.GetHashCode();

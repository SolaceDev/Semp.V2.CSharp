...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinkAttributeResponse :  IEquatable<DmrClusterLinkAttributeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinkAttributeResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterLinkAttributeResponse(DmrClusterLinkAttribute data = default(DmrClusterLinkAttribute), DmrClusterLinkAttributeLinks links = default(DmrClusterLinkAttributeLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterLinkAttributeResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DmrClusterLinkAttribute Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DmrClusterLinkAttributeLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterLinkAttributeResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterLinkAttributeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinkAttributeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinkAttributeResponse input)
        {
            if (input == null)
                return false;

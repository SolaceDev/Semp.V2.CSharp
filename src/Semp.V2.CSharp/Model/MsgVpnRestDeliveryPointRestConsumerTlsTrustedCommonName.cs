...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName :  IEquatable<MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName" /> class.
        /// </summary>
        /// <param name="msgVpnName">The name of the Message VPN. Deprecated since (will be deprecated in next SEMP version). Common Name validation has been replaced by Server Certificate Name validation..</param>
        /// <param name="restConsumerName">The name of the REST Consumer. Deprecated since (will be deprecated in next SEMP version). Common Name validation has been replaced by Server Certificate Name validation..</param>
        /// <param name="restDeliveryPointName">The name of the REST Delivery Point. Deprecated since (will be deprecated in next SEMP version). Common Name validation has been replaced by Server Certificate Name validation..</param>
        /// <param name="tlsTrustedCommonName">The expected trusted common name of the remote certificate. Deprecated since (will be deprecated in next SEMP version). Common Name validation has been replaced by Server Certificate Name validation..</param>
        public MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName(string msgVpnName = default(string), string restConsumerName = default(string), string restDeliveryPointName = default(string), string tlsTrustedCommonName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the Message VPN. Deprecated since (will be deprecated in next SEMP version). Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        /// </summary>
        /// <value>The name of the REST Consumer. Deprecated since (will be deprecated in next SEMP version). Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        /// </summary>
        /// <value>The name of the REST Delivery Point. Deprecated since (will be deprecated in next SEMP version). Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        /// </summary>
        /// <value>The expected trusted common name of the remote certificate. Deprecated since (will be deprecated in next SEMP version). Common Name validation has been replaced by Server Certificate Name validation.</value>
        [DataMember(Name="tlsTrustedCommonName", EmitDefaultValue=false)]
        public string TlsTrustedCommonName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TlsTrustedCommonName: ").Append(TlsTrustedCommonName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TlsTrustedCommonName == input.TlsTrustedCommonName ||
                    (this.TlsTrustedCommonName != null &&
                    this.TlsTrustedCommonName.Equals(input.TlsTrustedCommonName))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TlsTrustedCommonName != null)
                    hashCode = hashCode * 59 + this.TlsTrustedCommonName.GetHashCode();
                return hashCode;
            }
        }
    }

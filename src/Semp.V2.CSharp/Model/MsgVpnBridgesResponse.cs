...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgesResponse :  IEquatable<MsgVpnBridgesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnBridgesResponse(List<MsgVpnBridge> data = default(List<MsgVpnBridge>), List<MsgVpnBridgeLinks> links = default(List<MsgVpnBridgeLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnBridgesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnBridge> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnBridgeLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnBridgesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgesResponse input)
        {
            if (input == null)
                return false;

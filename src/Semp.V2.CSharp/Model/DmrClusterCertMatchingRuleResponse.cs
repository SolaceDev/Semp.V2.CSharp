...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterCertMatchingRuleResponse :  IEquatable<DmrClusterCertMatchingRuleResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterCertMatchingRuleResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public DmrClusterCertMatchingRuleResponse(DmrClusterCertMatchingRule data = default(DmrClusterCertMatchingRule), DmrClusterCertMatchingRuleLinks links = default(DmrClusterCertMatchingRuleLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for DmrClusterCertMatchingRuleResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public DmrClusterCertMatchingRule Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public DmrClusterCertMatchingRuleLinks Links { get; set; }
        ...
        {
            return this.Equals(input as DmrClusterCertMatchingRuleResponse);
        }

        /// <summary>
        /// Returns true if DmrClusterCertMatchingRuleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterCertMatchingRuleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterCertMatchingRuleResponse input)
        {
            if (input == null)
                return false;

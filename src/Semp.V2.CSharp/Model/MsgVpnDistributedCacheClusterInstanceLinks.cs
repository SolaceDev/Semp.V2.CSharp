...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnDistributedCacheClusterInstanceLinks :  IEquatable<MsgVpnDistributedCacheClusterInstanceLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnDistributedCacheClusterInstanceLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Cache Instance object..</param>
        public MsgVpnDistributedCacheClusterInstanceLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        /// </summary>
        /// <value>The URI of this Cache Instance object.</value>
        ...
        {
            return this.Equals(input as MsgVpnDistributedCacheClusterInstanceLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnDistributedCacheClusterInstanceLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnDistributedCacheClusterInstanceLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnDistributedCacheClusterInstanceLinks input)
        {
            if (input == null)
                return false;

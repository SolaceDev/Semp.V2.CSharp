...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnQueueLinks :  IEquatable<MsgVpnQueueLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnQueueLinks" /> class.
        /// </summary>
        /// <param name="subscriptionsUri">The URI of this Queue&#x27;s collection of Queue Subscription objects..</param>
        /// <param name="uri">The URI of this Queue object..</param>
        public MsgVpnQueueLinks(string subscriptionsUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Queue&#x27;s collection of Queue Subscription objects.</value>
        ...
        /// </summary>
        /// <value>The URI of this Queue object.</value>
        ...
        {
            return this.Equals(input as MsgVpnQueueLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnQueueLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnQueueLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnQueueLinks input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnCertMatchingRuleAttributeFilterResponse :  IEquatable<MsgVpnCertMatchingRuleAttributeFilterResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnCertMatchingRuleAttributeFilterResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnCertMatchingRuleAttributeFilterResponse(MsgVpnCertMatchingRuleAttributeFilter data = default(MsgVpnCertMatchingRuleAttributeFilter), MsgVpnCertMatchingRuleAttributeFilterLinks links = default(MsgVpnCertMatchingRuleAttributeFilterLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnCertMatchingRuleAttributeFilterResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnCertMatchingRuleAttributeFilter Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnCertMatchingRuleAttributeFilterLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnCertMatchingRuleAttributeFilterResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnCertMatchingRuleAttributeFilterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnCertMatchingRuleAttributeFilterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnCertMatchingRuleAttributeFilterResponse input)
        {
            if (input == null)
                return false;

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnBridgeTlsTrustedCommonName :  IEquatable<MsgVpnBridgeTlsTrustedCommonName>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The virtual router of the Bridge. The allowed values and their meaning are:  &lt;pre&gt; \&quot;primary\&quot; - The Bridge is used for the primary virtual router. \&quot;backup\&quot; - The Bridge is used for the backup virtual router. \&quot;auto\&quot; - The Bridge is automatically assigned a virtual router at creation, depending on the broker&#x27;s active-standby role. &lt;/pre&gt;  Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnBridgeTlsTrustedCommonName" /> class.
        /// </summary>
        /// <param name="bridgeName">The name of the Bridge. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation..</param>
        /// <param name="bridgeVirtualRouter">The virtual router of the Bridge. The allowed values and their meaning are:  &lt;pre&gt; \&quot;primary\&quot; - The Bridge is used for the primary virtual router. \&quot;backup\&quot; - The Bridge is used for the backup virtual router. \&quot;auto\&quot; - The Bridge is automatically assigned a virtual router at creation, depending on the broker&#x27;s active-standby role. &lt;/pre&gt;  Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation..</param>
        /// <param name="msgVpnName">The name of the Message VPN. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation..</param>
        /// <param name="tlsTrustedCommonName">The expected trusted common name of the remote certificate. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation..</param>
        public MsgVpnBridgeTlsTrustedCommonName(string bridgeName = default(string), BridgeVirtualRouterEnum? bridgeVirtualRouter = default(BridgeVirtualRouterEnum?), string msgVpnName = default(string), string tlsTrustedCommonName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the Bridge. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        /// </summary>
        /// <value>The name of the Message VPN. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        /// </summary>
        /// <value>The expected trusted common name of the remote certificate. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.</value>
        ...
        {
            return this.Equals(input as MsgVpnBridgeTlsTrustedCommonName);
        }

        /// <summary>
        /// Returns true if MsgVpnBridgeTlsTrustedCommonName instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnBridgeTlsTrustedCommonName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnBridgeTlsTrustedCommonName input)
        {
            if (input == null)
                return false;

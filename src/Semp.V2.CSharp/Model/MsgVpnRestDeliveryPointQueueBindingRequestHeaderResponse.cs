...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse :  IEquatable<MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse(MsgVpnRestDeliveryPointQueueBindingRequestHeader data = default(MsgVpnRestDeliveryPointQueueBindingRequestHeader), MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks links = default(MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnRestDeliveryPointQueueBindingRequestHeader Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnRestDeliveryPointQueueBindingRequestHeaderLinks Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse input)
        {
            if (input == null)
                return false;

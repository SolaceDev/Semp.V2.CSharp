...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnAclProfilePublishExceptionLinks :  IEquatable<MsgVpnAclProfilePublishExceptionLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnAclProfilePublishExceptionLinks" /> class.
        /// </summary>
        /// <param name="uri">The URI of this Publish Topic Exception object..</param>
        public MsgVpnAclProfilePublishExceptionLinks(string uri = default(string))
        {
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as MsgVpnAclProfilePublishExceptionLinks);
        }

        /// <summary>
        /// Returns true if MsgVpnAclProfilePublishExceptionLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnAclProfilePublishExceptionLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnAclProfilePublishExceptionLinks input)
        {
            if (input == null)
                return false;

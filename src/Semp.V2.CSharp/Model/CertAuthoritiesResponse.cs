...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CertAuthoritiesResponse :  IEquatable<CertAuthoritiesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertAuthoritiesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public CertAuthoritiesResponse(List<CertAuthority> data = default(List<CertAuthority>), List<CertAuthorityLinks> links = default(List<CertAuthorityLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for CertAuthoritiesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<CertAuthority> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<CertAuthorityLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as CertAuthoritiesResponse);
        }

        /// <summary>
        /// Returns true if CertAuthoritiesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CertAuthoritiesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertAuthoritiesResponse input)
        {
            if (input == null)
                return false;

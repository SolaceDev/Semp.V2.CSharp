...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnClientUsernamesResponse :  IEquatable<MsgVpnClientUsernamesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnClientUsernamesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnClientUsernamesResponse(List<MsgVpnClientUsername> data = default(List<MsgVpnClientUsername>), List<MsgVpnClientUsernameLinks> links = default(List<MsgVpnClientUsernameLinks>), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnClientUsernamesResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public List<MsgVpnClientUsername> Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public List<MsgVpnClientUsernameLinks> Links { get; set; }
        ...
        {
            return this.Equals(input as MsgVpnClientUsernamesResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnClientUsernamesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnClientUsernamesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnClientUsernamesResponse input)
        {
            if (input == null)
                return false;

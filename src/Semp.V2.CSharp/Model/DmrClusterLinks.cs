...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DmrClusterLinks :  IEquatable<DmrClusterLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DmrClusterLinks" /> class.
        /// </summary>
        /// <param name="certMatchingRulesUri">The URI of this Cluster&#x27;s collection of Certificate Matching Rule objects. Available since 2.28..</param>
        /// <param name="linksUri">The URI of this Cluster&#x27;s collection of Link objects..</param>
        /// <param name="uri">The URI of this Cluster object..</param>
        public DmrClusterLinks(string certMatchingRulesUri = default(string), string linksUri = default(string), string uri = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI of this Cluster&#x27;s collection of Certificate Matching Rule objects. Available since 2.28.</value>
        ...
        /// </summary>
        /// <value>The URI of this Cluster&#x27;s collection of Link objects.</value>
        [DataMember(Name="linksUri", EmitDefaultValue=false)]
        public string LinksUri { get; set; }

        /// <summary>
        /// The URI of this Cluster object.
        /// </summary>
        /// <value>The URI of this Cluster object.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LinksUri: ").Append(LinksUri).Append("\n");
        ...
        {
            return this.Equals(input as DmrClusterLinks);
        }

        /// <summary>
        /// Returns true if DmrClusterLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of DmrClusterLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DmrClusterLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.LinksUri == input.LinksUri ||
                    (this.LinksUri != null &&
                    this.LinksUri.Equals(input.LinksUri))
                ) && 
                (
                    this.Uri == input.Uri ||
                    (this.Uri != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LinksUri != null)
                    hashCode = hashCode * 59 + this.LinksUri.GetHashCode();
                if (this.Uri != null)

...
namespace Semp.V2.CSharp.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse :  IEquatable<MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        /// <param name="meta">meta (required).</param>
        public MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse(MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader data = default(MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader), MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks links = default(MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks), SempMeta meta = default(SempMeta))
        {
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        public MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader Data { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name="links", EmitDefaultValue=false)]
        public MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse {\n");
        ...
        {
            return this.Equals(input as MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse);
        }

        /// <summary>
        /// Returns true if MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderResponse input)
        {
            if (input == null)
                return false;

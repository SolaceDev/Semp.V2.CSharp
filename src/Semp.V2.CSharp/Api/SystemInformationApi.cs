...
namespace Semp.V2.CSharp.Api
{
    ...
    /// </summary>
        public interface ISystemInformationApi : IApiAccessor
    {
        ...
        /// <returns>SystemInformationResponse</returns>
        ...
        /// <param name="opaquePassword">Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See the documentation for the &#x60;opaquePassword&#x60; parameter. (optional)</param>
        /// <param name="select">Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter. (optional)</param>
        /// <returns>ApiResponse of SystemInformationResponse</returns>
        ApiResponse<SystemInformationResponse> GetSystemInformationWithHttpInfo (string opaquePassword = null, List<string> select = null);
        ...
        /// <param name="opaquePassword">Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See the documentation for the &#x60;opaquePassword&#x60; parameter. (optional)</param>
        /// <param name="select">Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter. (optional)</param>
        /// <returns>Task of SystemInformationResponse</returns>
        System.Threading.Tasks.Task<SystemInformationResponse> GetSystemInformationAsync (string opaquePassword = null, List<string> select = null);
        ...
        /// <param name="opaquePassword">Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See the documentation for the &#x60;opaquePassword&#x60; parameter. (optional)</param>
        /// <param name="select">Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter. (optional)</param>
        /// <returns>Task of ApiResponse (SystemInformationResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<SystemInformationResponse>> GetSystemInformationAsyncWithHttpInfo (string opaquePassword = null, List<string> select = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class SystemInformationApi : ISystemInformationApi
    {
        private Semp.V2.CSharp.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SystemInformationApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SystemInformationApi(String basePath)
        {
        ...
        /// <returns></returns>
        public SystemInformationApi(Semp.V2.CSharp.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Get a System Information object. Get a System Information object.  The System Information object provides metadata about the SEMP API.   Attribute|Identifying|Write-Only|Deprecated|Opaque :- --|:- --:|:- --:|:- --:|:- --: platform|||x| sempVersion|||x|    A SEMP client authorized with a minimum access scope/level of \&quot;global/none\&quot; is required to perform this operation.  This has been deprecated since 2.2. /systemInformation was replaced by /about/api.
        /// </summary>
        /// <exception cref="Semp.V2.CSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="opaquePassword">Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See the documentation for the &#x60;opaquePassword&#x60; parameter. (optional)</param>
        /// <param name="select">Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter. (optional)</param>
        /// <returns>SystemInformationResponse</returns>
        public SystemInformationResponse GetSystemInformation (string opaquePassword = null, List<string> select = null)
        {
             ApiResponse<SystemInformationResponse> localVarResponse = GetSystemInformationWithHttpInfo(opaquePassword, select);
        ...
        /// <param name="select">Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter. (optional)</param>
        /// <returns>ApiResponse of SystemInformationResponse</returns>
        public ApiResponse< SystemInformationResponse > GetSystemInformationWithHttpInfo (string opaquePassword = null, List<string> select = null)
        {

            var localVarPath = "./systemInformation";
            ...
            {
                Exception exception = ExceptionFactory("GetSystemInformation", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<SystemInformationResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (SystemInformationResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(SystemInformationResponse)));
        }
        ...
        /// <param name="select">Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter. (optional)</param>
        /// <returns>Task of SystemInformationResponse</returns>
        public async System.Threading.Tasks.Task<SystemInformationResponse> GetSystemInformationAsync (string opaquePassword = null, List<string> select = null)
        {
             ApiResponse<SystemInformationResponse> localVarResponse = await GetSystemInformationAsyncWithHttpInfo(opaquePassword, select);
             return localVarResponse.Data;
        ...
        /// <param name="select">Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter. (optional)</param>
        /// <returns>Task of ApiResponse (SystemInformationResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SystemInformationResponse>> GetSystemInformationAsyncWithHttpInfo (string opaquePassword = null, List<string> select = null)
        {

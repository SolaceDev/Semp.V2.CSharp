...
namespace Semp.V2.CSharp.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Semp.V2.CSharp.Client.Configuration.Default;
            RestClient = new RestClient("http://www.solace.com/SEMP/v2/config");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://www.solace.com/SEMP/v2/config).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Semp.V2.CSharp.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "http://www.solace.com/SEMP/v2/config")
        {
